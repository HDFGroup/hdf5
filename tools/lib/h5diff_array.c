        ...
        case H5T_REFERENCE:
            ...
            if (iszero1 != iszero2) {
                ...
                if (H5Tequal(m_type, H5T_STD_REF)) {
                    ...
                    switch (ref_type) {
                        case H5R_OBJECT1:
                            ...
                            if (obj1_type != obj2_type) {
                                parallel_print("Different object types referenced: <%s> and <%s>", obj1,
                                               obj2);
                                opts->not_cmp = 1;
                                H5TOOLS_GOTO_DONE(opts->err_stat);
                            }
                                ...
                                if ((obj2_id = H5Ropen_object(ref2_buf, H5P_DEFAULT, H5P_DEFAULT)) >= 0) {
                                    if ((region1_id = H5Ropen_region(ref1_buf, H5P_DEFAULT, H5P_DEFAULT)) >=
                                        ...
                                        if ((region2_id =
                                            ...
                                            nfound =
                                                diff_region(obj1_id, obj2_id, region1_id, region2_id, opts);
                                            if (H5Sclose(region2_id) < 0)
                                                H5TOOLS_ERROR(H5DIFF_ERR,
                                                              "H5Sclose H5R_DATASET_REGION1 failed");
                                        }
                        ...
                        case H5R_OBJECT2:
                            ...
                            switch (obj1_type) {
                                ...
                                case H5O_TYPE_GROUP:
                                    ...
                                    if (opts->m_verbose)
                                        parallel_print("Warning: Comparison not possible of group object "
                                ...
                                case H5O_TYPE_NAMED_DATATYPE:
                                    ...
                                    if (opts->m_verbose)
                                        parallel_print("Warning: Comparison not possible of named datatypes "
                                ...
                                if ((region1_id = H5Ropen_region(ref1_buf, H5P_DEFAULT, H5P_DEFAULT)) >= 0) {
                                    if (h5tools_is_zero(ref1_buf, H5Tget_size(H5T_STD_REF))) {
                                        ...
                                        if ((region2_id =
                                            ...
                                            if (H5Sclose(region2_id) < 0)
                                                H5TOOLS_ERROR(H5DIFF_ERR,
                                                              "H5Sclose H5R_DATASET_REGION2 failed");
                                        }
                                        else
                                            H5TOOLS_ERROR(H5DIFF_ERR,
                    ...
                    H5TOOLS_DEBUG("diff_datum H5T_REFERENCE - H5T_STD_REF complete nfound:%d - errstat:%d",
                 ...
                 */
                    ...
                    if ((obj1_id = H5Rdereference2(container1_id, H5P_DEFAULT, H5R_DATASET_REGION, _mem1)) <
                        0) {
                        opts->err_stat = H5DIFF_ERR;
                        H5TOOLS_INFO("H5Rdereference2 object 1 failed");
                    }
                    if ((obj2_id = H5Rdereference2(container2_id, H5P_DEFAULT, H5R_DATASET_REGION, _mem2)) <
                        0) {
                        opts->err_stat = H5DIFF_ERR;
