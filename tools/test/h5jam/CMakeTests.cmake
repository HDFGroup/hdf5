...
##############################################################################
  ...
  foreach (h5_file ${HDF5_REFERENCE_TEST_FILES})
    HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/${h5_file}" "${PROJECT_BINARY_DIR}/testfiles/${h5_file}" "h5jam_files")
  endforeach ()
  ...
  macro (UNJAMTEST testname setfile infile ufile chkfile outfile)
    if (NOT HDF5_ENABLE_USING_MEMCHECKER)
      ...
      add_test (
          ...
          COMMAND ${CMAKE_COMMAND} -E copy_if_different ${HDF5_TOOL_INPUT_PATH}/testfiles/${setfile} ${PROJECT_BINARY_DIR}/${infile}
      )
