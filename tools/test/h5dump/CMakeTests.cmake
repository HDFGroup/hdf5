...
# so without SZIP only the native variant runs. The PARAMS_STRING line differs by availability -- the SZIP
# get_config form (e.g. coding = "nn", pixels_per_block = 4) when SZIP is available, the raw cd_values fallback
# form otherwise -- hence the separate reference files.
if (HDF5_ENABLE_SZIP_SUPPORT)
  ADD_H5_TEST (tszip RESULT_CODE 0 APPLY_FILTERS 2 --enable-error-stack -H -p -d szip TARGET_FILE tfilters.h5)
else ()
  ADD_H5_TEST (tszip_noavail RESULT_CODE 0 APPLY_FILTERS 2 --enable-error-stack -H -p -d szip TARGET_FILE tfilters.h5 NATIVE_ONLY)
endif ()
...
if (H5_HAVE_FILTER_DEFLATE)
  ...
  ADD_H5_TEST (tdeflate_noavail RESULT_CODE 0 APPLY_FILTERS 2 --enable-error-stack -H -p -d deflate TARGET_FILE tfilters.h5 NATIVE_ONLY)
endif ()
