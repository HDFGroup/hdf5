...
##############################################################################
  ...
  foreach (vds_h5_file ${HDF5_REFERENCE_TEST_VDS})
    HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/vds/${vds_h5_file}" "${PROJECT_BINARY_DIR}/testfiles/vds/${vds_h5_file}" "h5dump_vds_files")
  endforeach ()

  foreach (vds_h5_file ${HDF5_REFERENCE_PREFIX_VDS})
    HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/vds/${vds_h5_file}" "${PROJECT_BINARY_DIR}/testfiles/vds/prefix/${vds_h5_file}" "h5dump_vds_files")
  endforeach ()
