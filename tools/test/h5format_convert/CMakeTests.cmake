...
##############################################################################
  ...
  foreach (h5_file ${HDF5_REFERENCE_TEST_FILES})
    HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/${h5_file}" "${PROJECT_BINARY_DIR}/testfiles/${h5_file}" "h5fc_files")
  endforeach ()
    ...
    if (NOT HDF5_ENABLE_USING_MEMCHECKER)
      ...
      if (${testfile})
        add_test (
            ...
            COMMAND ${CMAKE_COMMAND} -E copy_if_different ${HDF5_TOOL_INPUT_PATH}/testfiles/${testfile} ./testfiles/${testname}-tmp.h5
        )
  ...
  macro (ADD_H5_H5DUMP_CHECK testname)
    ...
    if (NOT HDF5_ENABLE_USING_MEMCHECKER)
      ...
      add_test (
          ...
          COMMAND ${CMAKE_COMMAND} -E copy_if_different ${HDF5_TOOL_INPUT_PATH}/testfiles/${testname}.h5 ./testfiles/${testname}-tmp.h5
      )
