...
##############################################################################
  ...
  foreach (h5_tstfiles ${LIST_DIFF_TEST_FILES})
    HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/${h5_tstfiles}" "${PROJECT_BINARY_DIR}/testfiles/${h5_tstfiles}" "h5diff_files")
    if (H5_HAVE_PARALLEL)
      HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/${h5_tstfiles}" "${PROJECT_BINARY_DIR}/PAR/testfiles/${h5_tstfiles}" "h5diff_files")
    endif ()
  endforeach ()
  foreach (h5_tstfiles ${LIST_VDS_TEST_FILES})
    HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/vds/${h5_tstfiles}" "${PROJECT_BINARY_DIR}/testfiles/${h5_tstfiles}" "h5diff_files")
    if (H5_HAVE_PARALLEL)
      HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/vds/${h5_tstfiles}" "${PROJECT_BINARY_DIR}/PAR/testfiles/${h5_tstfiles}" "h5diff_files")
    endif ()
  endforeach ()
  ...
  HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/tvlstr.h5" "${PROJECT_BINARY_DIR}/testfiles/tvlstr2.h5" "h5diff_files")
  if (H5_HAVE_PARALLEL)
      HDFTEST_COPY_FILE("${HDF5_TOOL_INPUT_PATH}/testfiles/tvlstr.h5" "${PROJECT_BINARY_DIR}/PAR/testfiles/tvlstr2.h5" "h5diff_files")
  endif ()
