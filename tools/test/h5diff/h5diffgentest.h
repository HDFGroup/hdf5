...
void test_comps_array_vlen(const char *fname, const char *dset, const char *attr, int diff,
                                  int is_file_new);
void test_comps_vlen_arry(const char *fname, const char *dset, const char *attr, int diff,
                                 int is_file_new);
