...
main(void)
{
    ...
    //! <!-- [struct_chunk_filter] -->
    {
        __label__ fail_file, fail_space, fail_dcpl, fail_set_chunk, 
...
fail_file:;
    ...
    //! <!-- [struct_chunk_filter2] -->
    {
        ...
        if (H5Pget_filter_by_id3(dcpl, H5Z_FLAG_SPARSE_SELECTION, H5Z_FILTER_DEFLATE, &flags, NULL, NULL, 0, NULL, NULL) < 0) {
