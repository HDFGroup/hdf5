      ...
      if (HDF5_FOUND)
        if (NOT HDF5_static_C_FOUND AND NOT HDF5_shared_C_FOUND)
          ...
          if (NOT HDF5_static_Fortran_FOUND AND NOT HDF5_shared_Fortran_FOUND)
            ...
            if (HDF_BUILD_FORTRAN AND ${HDF5_SUPPORTS_FORTRAN})
        ...
        #Legacy find_package does not set HDF5_SUPPORTS_SHARED_LIBS, so we set it here
        if (USE_SHARED_LIBS AND EXISTS "${HDF5_LIBRARY_DIRS}/libhdf5.so")
          set (HDF5_SUPPORTS_SHARED_LIBS 1)
        else ()
          set (HDF5_SUPPORTS_SHARED_LIBS 0)
        endif ()
        set (H5${EXTNAME}_HDF5_LINK_LIBS ${H5${EXTNAME}_HDF5_LINK_LIBS} ${HDF5_LIBRARIES})
        add_executable (${HDF5_NAMESPACE}h5dump IMPORTED)
        set_property (TARGET ${HDF5_NAMESPACE}h5dump PROPERTY IMPORTED_LOCATION "${HDF5_TOOLS_DIR}/h5dump")
...
macro (EXTERNAL_HDF5_STATUS) # add argument REV to convert from 2.x to 1.x names
  if (NOT ARGN)
    ...
    # Languages:
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_FORTRAN     ${HDF5_PACKAGE_NAME}_BUILD_FORTRAN)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_CPP_LIB     ${HDF5_PACKAGE_NAME}_BUILD_CPP_LIB)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_JAVA        ${HDF5_PACKAGE_NAME}_BUILD_JAVA)
    #-----------------------------------------------------------------------------
    # Features:
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_HL_LIB          ${HDF5_PACKAGE_NAME}_BUILD_HL_LIB)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_SHARED_LIBS     ${HDF5_PACKAGE_NAME}_BUILD_SHARED_LIBS)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_STATIC_LIBS     ${HDF5_PACKAGE_NAME}_BUILD_STATIC_LIBS)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_THREADS         ${HDF5_PACKAGE_NAME}_ENABLE_THREADSAFE)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_THREADSAFE      ${HDF5_PACKAGE_NAME}_ENABLE_THREADSAFE)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_PARALLEL        ${HDF5_PACKAGE_NAME}_ENABLE_PARALLEL)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_DEPRECATED_SYMBOLS ${HDF5_PACKAGE_NAME}_ENABLE_DEPRECATED_SYMBOLS)
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_TOOLS           ${HDF5_PACKAGE_NAME}_BUILD_TOOLS)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_STATIC_TOOLS    ${HDF5_PACKAGE_NAME}_BUILD_STATIC_TOOLS)
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_NONSTANDARD_FEATURE_FLOAT16 ${HDF5_PACKAGE_NAME}_ENABLE_NONSTANDARD_FEATURE_FLOAT16)
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_ZLIB_SUPPORT   ${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_SZIP_SUPPORT   ${HDF5_PACKAGE_NAME}_ENABLE_SZIP_SUPPORT)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_SZIP_ENCODING  ${HDF5_PACKAGE_NAME}_ENABLE_SZIP_ENCODING)
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_MAP_API        ${HDF5_PACKAGE_NAME}_ENABLE_MAP_API)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_DIRECT_VFD     ${HDF5_PACKAGE_NAME}_ENABLE_DIRECT_VFD)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_MIRROR_VFD     ${HDF5_PACKAGE_NAME}_ENABLE_MIRROR_VFD)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_ROS3_VFD       ${HDF5_PACKAGE_NAME}_ENABLE_ROS3_VFD)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_HDFS_VFD       ${HDF5_PACKAGE_NAME}_ENABLE_HDFS)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_SUBFILING_VFD  ${HDF5_PACKAGE_NAME}_ENABLE_SUBFILING_VFD)
    set (${HDF5_PACKAGE_NAME}_SUPPORTS_PLUGIN_SUPPORT ${HDF5_PACKAGE_NAME}_ENABLE_PLUGIN_SUPPORT)
  else ()
    #-----------------------------------------------------------------------------
    # Languages:
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_BUILD_FORTRAN     ${HDF5_PACKAGE_NAME}_SUPPORTS_FORTRAN)
    set (${HDF5_PACKAGE_NAME}_BUILD_CPP_LIB     ${HDF5_PACKAGE_NAME}_SUPPORTS_CPP_LIB)
    set (${HDF5_PACKAGE_NAME}_BUILD_JAVA        ${HDF5_PACKAGE_NAME}_SUPPORTS_JAVA)
    #-----------------------------------------------------------------------------
    # Features:
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_BUILD_HL_LIB           ${HDF5_PACKAGE_NAME}_SUPPORTS_HL_LIBS)
    set (${HDF5_PACKAGE_NAME}_BUILD_SHARED_LIBS      ${HDF5_PACKAGE_NAME}_SUPPORTS_SHARED_LIBS)
    set (${HDF5_PACKAGE_NAME}_BUILD_STATIC_LIBS      ${HDF5_PACKAGE_NAME}_SUPPORTS_STATIC_LIB)
    set (${HDF5_PACKAGE_NAME}_ENABLE_THREADSAFE      ${HDF5_PACKAGE_NAME}_SUPPORTS_THREADSAFE)
    set (${HDF5_PACKAGE_NAME}_ENABLE_PARALLEL        ${HDF5_PACKAGE_NAME}_SUPPORTS_PARALLEL)
    set (${HDF5_PACKAGE_NAME}_ENABLE_DEPRECATED_SYMBOLS ${HDF5_PACKAGE_NAME}_SUPPORTS_DEPRECATED_SYMBOLS)
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_BUILD_TOOLS           ${HDF5_PACKAGE_NAME}_SUPPORTS_TOOLS)
    set (${HDF5_PACKAGE_NAME}_BUILD_STATIC_TOOLS    ${HDF5_PACKAGE_NAME}_SUPPORTS_STATIC_TOOLS)
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_BUILD_NONSTANDARD_FEATURE_FLOAT16 ${HDF5_PACKAGE_NAME}_SUPPORTS_NONSTANDARD_FEATURE_FLOAT16)
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT   ${HDF5_PACKAGE_NAME}_SUPPORTS_ZLIB_SUPPORT)
    set (${HDF5_PACKAGE_NAME}_ENABLE_SZIP_SUPPORT    ${HDF5_PACKAGE_NAME}_SUPPORTS_SZIP_SUPPORT)
    set (${HDF5_PACKAGE_NAME}_ENABLED_SZIP_ENCODING  ${HDF5_PACKAGE_NAME}_SUPPORTS_SZIP_ENCODING)
    #-----------------------------------------------------------------------------
    set (${HDF5_PACKAGE_NAME}_ENABLE_MAP_API        ${HDF5_PACKAGE_NAME}_SUPPORTS_MAP_API)
    set (${HDF5_PACKAGE_NAME}_ENABLE_DIRECT_VFD     ${HDF5_PACKAGE_NAME}_SUPPORTS_DIRECT_VFD)
    set (${HDF5_PACKAGE_NAME}_ENABLE_MIRROR_VFD     ${HDF5_PACKAGE_NAME}_SUPPORTS_MIRROR_VFD)
    set (${HDF5_PACKAGE_NAME}_ENABLE_ROS3_VFD       ${HDF5_PACKAGE_NAME}_SUPPORTS_ROS3_VFD)
    set (${HDF5_PACKAGE_NAME}_ENABLE_HDFS_VFD       ${HDF5_PACKAGE_NAME}_SUPPORTS_HDFS)
    set (${HDF5_PACKAGE_NAME}_ENABLE_SUBFILING_VFD  ${HDF5_PACKAGE_NAME}_SUPPORTS_SUBFILING_VFD)
    set (${HDF5_PACKAGE_NAME}_ENABLE_PLUGIN_SUPPORT ${HDF5_PACKAGE_NAME}_SUPPORTS_PLUGIN_SUPPORT)
  endif ()
endmacro ()
