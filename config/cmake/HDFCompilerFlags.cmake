...
if (${CMAKE_SYSTEM_NAME} MATCHES "SunOS")
  ...
  elseif (CMAKE_C_COMPILER_ID STREQUAL "GNU")
    ...
    if (CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 4.8)
      ...
      ADD_H5_FLAGS (TMP_CFLAGS "${HDF5_SOURCE_DIR}/config/gnu-warnings/error-general")
      if (NOT HDF5_ENABLE_WARNINGS_AS_ERRORS)
        string (REGEX REPLACE "-Werror=" "-W" TMP_CFLAGS "${TMP_CFLAGS}")
      endif ()
      list (APPEND H5_CFLAGS ${TMP_CFLAGS})
    endif ()
  ...
  elseif (CMAKE_C_COMPILER_ID MATCHES "[Cc]lang")
    ...
    ADD_H5_FLAGS (TMP_CFLAGS "${HDF5_SOURCE_DIR}/config/clang-warnings/error-general")
    if (NOT HDF5_ENABLE_WARNINGS_AS_ERRORS)
      string (REGEX REPLACE "-Werror=" "-W" TMP_CFLAGS "${TMP_CFLAGS}")
    endif ()
    list (APPEND H5_CFLAGS ${TMP_CFLAGS})
...
if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
  ...
  if (NOT CMAKE_C_COMPILER_VERSION VERSION_LESS 5.0)
    ...
    ADD_H5_FLAGS (TMP_CFLAGS "${HDF5_SOURCE_DIR}/config/gnu-warnings/error-5")
    if (NOT HDF5_ENABLE_WARNINGS_AS_ERRORS)
      string (REGEX REPLACE "-Werror=" "-W" TMP_CFLAGS "${TMP_CFLAGS}")
    endif ()
    list (APPEND H5_CFLAGS ${TMP_CFLAGS})
