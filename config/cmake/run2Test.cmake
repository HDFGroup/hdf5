...
# help@hdfgroup.org.
#
# run2Test.cmake executes a command and captures the output in a file. File is then compared
# against a reference file or a second file. Exit status of command can also be compared.
...
if (TEST_REF_FILTER2)
  #message (STATUS "TEST_REF_FILTER: ${TEST_APPEND}${TEST_REF_FILTER2}")
  file (READ ${TEST_FOLDER}/${TEST_REFERENCE2} TEST_STREAM)
  string (REGEX REPLACE "${TEST_REF_APPEND}" "${TEST_REF_FILTER}" TEST_STREAM "${TEST_STREAM}")
  file (WRITE ${TEST_FOLDER}/${TEST_REFERENCE2} "${TEST_STREAM}")
endif ()

# compare output files to references unless this must be skipped
set (TEST_COMPARE_RESULT 0)
set (TEST_COMPARE_RESULT2 0)
if (NOT TEST_SKIP_COMPARE)
  ...
  if (EXISTS "${TEST_FOLDER}/${TEST_REFERENCE2}")
    file (READ ${TEST_FOLDER}/${TEST_REFERENCE2} TEST_STREAM)
    list (LENGTH TEST_STREAM test_len2)
    if (test_len2 GREATER 0)
      if (WIN32)
        configure_file(${TEST_FOLDER}/${TEST_REFERENCE2} ${TEST_FOLDER}/${TEST_REFERENCE2}.tmp NEWLINE_STYLE CRLF)
        if (EXISTS "${TEST_FOLDER}/${TEST_REFERENCE2}.tmp")
          file(RENAME ${TEST_FOLDER}/${TEST_REFERENCE2}.tmp ${TEST_FOLDER}/${TEST_REFERENCE2})
        endif ()
        #file (READ ${TEST_FOLDER}/${TEST_REFERENCE2} TEST_STREAM)
        #file (WRITE ${TEST_FOLDER}/${TEST_REFERENCE2} "${TEST_STREAM}")
      endif ()
  ...
  if (test_len GREATER 0)
    ...
    message (STATUS "TEST_COMPARE_RESULT: ${TEST_COMPARE_RESULT}\n")
  endif ()
  if (test_len2 GREATER 0)
    if (NOT TEST_SORT_COMPARE)
      # now compare the output with the reference2
      execute_process (
          COMMAND ${CMAKE_COMMAND} -E compare_files ${CMAKE_IGNORE_EOL} ${TEST_FOLDER}/${TEST_OUTPUT} ${TEST_FOLDER}/${TEST_REFERENCE2}
          RESULT_VARIABLE TEST_COMPARE_RESULT2
      )
    else ()
      file (STRINGS ${TEST_FOLDER}/${TEST_OUTPUT} v1)
      file (STRINGS ${TEST_FOLDER}/${TEST_REFERENCE2} v2)
      list (SORT v1)
      list (SORT v2)
      if (NOT v1 STREQUAL v2)
        set(TEST_COMPARE_RESULT2 1)
      endif ()
    endif ()
    message (STATUS "TEST_COMPARE_RESULT2: ${TEST_COMPARE_RESULT2}\n")
  endif ()

  if (TEST_COMPARE_RESULT AND TEST_COMPARE_RESULT2)
    file (STRINGS ${TEST_FOLDER}/${TEST_OUTPUT} test_act)
    list (LENGTH test_act len_act)
    file (STRINGS ${TEST_FOLDER}/${TEST_REFERENCE} test_ref)
    list (LENGTH test_ref len_ref)
    file (STRINGS ${TEST_FOLDER}/${TEST_REFERENCE2} test_ref2)
    list (LENGTH test_ref2 len_ref2)
    if (len_act GREATER 0 AND len_ref GREATER 0)
      ...
      foreach (line RANGE 0 ${_FP_LEN})
        ...
        if (len_ref2 GREATER 0)
          list (GET test_ref2 ${line} str_ref2)
          if (NOT str_act STREQUAL str_ref2)
            if (str_act)
              message (STATUS "line = ${line}\n***ACTUAL: ${str_act}\n****REFER2: ${str_ref2}\n")
            endif ()
          endif ()
