...
if (${HDF_PREFIX}_SIZEOF___FLOAT128 EQUAL 0 OR FLT128_DIG EQUAL 0)
  set (${HDF_PREFIX}_HAVE_FLOAT128 0)
  set (${HDF_PREFIX}_SIZEOF___FLOAT128 0)
  set (${HDF_PREFIX}_PAC_C_MAX_REAL_PRECISION ${H5_LDBL_DIG})
else ()
  set (${HDF_PREFIX}_PAC_C_MAX_REAL_PRECISION ${H5_FLT128_DIG})
endif ()
if (NOT ${HDF_PREFIX}_PAC_C_MAX_REAL_PRECISION)
   message (FATAL_ERROR "Failed to set ${HDF_PREFIX}_PAC_C_MAX_REAL_PRECISION")
endif ()
