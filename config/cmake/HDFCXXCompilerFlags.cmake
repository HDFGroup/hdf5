...
if (${CMAKE_SYSTEM_NAME} MATCHES "SunOS")
  ...
  elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    if (CMAKE_COMPILER_IS_GNUCXX AND CMAKE_CXX_COMPILER_LOADED
      ...
      ADD_H5_FLAGS (TMP_CXXFLAGS "${HDF5_SOURCE_DIR}/config/gnu-warnings/cxx-error-general")
      if (NOT HDF5_ENABLE_WARNINGS_AS_ERRORS)
        string (REGEX REPLACE "-Werror=" "-W" TMP_CXXFLAGS "${TMP_CXXFLAGS}")
      endif ()
      list (APPEND H5_CXXFLAGS ${TMP_CXXFLAGS})
    endif ()
...
if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  ...
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 5.0)
    ...
    ADD_H5_FLAGS (TMP_CXXFLAGS "${HDF5_SOURCE_DIR}/config/gnu-warnings/cxx-error-5")
    if (NOT HDF5_ENABLE_WARNINGS_AS_ERRORS)
      string (REGEX REPLACE "-Werror=" "-W" TMP_CXXFLAGS "${TMP_CXXFLAGS}")
    endif ()
    list (APPEND H5_CXXFLAGS ${TMP_CXXFLAGS})
  ...
  if (NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 8.0)
    ...
    ADD_H5_FLAGS (TMP_CXXFLAGS "${HDF5_SOURCE_DIR}/config/gnu-warnings/error-8")
    if (NOT HDF5_ENABLE_WARNINGS_AS_ERRORS)
      string (REGEX REPLACE "-Werror=" "-W" TMP_CXXFLAGS "${TMP_CXXFLAGS}")
    endif ()
    list (APPEND H5_CXXFLAGS ${TMP_CXXFLAGS})
