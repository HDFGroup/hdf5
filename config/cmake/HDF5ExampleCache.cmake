...
if (NOT BUILD_SHARED_LIBS AND BUILD_STATIC_LIBS)
  ...
  if (HDF5_BUILD_JAVA)
    set (HDF5_JAVA_INCLUDE_DIRS ${HDF5_JAVA_JARS})
    message (DEBUG "HDF5 Example java jars: ${HDF5_JAVA_INCLUDE_DIRS} = ${HDF5_JAVA_JARS}")
  endif ()
  if (HDF5_ENABLE_PLUGIN_SUPPORT)
    set (H5EX_HDF5_PLUGIN_PATH "${CMAKE_BINARY_DIR}/plugins")
  endif ()
endif ()
message (DEBUG "HDF5 Example link libs: ${H5EX_HDF5_LINK_LIBS} Includes: ${H5EX_HDF5_INCLUDE_DIRS}")
