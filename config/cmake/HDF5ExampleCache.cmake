...
set (H5EX_USE_HIGH_FIVE ${HDF5_USE_HIGH_FIVE} CACHE BOOL "Use HighFive C++ Headers instead of HDF5 C++ Library" FORCE)
...
if (NOT BUILD_SHARED_LIBS AND BUILD_STATIC_LIBS)
  ...
  if (HDF5_BUILD_CPP_LIB)
    if (NOT HDF5_USE_HIGH_FIVE)
      ...
      #set (H5EX_HDF5_LINK_LIBS ${H5EX_HDF5_LINK_LIBS} ${H5_HIGHFIVE_LIBS})
      set (H5EX_HDF5_INCLUDE_DIRS "${H5EX_HDF5_INCLUDE_DIRS};${H5_HIGHFIVE_INCLUDE_DIRS}" CACHE PATH "HDF5 include dirs" FORCE)
      endif ()
    endif ()
  endif ()
else ()
  ...
  if (HDF5_BUILD_CPP_LIB)
    if (NOT HDF5_USE_HIGH_FIVE)
      ...
      #message (STATUS "HIGHFIVE LIB: ${H5_HIGHFIVE_LIBS} INCLUDE: ${H5_HIGHFIVE_INCLUDE_DIRS}")
      #set (H5EX_HDF5_LINK_LIBS ${H5EX_HDF5_LINK_LIBS} ${H5_HIGHFIVE_LIBS})
      set (H5EX_HDF5_INCLUDE_DIRS "${H5EX_HDF5_INCLUDE_DIRS};${H5_HIGHFIVE_INCLUDE_DIRS}" CACHE PATH "HDF5 include dirs" FORCE)
      message (STATUS "HDF5 Example HF libs: ${H5EX_HDF5_LINK_LIBS} Includes: ${H5EX_HDF5_INCLUDE_DIRS}")
    endif ()
    #message (STATUS "HDF5 Example CPP libs: ${H5EX_HDF5_LINK_LIBS} Includes: ${H5EX_HDF5_INCLUDE_DIRS}")
  endif ()
  if (HDF5_BUILD_FORTRAN)
