...
if (NOT TEST_EXPECTED_STRING)
  message (VERBOSE "Optional TEST_EXPECTED_STRING to be defined")
endif ()
...
if (TEST_EXPECTED_STRING)
  string (REGEX MATCH "${TEST_EXPECTED_STRING}" TEST_MATCH ${TEST_STREAM})
  if (TEST_EXPECT)
    # TEST_EXPECT (1) interprets TEST_EXPECTED_STRING as; NOT to match
    string (LENGTH "${TEST_MATCH}" TEST_GREP_RESULT)
    if (TEST_GREP_RESULT)
      message (FATAL_ERROR "Failed: The output of ${TEST_PROGRAM} did contain ${TEST_EXPECTED_STRING}")
    endif ()
  endif ()
endif ()
