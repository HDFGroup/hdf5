...
public class H5 implements java.io.Serializable {
    ...
    public static int H5AreadVL(long attr_id, long mem_type_id, Object[] buf)
        throws HDF5LibraryException, NullPointerException
    {
        throw new HDF5LibraryException("H5AreadVL not implemented yet");
    }
    ...
    public static int H5AwriteVL(long attr_id, long mem_type_id, Object[] buf)
        throws HDF5LibraryException, NullPointerException
    {
        throw new HDF5LibraryException("H5AwriteVL not implemented yet");
    }
    ...
    public static int H5DreadVL(long dataset_id, long mem_type_id, long mem_space_id, long file_space_id,
        ...
        throws HDF5LibraryException, NullPointerException
    {
        throw new HDF5LibraryException("H5DreadVL not implemented yet");
    }
        ...
        throws HDF5LibraryException, NullPointerException
    {
        ...
        int status = -1;
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment bufSegment = arena.allocateFrom(ValueLayout.JAVA_BYTE, buf);
            status = org.hdfgroup.javahdf5.hdf5_h_1.H5Dwrite(dataset_id, mem_type_id, mem_space_id,
                                                             file_space_id, xfer_plist_id, bufSegment);
            if (status < 0) {
                h5libraryError();
            }
        }
    ...
    public static int H5DwriteVL(long dataset_id, long mem_type_id, long mem_space_id, long file_space_id,
        ...
        throws HDF5LibraryException, NullPointerException
    {
        throw new HDF5LibraryException("H5DwriteVL not implemented yet");
    }
                                ...
                                long min_id, String msg) throws HDF5LibraryException, NullPointerException
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment msg_segment  = arena.allocateFrom(msg);
            // Call the native method to push the error
            // TODO contains a variable argument list, which will need research.
            //            if (org.hdfgroup.javahdf5.hdf5_h_1.H5Epush2(stack_id, file_segment, func_segment,
            //            line, cls_id, maj_id,
            //                    min_id, msg_segment, null) < 0)
            //                h5libraryError();
        }
    }
        ...
        throws HDF5LibraryException, NullPointerException
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            type[0] = H5L_info2_t.type(linfo_segment);
        }
        ...
        throws HDF5LibraryException, NullPointerException
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            if (org.hdfgroup.javahdf5.hdf5_h_1.H5Lexists(loc_id, name_segment, lapl_id) < 0) {
                h5libraryError();
            }
            exists = true;
        }
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            if (H5L_info2_t.type(linfo_segment) == H5L_TYPE_HARD()) {
                hdf.hdf5lib.structs.H5O_token_t token = new hdf.hdf5lib.structs.H5O_token_t(
                    H5L_info2_t.u(linfo_segment).toArray(ValueLayout.JAVA_BYTE));
                info = new hdf.hdf5lib.structs.H5L_info_t(
                    H5L_info2_t.type(linfo_segment), H5L_info2_t.corder_valid(linfo_segment),
        ...
        throws HDF5LibraryException, NullPointerException
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            // Unpack the H5L_info2_t from the MemorySegment
            long val_size = H5L_info2_t.u.val_size(linfo_segment);
            link_type     = H5L_info2_t.type(linfo_segment);
                               ...
                               long ocpypl_id, long lcpl_id) throws HDF5LibraryException, NullPointerException
    {
        ...
        throw new HDF5LibraryException("H5Ocopy not implemented yet");
    }
        ...
        throws HDF5LibraryException, NullPointerException
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            org.hdfgroup.javahdf5.H5AC_cache_config_t.epoch_length(config_segment, config_ptr.epoch_length);
