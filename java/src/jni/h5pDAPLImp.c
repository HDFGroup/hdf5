 ...
 */
JNIEXPORT void JNICALL
Java_hdf_hdf5lib_H5_H5Pset_1dset_1use_1spatial_1tree(JNIEnv *env, jclass clss, jlong dapl_id, jboolean use_tree)
{
    bool use_tree_val;
    herr_t retVal = FAIL;
    ...
    if ((retVal = H5Pset_dset_use_spatial_tree((hid_t)dapl_id, (bool)use_tree_val)) < 0)
        H5_LIBRARY_ERROR(ENVONLY);

done:
    return;
} /* end Java_hdf_hdf5lib_H5_H5Pset_1dset_1use_1spatial_1tree */

/*
 * Class:     hdf_hdf5lib_H5
 * Method:    H5Pget_dset_use_spatial_tree
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL
Java_hdf_hdf5lib_H5_H5Pget_1dset_1use_1spatial_1tree(JNIEnv *env, jclass clss, jlong dapl_id)
{
    bool use_tree = false;
    ...
    if (H5Pget_dset_use_spatial_tree((hid_t)dapl_id, (bool *)&use_tree) < 0)
        H5_LIBRARY_ERROR(ENVONLY);
    ...
    return bval;
} /* end Java_hdf_hdf5lib_H5_H5Pget_1dset_1use_1spatial_1tree */
