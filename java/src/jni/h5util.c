...
static int    render_bin_output_region_points(FILE *stream, hid_t region_space, hid_t region_id,
                                              hid_t container);
jobject translate_atomic_rbuf(JNIEnv *env, jobject ret_buf, jlong mem_type_id, H5T_class_t type_class, jbyte *raw_buf);
void translate_atomic_wbuf(JNIEnv *env, jobject in_obj, jlong mem_type_id, H5T_class_t type_class, jbyte *raw_buf);
...
jobject
translate_atomic_rbuf(JNIEnv *env, jobject ret_buf, jlong mem_type_id, H5T_class_t type_class, jbyte *raw_buf)
{
    jobject      jobj        = NULL;
    hid_t        memb        = H5I_INVALID_HID;
    int          ret_buflen  = -1;
    ...
    switch (type_class) {
        case H5T_VLEN: {
            ...
            /* Get the number of sequence elements */
            HDmemcpy(&vl_elem, (char *)raw_buf, sizeof(hvl_t));
            ...
            if (NULL ==
                ...
                H5_OUT_OF_MEMORY_ERROR(ENVONLY,
                                       "translate_atomic_rbuf: failed to allocate list read buffer");
        ...
        case H5T_ARRAY: {
            ...
            HDmemcpy((char *)objBuf, (char *)raw_buf, typeSize);
        ...
        case H5T_INTEGER: {
            ...
            switch (typeSize) {
                case sizeof(jbyte): {
                    jbyte byteValue;
                    HDmemcpy(((char *)&byteValue), ((char *)raw_buf), typeSize);
                ...
                case sizeof(jshort): {
                    jshort shortValue;
                    HDmemcpy(((char *)&shortValue), ((char *)raw_buf), typeSize);
                ...
                case sizeof(jint): {
                    ...
                    HDmemcpy(((char *)&intValue), ((char *)raw_buf), typeSize);
                ...
                case sizeof(jlong): {
                    jlong longValue;
                    HDmemcpy(((char *)&longValue), ((char *)raw_buf), typeSize);
        ...
        case H5T_FLOAT: {
            ...
            switch (typeSize) {
                case sizeof(jfloat): {
                    jfloat floatValue;
                    HDmemcpy(((char *)&floatValue), ((char *)raw_buf), typeSize);
                ...
                case sizeof(jdouble): {
                    jdouble doubleValue;
                    HDmemcpy(((char *)&doubleValue), ((char *)raw_buf), typeSize);
...
void
translate_atomic_wbuf(JNIEnv *env, jobject in_obj, jlong mem_type_id, H5T_class_t type_class, jbyte *raw_buf)
{
    hid_t        memb   = H5I_INVALID_HID;
    H5T_class_t  vlClass;
    size_t       vlSize;
    ...
    switch (type_class) {
        ...
        case H5T_COMPOUND: {
            ...
            if (jnelmts != nmembs)
                H5_BAD_ARGUMENT_ERROR(ENVONLY, "translate_atomic_wbuf: number of elements not equal to number of members");
            ...
            for (i = 0; i < (size_t)nmembs; i++) {
                ...
                translate_atomic_wbuf(ENVONLY, arr_obj, memb, memb_vlClass, ((char *)raw_buf) + i * typeSize + memb_offset);
        ...
        case H5T_FLOAT: {
            ...
            switch (typeSize) {
                case sizeof(jfloat): {
                    ...
                    HDmemcpy(((char *)raw_buf), ((char *)&floatValue), typeSize);
                    break;
                }
                case sizeof(jdouble): {
                    jdouble doubleValue = ENVPTR->CallDoubleMethod(ENVONLY, in_obj, doubleValueMid);
                    HDmemcpy(((char *)raw_buf), ((char *)&doubleValue), typeSize);
                    break;
                }
            }
            break;
        ...
        case H5T_REFERENCE: {
            ...
            HDmemcpy(((char *)raw_buf), ((char *)barray), typeSize);
        ...
        case H5T_STRING: {
            ...
            HDmemset(((char *)raw_buf), 0, typeSize);
            if (NULL != in_obj) {
               ...
               jbyte *raw_buf)
{
    ...
    switch (type_class) {
        ...
        case H5T_STRING: {
            /* Convert each element to a list */
            for (i = 0; i < (size_t)count; i++) {
                jobj = translate_atomic_rbuf(ENVONLY, ret_buf, mem_type_id, type_class, ((char *)raw_buf) + i * typeSize);
                if (jobj) {
                    if (ret_buflen == 0)
    ...
    switch (type_class) {
        ...
        case H5T_COMPOUND: {
            ...
            for (i = 0; i < (size_t)count; i++) {
                ...
                if (jnelmts != nmembs)
                    H5_BAD_ARGUMENT_ERROR(ENVONLY, "translate_wbuf: number of elements not equal to number of members");
        ...
        case H5T_ARRAY: {
            ...
            for (i = 0; i < (size_t)count; i++) {
                ...
                translate_wbuf(ENVONLY, array, memb, vlClass, (jsize)jnelmts, (char *)raw_buf + i * vlSize * jnelmts);//objBuf);
