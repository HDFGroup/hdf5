...
#include "h5pFAPLImp.h"
     ...
     * Signature: (J)J
     */
    JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1driver(JNIEnv * env, jclass clss, jlong plist)
    {
     ...
     * Signature: (JI)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fclose_1degree(JNIEnv * env, jclass clss, jlong plist,
                                                                      jint fc_degree)
    {
        herr_t retVal = FAIL;
     ...
     * Signature: (J)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pget_1fclose_1degree(JNIEnv * env, jclass clss, jlong plist)
    {
     ...
     * Signature: (JJZ)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1core(JNIEnv * env, jclass clss, jlong fapl_id,
     ...
     * Signature: (J[J)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pget_1fapl_1direct(JNIEnv * env, jclass clss, jlong fapl_id,
                                                                    jlongArray info)
    {
#ifdef H5_HAVE_DIRECT
        jboolean isCopy;
     ...
     * Signature: (JJJ)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1family(JNIEnv * env, jclass clss, jlong plist,
                                                                    jlong memb_size, jlong memb_plist)
    {
     ...
     * Signature: (JJ)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1family_1offset(JNIEnv * env, jclass clss,
                                                                      jlong fapl_id, jlong offset)
    {
        herr_t retVal = FAIL;
     ...
     * Signature: (J)J
     */
    JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1family_1offset(JNIEnv * env, jclass clss,
                                                                       jlong fapl_id)
    {
        hsize_t offset = 0;
        herr_t  retVal = FAIL;
     ...
     */
    JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Pget_1fapl_1hdfs(JNIEnv * env, jclass clss, jlong fapl_id)
    {
        ...
        if (NULL == (j_user_name = ENVPTR->NewStringUTF(ENVONLY, fa.user_name))) {
            CHECK_JNI_EXCEPTION(ENVONLY, JNI_TRUE);
            H5_OUT_OF_MEMORY_ERROR(ENVONLY,
                                   "H5Pget_fapl_hdfs: out of memory - can't create user_name string");
        }
        ...
        if (NULL == (j_kerb_cache_path = ENVPTR->NewStringUTF(ENVONLY, fa.kerberos_ticket_cache))) {
            ...
            H5_OUT_OF_MEMORY_ERROR(
                ENVONLY, "H5Pget_fapl_hdfs: out of memory - can't create kerberos_ticket_cache string");
        }
     ...
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1hdfs(JNIEnv * env, jclass clss, jlong fapl_id,
                                                                  jobject fapl_config)
    {
#ifdef H5_HAVE_LIBHDFS
        ...
        if (j_str) {
            PIN_JAVA_STRING(ENVONLY, j_str, str, NULL,
                            "H5FDset_fapl_hdfs: fapl_config namenode_name not pinned");
     ...
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1log(JNIEnv * env, jclass clss, jlong fapl_id,
                                                                 jstring logfile, jlong flags, jlong buf_size)
    {
        ...
        if ((retVal =
                 H5Pset_fapl_log((hid_t)fapl_id, pLogfile, (unsigned long long)flags, (size_t)buf_size)) < 0)
            H5_LIBRARY_ERROR(ENVONLY);
    ...
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1multi(
        JNIEnv * env, jclass clss, jlong tid, jintArray memb_map, jlongArray memb_fapl,
        jobjectArray memb_name, jlongArray memb_addr, jboolean relax)
    {
        ...
        if (memb_fapl)
            PIN_LONG_ARRAY(ENVONLY, memb_fapl, thefaplArray, &isCopy,
                           "H5Pset_fapl_multi: memb_fapl not pinned");
        if (memb_addr)
            PIN_LONG_ARRAY(ENVONLY, memb_addr, theaddrArray, &isCopy,
                           "H5Pset_fapl_multi: memb_addr not pinned");

        if (memb_name) {
            for (i = 0; i < H5FD_MEM_NTYPES; i++) {
                size_t str_len;

                if (NULL == (obj = (jstring)ENVPTR->GetObjectArrayElement(ENVONLY, (jobjectArray)memb_name,
                                                                          (jsize)i))) {
                    CHECK_JNI_EXCEPTION(ENVONLY, JNI_FALSE);
        ...
        if ((status =
                 H5Pset_fapl_multi((hid_t)tid, (const H5FD_mem_t *)themapArray, (const hid_t *)thefaplArray,
    ...
    JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Pget_1fapl_1multi(
        JNIEnv * env, jclass clss, jlong tid, jintArray memb_map, jlongArray memb_fapl,
        jobjectArray memb_name, jlongArray memb_addr)
    {
        jboolean isCopy;
        jstring  str;
        herr_t   status = FAIL;
        ...
        if (memb_fapl)
            PIN_LONG_ARRAY(ENVONLY, memb_fapl, thefaplArray, &isCopy,
                           "H5Pget_fapl_multi: memb_fapl not pinned");
        if (memb_addr)
            PIN_LONG_ARRAY(ENVONLY, memb_addr, theaddrArray, &isCopy,
                           "H5Pget_fapl_multi: memb_addr not pinned");
        if (memb_name)
            ...
            for (i = 0; i < H5FD_MEM_NTYPES; i++) {
                if (mName[i]) {
                    if (NULL == (str = ENVPTR->NewStringUTF(ENVONLY, mName[i]))) {
                        CHECK_JNI_EXCEPTION(ENVONLY, JNI_TRUE);
                        H5_OUT_OF_MEMORY_ERROR(ENVONLY, "H5Pget_fapl_multi: out of memory - unable to "
     ...
     */
    JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Pget_1fapl_1ros3(JNIEnv * env, jclass clss, jlong fapl_id)
    {
        ...
        if (NULL == (j_aws = ENVPTR->NewStringUTF(ENVONLY, fa.aws_region))) {
            CHECK_JNI_EXCEPTION(ENVONLY, JNI_TRUE);
            H5_OUT_OF_MEMORY_ERROR(ENVONLY,
                                   "H5Pget_fapl_ros3: out of memory - can't create aws_region string");
        }
        args[0].l = j_aws;
        ...
        if (NULL == (j_id = ENVPTR->NewStringUTF(ENVONLY, fa.secret_id))) {
            CHECK_JNI_EXCEPTION(ENVONLY, JNI_TRUE);
            H5_OUT_OF_MEMORY_ERROR(ENVONLY,
                                   "H5Pget_fapl_ros3: out of memory - can't create secret_id string");
        }
        args[1].l = j_id;
        ...
        if (NULL == (j_key = ENVPTR->NewStringUTF(ENVONLY, fa.secret_key))) {
            CHECK_JNI_EXCEPTION(ENVONLY, JNI_TRUE);
            H5_OUT_OF_MEMORY_ERROR(ENVONLY,
                                   "H5Pget_fapl_ros3: out of memory - can't create secret_key string");
        }
        args[2].l = j_key;
     ...
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1ros3(JNIEnv * env, jclass clss, jlong fapl_id,
                                                                  jobject fapl_config)
    {
#ifdef H5_HAVE_ROS3_VFD
     ...
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1split(JNIEnv * env, jclass clss, jlong fapl_id,
                                                                   jstring metaext, jlong meta_pl_id,
                                                                   jstring rawext, jlong raw_pl_id)
    {
     ...
     * Signature: (J)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1sec2(JNIEnv * env, jclass clss, jlong fapl_id)
    {
        herr_t retVal = FAIL;
     ...
     * Signature: (J)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1stdio(JNIEnv * env, jclass clss, jlong fapl_id)
    {
        herr_t retVal = FAIL;
     ...
     * Signature: (J)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1fapl_1windows(JNIEnv * env, jclass clss, jlong fapl_id)
    {
        herr_t retVal = FAIL;
     ...
     * Signature: (JJ)V
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1meta_1block_1size(JNIEnv * env, jclass clss,
                                                                         jlong plist, jlong size)
    {
        long sz = (long)size;
     ...
     * Signature: (J)J
     */
    JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1meta_1block_1size(JNIEnv * env, jclass clss,
                                                                          jlong plist)
    {
        hsize_t s = 0;
     ...
     * Signature: (JJ)V
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1sieve_1buf_1size(JNIEnv * env, jclass clss,
                                                                        jlong plist, jlong size)
    {
     ...
     * Signature: (J)J
     */
    JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1sieve_1buf_1size(JNIEnv * env, jclass clss,
                                                                         jlong plist)
    {
        size_t s = 0;
     ...
     * Signature: (JJJ)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1alignment(JNIEnv * env, jclass clss, jlong plist,
                                                                 jlong threshold, jlong alignment)
    {
     ...
     * Signature: (J[J)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pget_1alignment(JNIEnv * env, jclass clss, jlong plist,
                                                                 jlongArray alignment)
    {
        jboolean isCopy;
        hsize_t  t = 0;
        hsize_t  a = 0;
     ...
     * Signature: (JIJJD)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1cache(JNIEnv * env, jclass clss, jlong plist,
                                                             jint mdc_nelmts, jlong rdcc_nelmts,
     ...
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pget_1cache(JNIEnv * env, jclass clss, jlong plist,
                                                             jintArray mdc_nelmts, jlongArray rdcc_nelmts,
                                                             jlongArray rdcc_nbytes, jdoubleArray rdcc_w0)
    {
...

        {
            ...
            if ((status = H5Pget_cache((hid_t)plist, (int *)NULL, &rdcc_nelmts_t, &nbytes_t,
                                       (double *)w0Array)) < 0)
                H5_LIBRARY_ERROR(ENVONLY);
     ...
     * Signature: (JI)V
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1elink_1file_1cache_1size(JNIEnv * env, jclass clss,
                                                                                jlong plist, jint size)
    {
     ...
     * Signature: (J)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pget_1elink_1file_1cache_1size(JNIEnv * env, jclass clss,
                                                                                jlong plist)
    {
        unsigned s = 0;
     ...
     * Signature: (J)Z
     */
    JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Pget_1evict_1on_1close(JNIEnv * env, jclass clss,
                                                                            jlong fapl_id)
    {
        bool     evict_on_close_val = false;
     ...
     * Signature: (JZZ)V
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1file_1locking(
     ...
     * Signature: (J)Z
     */
    JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Pget_1ignore_1disabled_1file_1locking(
     ...
     * Signature: (J)J
     */
    JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1metadata_1read_1attempts(JNIEnv * env, jclass clss,
                                                                                 jlong plist_id)
    {
        unsigned attempts = 0;
     ...
     */
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1mdc_1config(JNIEnv * env, jclass clss, jlong plist,
                                                                   jobject cache_config)
    {
        ...
        flash_incr_mode =
            ENVPTR->GetIntField(ENVONLY, cache_config, fid); /*(enum H5C_cache_flash_incr_mode) */
        CHECK_JNI_EXCEPTION(ENVONLY, JNI_FALSE);
     ...
     */
    JNIEXPORT jobject JNICALL Java_hdf_hdf5lib_H5_H5Pget_1mdc_1config(JNIEnv * env, jclass clss, jlong plist)
    {
        H5AC_cache_config_t cacheinfo;
        jstring             j_str = NULL;
        jvalue              args[30];
    ...
    JNIEXPORT void JNICALL Java_hdf_hdf5lib_H5_H5Pset_1mdc_1log_1options(
        JNIEnv * env, jclass clss, jlong fapl_id, jboolean is_enabled, jstring location,
        jboolean start_on_access)
    {
        ...
        PIN_JAVA_STRING(ENVONLY, location, locStr, NULL,
                        "H5Pset_mdc_log_options: location string not pinned");

        if ((retVal =
                 H5Pset_mdc_log_options((hid_t)fapl_id, (bool)is_enabled, locStr, (bool)start_on_access)) < 0)
            H5_LIBRARY_ERROR(ENVONLY);
     ...
     * Signature: (JZ)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1gc_1references(JNIEnv * env, jclass clss,
                                                                      jlong fapl_id, jboolean gc_ref)
    {
     ...
     * Signature: (J)Z
     */
    JNIEXPORT jboolean JNICALL Java_hdf_hdf5lib_H5_H5Pget_1gc_1references(JNIEnv * env, jclass clss,
                                                                          jlong fapl_id)
    {
        unsigned gc_ref_val = 0;
        jboolean bval       = JNI_FALSE;
     ...
     * Signature: (JJ)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1small_1data_1block_1size(JNIEnv * env, jclass clss,
                                                                                jlong plist, jlong size)
    {
        long   sz     = (long)size;
        herr_t retVal = FAIL;
     ...
     * Signature: (J)J
     */
    JNIEXPORT jlong JNICALL Java_hdf_hdf5lib_H5_H5Pget_1small_1data_1block_1size(JNIEnv * env, jclass clss,
                                                                                 jlong plist)
    {
        hsize_t s = 0;
     ...
     * Signature: (JII)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pset_1libver_1bounds(JNIEnv * env, jclass clss,
                                                                      jlong fapl_id, jint low, jint high)
    {
        herr_t retVal = FAIL;
     ...
     * Signature: (J[I)I
     */
    JNIEXPORT jint JNICALL Java_hdf_hdf5lib_H5_H5Pget_1libver_1bounds(JNIEnv * env, jclass clss,
                                                                      jlong fapl_id, jintArray libver)
    {
        jboolean isCopy;
        jint    *theArray = NULL;
        herr_t   retVal   = FAIL;
