...
public class TestH5DChunkIterPerf {
    ...
    public void testH5Dchunk_iter_vs_get_chunk_info_perf() throws Exception
    {
        ...
        System.out.println();
        System.out.printf("%10s %14s %14s %14s %16s %10s %16s%n", "size", "iter_ms", "all_ms", "indx_ms",
                          "indx_shared_ms", "ratio_all", "shared_ratio");
        ...
        for (int size : SIZES) {
            ...
            double indx_shared_ms = (t4 - t3) / 1.0e6;
            ...
            System.out.printf("%10d %14.3f %14.3f %14.3f %16.3f %10.3f %16.3f%n", size, iter_ms, all_ms,
                              indx_ms, indx_shared_ms, indx_ms / all_ms, indx_shared_ms / iter_ms);
        }
    }
}
