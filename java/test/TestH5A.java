...
public class TestH5A {
    ...
    public void testH5Aopen_by_idx()
    {
        ...
        try {
            ...
            try {
                n = 5;
                H5.H5Aopen_by_idx(loc_id, obj_name, idx_type, order, n, HDF5Constants.H5P_DEFAULT, lapl_id);
    ...
    public void testH5Arename() throws Throwable, HDF5LibraryException, NullPointerException
    {
        ...
        try {
            attr_id = H5.H5Acreate(loc_id, old_attr_name, type_id, space_id, HDF5Constants.H5P_DEFAULT,
                                   HDF5Constants.H5P_DEFAULT);
