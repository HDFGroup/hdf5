...
/**
 * {@snippet lang=c :
 * typedef herr_t (*H5E_walk1_t)(int, H5E_error1_t *, void *)
 * }
 */
public class H5E_walk1_t {
    ...
    private static final MethodHandle UP$MH = hdf5_h.upcallHandle(H5E_walk1_t.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(H5E_walk1_t.Function fi, Arena arena)
    {
