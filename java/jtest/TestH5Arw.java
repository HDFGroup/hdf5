...
public class TestH5Arw {
    ...
    public void openH5file(String filename, String dsetname)
    {
        ...
        try {
            H5aid = H5.H5Aopen(H5did, dsetname, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("TestH5Arw._openH5file: " + err);
    ...
    public void testH5Aread_8bit_ints()
    {
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_UINT8_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        try {
            H5aid = H5.H5Aopen(H5did, DATASETS08, H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_INT8_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Aread_8bit_ints: H5Aread: " + err);
    ...
    public void testH5Aread_16bit_ints()
    {
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_UINT16_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Open an existing attribute.
        try {
            H5aid = H5.H5Aopen(H5did, DATASETS16, H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_INT16_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Aread_16bit_ints: H5Aread: " + err);
    ...
    public void testH5Aread_32bit_ints()
    {
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_UINT32_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Open an existing attribute.
        try {
            H5aid = H5.H5Aopen(H5did, DATASETS32, H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_INT32_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Aread_32bit_ints: H5Aread: " + err);
    ...
    public void testH5Aread_64bit_ints()
    {
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_UINT64_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Open an existing attribute.
        try {
            H5aid = H5.H5Aopen(H5did, DATASETS64, H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_INT64_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Aread_64bit_ints: H5Aread: " + err);
    ...
    public void testH5Aread_32bit_floats()
    {
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_FLOAT_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    public void testH5Aread_64bit_floats()
    {
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_DOUBLE_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    public void testH5Aread_128bit_floats()
    {
        ...
        // Read data.
        try {
            H5.H5Aread(H5aid, H5T_NATIVE_LDOUBLE_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
