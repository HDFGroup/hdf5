...
public class TestH5Arw {
    ...
    public void openH5file(String filename, String dsetname)
    {
        ...
        assertTrue("TestH5Arw._openH5file: H5Fopen: ", H5fid >= 0);
        try {
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the string bytes
        ...
        assertTrue("TestH5Arw._openH5file: H5Dopen: ", H5did >= 0);
        try {
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the string bytes
                MemorySegment filename_segment = arena.allocateFrom(dsetname);
                H5aid                          = H5Aopen(H5did, filename_segment, H5P_DEFAULT());
            }
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        assertTrue("TestH5Arw._openH5file: H5Aopen: ", H5aid >= 0);
    }
    ...
    public void testH5Aread_8bit_ints()
    {
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_UINT8_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_INT8_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Aread_8bit_ints: H5Aread: " + err);
    ...
    public void testH5Aread_16bit_ints()
    {
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_UINT16_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_INT16_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Aread_16bit_ints: H5Aread: " + err);
    ...
    public void testH5Aread_32bit_ints()
    {
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_UINT32_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_INT32_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Aread_32bit_ints: H5Aread: " + err);
    ...
    public void testH5Aread_64bit_ints()
    {
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_UINT64_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        try {
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the string bytes
                MemorySegment filename_segment = arena.allocateFrom(DATASETS64);
                H5aid                          = H5Aopen(H5fid, filename_segment, H5P_DEFAULT());
            }
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_INT64_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Aread_64bit_ints: H5Aread: " + err);
    ...
    public void testH5Aread_32bit_floats()
    {
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_FLOAT_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        for (int i = 0; i < DIM_X; i++)
            assertTrue("testH5Aread_32bit_floats - H5Aread: ", attr_data[i][0] == (32 - i));
    }
    ...
    public void testH5Aread_64bit_floats()
    {
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_DOUBLE_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
        ...
        for (int i = 0; i < DIM_X; i++)
            assertTrue("testH5Aread_64bit_floats - H5Aread: ", attr_data[i][0] == (64 - i));
    }
    ...
    public void testH5Aread_128bit_floats()
    {
        ...
        // Read data.
        try {
            H5Aread(H5aid, H5T_NATIVE_LDOUBLE_g(), attr_data);
        }
        catch (Exception err) {
            err.printStackTrace();
