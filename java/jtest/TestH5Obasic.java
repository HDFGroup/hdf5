...
public class TestH5Obasic {
    ...
    public void testH5Oget_info_hardlink()
    {
        ...
        H5O_info_t obj_info = null;
        try {
            oid      = H5.H5Oopen(H5fid, "L1", H5P_DEFAULT());
            obj_info = H5.H5Oget_info(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oget_info_group()
    {
        ...
        H5O_info_t obj_info = null;
        try {
            oid      = H5.H5Oopen(H5fid, "G1", H5P_DEFAULT());
            obj_info = H5.H5Oget_info(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oget_info_datatype()
    {
        ...
        H5O_info_t obj_info = null;
        try {
            oid      = H5.H5Oopen(H5fid, "DT1", H5P_DEFAULT());
            obj_info = H5.H5Oget_info(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    {
        H5.H5Oget_info_by_name(H5fid, "None", H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_info_by_name_not_exists() throws Throwable
    {
        H5.H5Oget_info_by_name(H5fid, "Bogus", H5P_DEFAULT());
    }
    ...
    public void testH5Oget_info_by_name_dataset()
    {
        ...
        try {
            obj_info = H5.H5Oget_info_by_name(H5fid, "DS1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Oget_info: " + err);
    ...
    public void testH5Oget_info_by_name_group()
    {
        H5O_info_t obj_info = null;
        try {
            obj_info = H5.H5Oget_info_by_name(H5fid, "G1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Oget_info: " + err);
    ...
    public void testH5Oget_info_by_name_datatype()
    {
        H5O_info_t obj_info = null;
        try {
            obj_info = H5.H5Oget_info_by_name(H5fid, "DT1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Oget_info: " + err);
    ...
    {
        H5.H5Oget_native_info_by_name(H5fid, "None", H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_native_info_by_name_not_exists() throws Throwable
    {
        H5.H5Oget_native_info_by_name(H5fid, "Bogus", H5P_DEFAULT());
    }
    ...
    public void testH5Oget_native_info_by_name_dataset()
    {
        ...
        try {
            native_info = H5.H5Oget_native_info_by_name(H5fid, "DS1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oget_native_info_by_name_hardlink()
    {
        ...
        try {
            native_info = H5.H5Oget_native_info_by_name(H5fid, "L1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Oget_native_info_by_name: " + err);
    ...
    public void testH5Oget_native_info_by_name_group()
    {
        ...
        try {
            native_info = H5.H5Oget_native_info_by_name(H5fid, "G1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Oget_native_info_by_name: " + err);
    ...
    public void testH5Oget_native_info_by_name_datatype()
    {
        ...
        try {
            native_info = H5.H5Oget_native_info_by_name(H5fid, "DT1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Oget_native_info_by_name: " + err);
    ...
    public void testH5Ovisit()
    {
        ...
        try {
            H5.H5Ovisit(H5fid, H5_INDEX_NAME(), H5_ITER_INC(), iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oexists_by_name()
    {
        ...
        try {
            name_exists = H5.H5Oexists_by_name(H5fid, "G1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
