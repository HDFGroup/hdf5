...
public class TestH5Obasic {
    ...
    {
        long oid             = H5I_INVALID_HID();
        H5O_info2_t obj_info = null;

        try {
            oid      = H5Oopen(H5fid, "DS1", H5P_DEFAULT());
            obj_info = H5Oget_info(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oget_info_hardlink()
    {
        ...
        H5O_info2_t obj_info = null;
        try {
            oid      = H5Oopen(H5fid, "L1", H5P_DEFAULT());
            obj_info = H5Oget_info(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oget_info_group()
    {
        ...
        H5O_info2_t obj_info = null;
        try {
            oid      = H5Oopen(H5fid, "G1", H5P_DEFAULT());
            obj_info = H5Oget_info(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oget_info_datatype()
    {
        ...
        H5O_info2_t obj_info = null;
        try {
            oid      = H5Oopen(H5fid, "DT1", H5P_DEFAULT());
            obj_info = H5Oget_info(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    {
        H5Oget_info_by_name(H5fid, "None", H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_info_by_name_not_exists() throws Throwable
    {
        H5Oget_info_by_name(H5fid, "Bogus", H5P_DEFAULT());
    }
    ...
    public void testH5Oget_info_by_name_dataset()
    {
        ...
        try {
            obj_info = H5Oget_info_by_name(H5fid, "DS1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Oget_info: " + err);
    ...
    public void testH5Oget_info_by_name_hardlink()
    {
        H5O_info2_t obj_info = null;
        try {
            obj_info = H5Oget_info_by_name(H5fid, "L1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Oget_info: " + err);
    ...
    public void testH5Oget_info_by_name_group()
    {
        H5O_info2_t obj_info = null;
        try {
            obj_info = H5Oget_info_by_name(H5fid, "G1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Oget_info: " + err);
    ...
    public void testH5Oget_info_by_name_datatype()
    {
        H5O_info2_t obj_info = null;
        try {
            obj_info = H5Oget_info_by_name(H5fid, "DT1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Oget_info: " + err);
    ...
    {
        H5Oget_info_by_idx(H5fid, "None", H5_INDEX_NAME(), H5_ITER_INC(), 0, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_info_by_idx_name_not_exist_create() throws Throwable
    {
        H5Oget_info_by_idx(H5fid, "None", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_info_by_idx_not_exist_name() throws Throwable
    {
        H5Oget_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 5, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_info_by_idx_not_exist_create() throws Throwable
    {
        H5Oget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 5, H5P_DEFAULT());
    }
    ...
    public void testH5Oget_info_by_idx_n0()
    {
        ...
        try {
            ...
            err.printStackTrace();
            fail("testH5Oget_info_by_idx_n0:H5Oget_info: " + err);
        }
        ...
        try {
            obj_info = H5Oget_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 0, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("testH5Oget_info_by_idx_n0:H5Oget_info_by_idx: " + err);
        }
    ...
    public void testH5Oget_info_by_idx_n3()
    {
        ...
        try {
            ...
            err.printStackTrace();
            fail("testH5Oget_info_by_idx_n3:H5Oget_info: " + err);
        }
        ...
        try {
            obj_info = H5Oget_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 3, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("testH5Oget_info_by_idx_n3:H5Oget_info_by_idx: " + err);
        }
    ...
    public void testH5Oget_native_info_dataset()
    {
        ...
        try {
            oid         = H5Oopen(H5fid, "DS1", H5P_DEFAULT());
            native_info = H5Oget_native_info(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    {
        H5Oget_native_info_by_name(H5fid, "None", H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_native_info_by_name_not_exists() throws Throwable
    {
        H5Oget_native_info_by_name(H5fid, "Bogus", H5P_DEFAULT());
    }
    ...
    public void testH5Oget_native_info_by_name_dataset()
    {
        ...
        try {
            native_info = H5Oget_native_info_by_name(H5fid, "DS1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oget_native_info_by_name_hardlink()
    {
        ...
        try {
            native_info = H5Oget_native_info_by_name(H5fid, "L1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Oget_native_info_by_name: " + err);
    ...
    public void testH5Oget_native_info_by_name_group()
    {
        ...
        try {
            native_info = H5Oget_native_info_by_name(H5fid, "G1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Oget_native_info_by_name: " + err);
    ...
    public void testH5Oget_native_info_by_name_datatype()
    {
        ...
        try {
            native_info = H5Oget_native_info_by_name(H5fid, "DT1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Oget_native_info_by_name: " + err);
    ...
    {
        H5Oget_native_info_by_idx(H5fid, "None", H5_INDEX_NAME(), H5_ITER_INC(), 0, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_native_info_by_idx_name_not_exist_create() throws Throwable
    {
        H5Oget_native_info_by_idx(H5fid, "None", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_native_info_by_idx_not_exist_name() throws Throwable
    {
        H5Oget_native_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 5, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_native_info_by_idx_not_exist_create() throws Throwable
    {
        H5Oget_native_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 5, H5P_DEFAULT());
    }
    ...
    public void testH5Oget_native_info_by_idx_n0()
    {
        ...
        try {
            ...
            err.printStackTrace();
            fail("testH5Oget_native_info_by_idx_n0:H5Oget_native_info: " + err);
        }
        ...
        try {
            native_info =
                H5Oget_native_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 0, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("testH5Oget_native_info_by_idx_n0:H5Oget_native_info_by_idx: " + err);
        }
    ...
    public void testH5Oget_native_info_by_idx_n3()
    {
        ...
        try {
            ...
            err.printStackTrace();
            fail("testH5Oget_native_info_by_idx_n3:H5Oget_native_info: " + err);
        }
        ...
        try {
            native_info =
                H5Oget_native_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 3, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("testH5Oget_native_info_by_idx_n3:H5Oget_native_info_by_idx: " + err);
        }
        assertFalse("H5Oget_native_info_by_idx ", native_info == null);
        assertFalse("H5Oget_native_info_by_idx ", native_info.hdr_info == null);
        assertFalse("H5Oget_native_info_by_idx ", native_info.obj_info == null);
    ...
    public void testH5Ovisit()
    {
        ...
        class H5O_iter_data extends H5O_iterate2_t {
            public ArrayList<idata> iterdata = new ArrayList<idata>();
        }
        H5O_iterate2_t iter_data = new H5O_iter_data();
        class H5O_iter_callback implements H5O_iterate2_t {
            public int apply(long group, String name, H5O_info2_t info, H5O_iterate2_t.Function op_data)
            {
        ...
        H5O_iterate2_t iter_cb = new H5O_iter_callback();
        try {
            H5Ovisit3(H5fid, H5_INDEX_NAME(), H5_ITER_INC(), iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Ovisit: " + err);
    ...
    public void testH5Ovisit_by_name()
    {
        ...
        H5O_iterate2_t iter_cb = new H5O_iter_callback();
        try {
            H5Ovisit_by_name3(H5fid, "G1", H5_INDEX_NAME(), H5_ITER_INC(), iter_cb, iter_data, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oexists_by_name()
    {
        ...
        try {
            name_exists = H5Oexists_by_name(H5fid, "G1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oopen_by_token()
    {
        ...
        try {
            try {
                ...
                err.printStackTrace();
                fail("testH5Oopen_by_token: H5Oget_info: " + err);
            }
            H5la_ds1 = obj_info.token;
            try {
                H5Oclose(oid);
            ...
            try {
                oid = H5Oopen_by_token(H5fid, H5la_ds1);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("testH5Oopen_by_token: H5Oopen_by_token: " + err);
            }
            try {
                obj_info = H5Oget_info(oid);
            }
    ...
    public void testH5Oopen_by_idx_n0()
    {
        ...
        try {
            try {
                ...
                err.printStackTrace();
                fail("testH5Oopen_by_idx_n0: H5Oget_info: " + err);
            }
            H5la_ds1 = obj_info.token;
            try {
                H5Oclose(oid);
            ...
            try {
                oid = H5Oopen_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 0, H5P_DEFAULT());
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("testH5Oopen_by_idx_n0: H5Oopen_by_idx: " + err);
            }
            try {
                obj_info = H5Oget_info(oid);
            }
                ...
                err.printStackTrace();
                fail("testH5Oopen_by_idx_n0: H5Oget_info_by_idx: " + err);
            }
    ...
    public void testH5Oopen_by_idx_n3()
    {
        ...
        try {
            try {
                ...
                err.printStackTrace();
                fail("testH5Oopen_by_idx_n3:H5Oget_info: " + err);
            }
            H5la_l1 = obj_info.token;
            try {
                H5Oclose(oid);
            ...
            try {
                oid = H5Oopen_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 3, H5P_DEFAULT());
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("testH5Oopen_by_idx_n3: H5Oopen_by_idx: " + err);
            }
            try {
                obj_info = H5Oget_info(oid);
            }
                ...
                err.printStackTrace();
                fail("testH5Oopen_by_idx_n3:H5Oget_info_by_idx: " + err);
            }
