...
public class TestH5Oparams {
    ...
    {
        H5.H5Oget_info_by_name(-1, null, 0, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_info_by_name_invalid() throws Throwable
    {
        H5.H5Oget_info_by_name(-1, "/testH5Gcreate", 0, H5P_DEFAULT());
    }
    ...
    {
        H5.H5Oget_native_info_by_name(-1, null, 0, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Oget_native_info_by_name_invalid() throws Throwable
    {
        H5.H5Oget_native_info_by_name(-1, "/testH5Gcreate", 0, H5P_DEFAULT());
    }
