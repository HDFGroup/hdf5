...
public class TestH5PData {
    ...
    private final long _createFloatDataset(long fid, long dsid, String name, long dapl)
    {
        ...
        try {
            try (Arena arena = Arena.ofConfined()) {
                ...
                did = H5Dcreate2(fid, name_segment, H5T_NATIVE_FLOAT_g(), dsid, H5P_DEFAULT(), H5P_DEFAULT(),
                                 dapl);
            }
            catch (Throwable err) {
                err.printStackTrace();
    ...
    public void testH5Pdata_transform()
    {
        ...
        try {
            ...
            H5Dwrite(H5did, H5T_NATIVE_DOUBLE_g(), H5S_ALL(), H5S_ALL(), plist_id, windchillF);
            H5Dread(H5did, H5T_NATIVE_DOUBLE_g(), H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), windchillFread);
        }
        catch (Throwable err) {
            err.printStackTrace();
