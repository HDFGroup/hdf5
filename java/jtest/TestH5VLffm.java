...
public class TestH5VLffm {
    ...
    public void testH5VLis_connector_registered_by_name()
    {
        try (Arena arena = Arena.ofConfined()) {
            ...
            result                  = hdf5_h_1.H5VLis_connector_registered_by_name(fake_name);
    ...
    public void testH5VLis_connector_registered_by_value()
    {
        ...
        int result = hdf5_h_1.H5VLis_connector_registered_by_value(hdf5_h.H5_VOL_NATIVE());
        assertTrue("Native VOL connector should be registered", result > 0);
    ...
    {
        long connector_id = hdf5_h_1.H5VLget_connector_id(H5fid);
        assertTrue("Should get valid connector ID for file", isValidId(connector_id));

        // Close the connector ID
        closeQuietly(connector_id, hdf5_h_1::H5VLclose);
    }
    ...
    public void testH5VLget_connector_id_by_name()
    {
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment name = stringToSegment(arena, "native");
            long connector_id  = hdf5_h_1.H5VLget_connector_id_by_name(name);
    ...
    {
        long connector_id = hdf5_h_1.H5VLget_connector_id_by_value(hdf5_h.H5_VOL_NATIVE());
    ...
    public void testH5VLget_connector_name()
    {
        try (Arena arena = Arena.ofConfined()) {
            ...
            long size = hdf5_h_1.H5VLget_connector_name(H5fid, MemorySegment.NULL, 0);
            ...
            long actual_size       = hdf5_h_1.H5VLget_connector_name(H5fid, name_buf, size + 1);
    ...
    public void testH5VLobject_is_native()
    {
        try (Arena arena = Arena.ofConfined()) {
            ...
            int result = hdf5_h_1.H5VLobject_is_native(H5fid, is_native);
    ...
    public void testH5VLregister_and_unregister_connector_by_name()
    {
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment name = stringToSegment(arena, "native");
            long connector_id  = hdf5_h_1.H5VLregister_connector_by_name(name, hdf5_h.H5P_DEFAULT());
            assertTrue("Should get valid connector ID", isValidId(connector_id));

            // Verify it's registered
            int is_registered = hdf5_h_1.H5VLis_connector_registered_by_name(name);
    ...
    public void testH5VLget_connector_id_for_dataset()
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            long connector_id = hdf5_h_1.H5VLget_connector_id(dset_id);
            assertTrue("Should get valid connector ID for dataset", isValidId(connector_id));

            // Verify it's native
            MemorySegment is_native = arena.allocate(ValueLayout.JAVA_BOOLEAN);
            int result              = hdf5_h_1.H5VLobject_is_native(dset_id, is_native);
            assertEquals("H5VLobject_is_native should succeed", 0, result);
            ...
            closeQuietly(dset_id, hdf5_h_1::H5Dclose);
        }
    }
    ...
    public void testH5VLquery_optional()
    {
        try (Arena arena = Arena.ofConfined()) {
            ...
            int result = hdf5_h_1.H5VLquery_optional(H5fid, 0, 0, flags);
