...
public class TestH5Edefault {
    ...
    public void testH5Eprint()
    {
        ...
        if (connector == null) {
            try {
                H5.H5Fopen("test", H5F_ACC_RDWR(), H5P_DEFAULT());
            }
            catch (Throwable err) {
            }
            try {
                H5.H5Eprint2(H5E_DEFAULT(), null);
            }
            catch (Throwable err) {
                err.printStackTrace();
    ...
    public void testH5Eget_current_stack_pop()
    {
        ...
        try {
            num_msg_default = H5.H5Eget_num(H5E_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Eget_current_stack: " + err);
    ...
    {
        H5.H5Eget_class_name(H5E_DEFAULT());
    }
    ...
    {
        H5.H5Ecreate_msg(-1, H5E_MAJOR(), "null");
    }
    ...
    public void testH5Eset_current_stack()
    {
        ...
        // Verify we have a nonzero number of messages and save it
        try {
            num_msg = H5.H5Eget_num(H5E_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Eauto_is_v2()
    {
        boolean is_v2 = false;
        try {
            is_v2 = H5.H5Eauto_is_v2(H5E_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
