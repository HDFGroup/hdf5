...
public class TestH5Lffm {
    ...
    public void testH5Lget_info()
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            int result = hdf5_h_1.H5Lcreate_hard(H5fid, groupName, H5fid, linkName, hdf5_h.H5P_DEFAULT(),
                                                 hdf5_h.H5P_DEFAULT());
            assertTrue("H5Lcreate_hard failed", isSuccess(result));
    ...
    public void testH5Lget_info_by_idx()
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment linfo = arena.allocate(56); // H5L_info_t size
            int result =
                hdf5_h_1.H5Lget_info_by_idx2(gid, stringToSegment(arena, "."), hdf5_h.H5_INDEX_NAME(),
    ...
    public void testH5Lget_val()
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            int result = hdf5_h_1.H5Lcreate_soft(targetPath, H5fid, linkName, hdf5_h.H5P_DEFAULT(),
                                                 hdf5_h.H5P_DEFAULT());
            assertTrue("H5Lcreate_soft failed", isSuccess(result));
    ...
    public void testH5Lget_val_by_idx()
    {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            int result = hdf5_h_1.H5Lcreate_soft(targetPath, gid, linkName, hdf5_h.H5P_DEFAULT(),
                                                 hdf5_h.H5P_DEFAULT());
            assertTrue("H5Lcreate_soft failed", isSuccess(result));
