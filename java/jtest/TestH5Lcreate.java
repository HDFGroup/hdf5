...
public class TestH5Lcreate {
                                       ...
                                       long lcpl, long lapl)
    {
        ...
        try {
            H5Lcreate_hard(cid, curname, did, dstname, lcpl, lapl);
            H5Fflush(fid, H5F_SCOPE_LOCAL());
            link_exists = H5Lexists(did, dstname, lapl);
        }
        catch (Throwable err) {
            err.printStackTrace();
                                       ...
                                       long lapl)
    {
        boolean link_exists = false;
        try {
            H5Lcreate_soft(curname, did, dstname, lcpl, lapl);
            H5Fflush(fid, H5F_SCOPE_LOCAL());
            link_exists = H5Lexists(did, dstname, lapl);
        }
        catch (Throwable err) {
                                           ...
                                           String dstname, long lcpl, long lapl)
    {
        boolean link_exists = false;
        try {
            H5Lcreate_external(ext_filename, curname, did, dstname, lcpl, lapl);
            H5Fflush(fid, H5F_SCOPE_LOCAL());
            link_exists = H5Lexists(did, dstname, lapl);
        }
        catch (Throwable err) {
    ...
    public void createH5file() throws NullPointerException, HDF5Exception
    {
        ...
        assertTrue("TestH5L.createH5file: H5Fcreate: ", H5fid > 0);
        try {
        ...
        assertTrue("TestH5L.createH5file: H5Screate_simple: ", H5dsid > 0);
        assertTrue("TestH5L.createH5file: H5Gcreate: ", H5gid > 0);
    ...
    public void testH5Lget_info_by_idx_n0_create()
    {
        ...
        try {
            ...
            err.printStackTrace();
            fail("H5Lget_info_by_idx_n0_create:H5Pget_link_creation_order " + err);
        }
        try {
            link_info = H5Lget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Lget_info_by_idx_n1_create()
    {
        ...
        try {
            ...
            err.printStackTrace();
            fail("H5Lget_info_by_idx_n1_create:H5Pget_link_creation_order " + err);
        }
        try {
            link_info = H5Lget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 1, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lget_info_by_idx: " + err);
    ...
    {
        H5Lcreate_hard(H5fid, "None", H5fid, "DS1", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        try {
            H5Lcreate_hard(H5fid, "DS1", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5Lexists(H5fid, "L1", H5P_DEFAULT());
    ...
    {
        _createHardLink(H5fid, H5fid, "/G1/DS2", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
        H5Lcreate_hard(H5fid, "L1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    public void testH5Ldelete_hard_link()
    {
        _createHardLink(H5fid, H5fid, "/G1/DS2", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            H5Ldelete(H5fid, "L1", H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5Lexists(H5fid, "L1", H5P_DEFAULT());
    ...
    {
        try {
            H5Lcreate_soft("DS1", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5Lexists(H5fid, "L1", H5P_DEFAULT());
    ...
    {
        _createSoftLink(H5fid, "/G1/DS2", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
        H5Lcreate_soft("L1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    public void testH5Lget_info_softlink()
    {
        ...
        _createSoftLink(H5fid, "/G1/DS2", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            link_info = H5Lget_info(H5fid, "L1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Lget_value_soft()
    {
        ...
        _createSoftLink(H5fid, "/G1/DS2", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            link_type = H5Lget_value(H5fid, "L1", link_value, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lget_value: " + err);
        }
    ...
    {
        try {
            H5Lcreate_soft("DS3", H5fid, "L2", H5P_DEFAULT(), H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5Lexists(H5fid, "L2", H5P_DEFAULT());
            assertTrue("testH5Lcreate_soft:H5Lexists ", link_exists);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    {
        _createSoftLink(H5fid, "DS3", H5fid, "L2", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            H5Ldelete(H5fid, "L2", H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5Lexists(H5fid, "L2", H5P_DEFAULT());
            assertFalse("testH5Lcreate_soft:H5Lexists ", link_exists);
        }
    ...
    public void testH5Lget_info_softlink_dangle()
    {
        ...
        _createSoftLink(H5fid, "DS3", H5fid, "L2", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            link_info = H5Lget_info(H5fid, "L2", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lget_info: " + err);
    ...
    public void testH5Lget_value_dangle()
    {
        ...
        _createSoftLink(H5fid, "DS3", H5fid, "L2", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            link_type = H5Lget_value(H5fid, "L2", link_value, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lget_value: " + err);
    ...
    {
        try {
            H5Lcreate_external(H5_EXTFILE, "DT1", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5Lexists(H5fid, "L1", H5P_DEFAULT());
    ...
    public void testH5Lget_value_external()
    {
        ...
        assertTrue("Link Type", link_type == H5L_TYPE_EXTERNAL());
        assertFalse("H5Lget_value ", link_value[0] == null);
    ...
    {
        H5Lcopy(H5fid, "None", H5fid, "DS1", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        try {
            H5Lcopy(H5fid, "DS1", H5fid, "CPY1", H5P_DEFAULT(), H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5Lexists(H5fid, "CPY1", H5P_DEFAULT());
    ...
    public void testH5Lcopy_dst_link_exists() throws Throwable
    {
        ...
        H5Lcopy(H5fid, "CPY1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Lmove_cur_not_exists() throws Throwable
    {
        H5Lmove(H5fid, "None", H5fid, "DS1", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        try {
            H5Lmove(H5fid, "DS1", H5fid, "CPY1", H5P_DEFAULT(), H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5Lexists(H5fid, "CPY1", H5P_DEFAULT());
    ...
    {
        _createHardLink(H5fid, H5fid, "/G1/DS2", H5fid, "CPY1", H5P_DEFAULT(), H5P_DEFAULT());
        H5Lmove(H5fid, "CPY1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        String[] link_value = {null, null};
        H5Lget_value_by_idx(H5fid, "None", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, link_value, H5P_DEFAULT());
    }
    ...
    {
        String[] link_value = {null, null};
        H5Lget_value_by_idx(H5fid, "None", H5_INDEX_NAME(), H5_ITER_INC(), 0, link_value, H5P_DEFAULT());
    }
    ...
    public void testH5Lget_value_by_idx_n2_name()
    {
        ...
        try {
            link_info = H5Lget_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lget_info_by_idx: " + err);
        ...
        try {
            link_type =
                H5Lget_value_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 2, link_value, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lget_value_by_idx: " + err);
        }
        assertTrue("Link Type", link_type == HDF5Constants.H5L_TYPE_SOFT);
    ...
    public void testH5Lget_value_by_idx_n2_create()
    {
        ...
        try {
            int order = H5Pget_link_creation_order(H5fcpl);
            assertTrue("creation order :" + order,
                       order == H5P_CRT_ORDER_TRACKED() + H5P_CRT_ORDER_INDEXED());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lget_value_by_idx_n2_create: H5Pget_link_creation_order " + err);
        }
        _createSoftLink(H5fid, "/G1/DS2", H5fid, "LS", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            link_info = H5Lget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lget_info_by_idx: " + err);
        ...
        assertFalse("testH5Lget_value_by_idx_n2 ", link_info == null);
        assertTrue("testH5Lget_value_by_idx_n2 link type", link_info.type == H5L_TYPE_SOFT());
        try {
            link_type = H5Lget_value_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 2, link_value,
                                            H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        assertTrue("Link Type", link_type == H5L_TYPE_SOFT());
        assertFalse("testH5Lget_value_by_idx_n2 ", link_value[0] == null);
        assertTrue("testH5Lget_value_by_idx_n2 Link Value ", link_value[0].compareTo("/G1/DS2") == 0);
    }
    ...
    {
        H5Ldelete_by_idx(H5fid, "None", H5_INDEX_NAME(), H5_ITER_INC(), 0, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Ldelete_by_idx_not_exist_create() throws Throwable
    {
        H5Ldelete_by_idx(H5fid, "None", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, H5P_DEFAULT());
    }
    ...
    public void testH5Ldelete_by_idx_n2_name()
    {
        ...
        try {
            H5Ldelete_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Ldelete_by_idx: " + err);
        }
        try {
            link_info = H5Lget_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
    ...
    public void testH5Ldelete_by_idx_n2_create()
    {
        ...
        assertTrue("testH5Ldelete_by_idx_n2 link type", link_info.type == HDF5Constants.H5L_TYPE_SOFT);
        try {
            H5Ldelete_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Ldelete_by_idx: " + err);
    ...
    public void testH5Lvisit_create()
    {
        try {
            ...
            err.printStackTrace();
            fail("H5Lvisit_create: H5Pget_link_creation_order " + err);
        }
        ...
        H5L_iteratet iter_cb = new H5L_iter_callback();
        try {
            H5Lvisit(H5fid, H5_INDEX_CRT_ORDER(), H5_ITER_INC(), iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Lvisit: " + err);
    ...
    public void testH5Literate_create()
    {
        try {
            ...
            err.printStackTrace();
            fail("H5Literate_create: H5Pget_link_creation_order " + err);
        }
        ...
        try {
            H5Literate(H5fid, H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Literate: " + err);
