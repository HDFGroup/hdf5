...
public class TestH5Lcreate {
    ...
    public void testH5Lget_info_by_idx_n0_create()
    {
        ...
        try {
            link_info =
                H5.H5Lget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Lget_info_by_idx_n1_create()
    {
        ...
        try {
            link_info =
                H5.H5Lget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 1, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lget_info_by_idx: " + err);
    ...
    {
        H5.H5Lcreate_hard(H5fid, "None", H5fid, "DS1", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        try {
            H5.H5Lcreate_hard(H5fid, "DS1", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
            H5.H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5.H5Lexists(H5fid, "L1", H5P_DEFAULT());
    ...
    public void testH5Lcreate_hard_dst_link_exists() throws Throwable
    {
        ...
        H5.H5Lcreate_hard(H5fid, "L1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    public void testH5Ldelete_hard_link()
    {
        _createHardLink(H5fid, H5fid, "/G1/DS2", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            H5.H5Ldelete(H5fid, "L1", H5P_DEFAULT());
            H5.H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5.H5Lexists(H5fid, "L1", H5P_DEFAULT());
    ...
    {
        try {
            H5.H5Lcreate_soft("DS1", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
            H5.H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5.H5Lexists(H5fid, "L1", H5P_DEFAULT());
    ...
    public void testH5Lcreate_soft_dst_link_exists() throws Throwable
    {
        ...
        H5.H5Lcreate_soft("L1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    public void testH5Lget_value_soft()
    {
        ...
        _createSoftLink(H5fid, "/G1/DS2", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            link_type = H5.H5Lget_value(H5fid, "L1", link_value, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    {
        try {
            H5.H5Lcreate_soft("DS3", H5fid, "L2", H5P_DEFAULT(), H5P_DEFAULT());
            H5.H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5.H5Lexists(H5fid, "L2", H5P_DEFAULT());
            assertTrue("testH5Lcreate_soft:H5Lexists ", link_exists);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Ldelete_soft_link_dangle()
    {
        ...
        try {
            H5.H5Ldelete(H5fid, "L2", H5P_DEFAULT());
            H5.H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5.H5Lexists(H5fid, "L2", H5P_DEFAULT());
            assertFalse("testH5Lcreate_soft:H5Lexists ", link_exists);
        }
    ...
    public void testH5Lget_info_softlink_dangle()
    {
        ...
        _createSoftLink(H5fid, "DS3", H5fid, "L2", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            link_info = H5.H5Lget_info(H5fid, "L2", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lget_info: " + err);
    ...
    public void testH5Lget_value_dangle()
    {
        ...
        _createSoftLink(H5fid, "DS3", H5fid, "L2", H5P_DEFAULT(), H5P_DEFAULT());
        try {
            link_type = H5.H5Lget_value(H5fid, "L2", link_value, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lget_value: " + err);
    ...
    {
        try {
            H5.H5Lcreate_external(H5_EXTFILE, "DT1", H5fid, "L1", H5P_DEFAULT(), H5P_DEFAULT());
            H5.H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5.H5Lexists(H5fid, "L1", H5P_DEFAULT());
    ...
    {
        H5.H5Lcopy(H5fid, "None", H5fid, "DS1", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        try {
            H5.H5Lcopy(H5fid, "DS1", H5fid, "CPY1", H5P_DEFAULT(), H5P_DEFAULT());
            H5.H5Fflush(H5fid, H5F_SCOPE_LOCAL());
    ...
    public void testH5Lcopy_dst_link_exists() throws Throwable
    {
        ...
        H5.H5Lcopy(H5fid, "CPY1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Lmove_cur_not_exists() throws Throwable
    {
        H5.H5Lmove(H5fid, "None", H5fid, "DS1", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        try {
            H5.H5Lmove(H5fid, "DS1", H5fid, "CPY1", H5P_DEFAULT(), H5P_DEFAULT());
            H5.H5Fflush(H5fid, H5F_SCOPE_LOCAL());
            boolean link_exists = H5.H5Lexists(H5fid, "CPY1", H5P_DEFAULT());
    ...
    {
        _createHardLink(H5fid, H5fid, "/G1/DS2", H5fid, "CPY1", H5P_DEFAULT(), H5P_DEFAULT());
        H5.H5Lmove(H5fid, "CPY1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        String[] link_value = {null, null};
        H5.H5Lget_value_by_idx(H5fid, "None", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, link_value,
                               H5P_DEFAULT());
    }
    ...
    {
        String[] link_value = {null, null};
        H5.H5Lget_value_by_idx(H5fid, "None", H5_INDEX_NAME(), H5_ITER_INC(), 0, link_value, H5P_DEFAULT());
    }
    ...
    public void testH5Lget_value_by_idx_n2_name()
    {
        ...
        try {
            link_info = H5.H5Lget_info_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lget_info_by_idx: " + err);
        ...
        try {
            link_type = H5.H5Lget_value_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 2, link_value,
                                               H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Lget_value_by_idx_n2_create()
    {
        ...
        try {
            link_info =
                H5.H5Lget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lget_info_by_idx: " + err);
        ...
        assertTrue("testH5Lget_value_by_idx_n2 link type", link_info.type == HDF5Constants.H5L_TYPE_SOFT);
        try {
            link_type = H5.H5Lget_value_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 2, link_value,
                                               H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    {
        H5.H5Ldelete_by_idx(H5fid, "None", H5_INDEX_NAME(), H5_ITER_INC(), 0, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Ldelete_by_idx_not_exist_create() throws Throwable
    {
        H5.H5Ldelete_by_idx(H5fid, "None", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, H5P_DEFAULT());
    }
    ...
    public void testH5Ldelete_by_idx_n2_name()
    {
        ...
        try {
            H5.H5Ldelete_by_idx(H5fid, "/", H5_INDEX_NAME(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Ldelete_by_idx_n2_create()
    {
        ...
        assertTrue("testH5Ldelete_by_idx_n2 link type", link_info.type == HDF5Constants.H5L_TYPE_SOFT);
        try {
            H5.H5Ldelete_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 2, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Ldelete_by_idx: " + err);
    ...
    public void testH5Lvisit_create()
    {
        ...
        try {
            H5.H5Lvisit(H5fid, H5_INDEX_CRT_ORDER(), H5_ITER_INC(), iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Literate_create()
    {
        ...
        H5L_iterate_t iter_cb = new H5L_iter_callback();
        try {
            H5.H5Literate(H5fid, H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
