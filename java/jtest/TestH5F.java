...
public class TestH5F {
    ...
    public void testH5Fget_intent_rdwr()
    {
        ...
        try {
            H5fid = H5Fopen(H5_FILE, H5F_ACC_RDWR(), H5P_DEFAULT());
        }
        catch (Throwable err) {
            fail("H5Fopen: " + err);
        }
    ...
    public void testH5Fget_fileno_same()
    {
        ...
        try {
            ...
            fid2 = H5Fopen(H5_FILE2, H5F_ACC_RDWR(), H5P_DEFAULT());
    ...
    public void testH5Fget_obj_count()
    {
        ...
        for (int i = 0; i < OBJ_TYPES.length; i++) {
            try {
                count = H5Fget_obj_count(H5fid, OBJ_TYPES[i]);
            }
            catch (Throwable err) {
    ...
    public void testH5Fget_obj_ids()
    {
        ...
        for (int i = 0; i < OBJ_TYPES.length; i++) {
            try {
                count = H5Fget_obj_ids(H5fid, OBJ_TYPES[i], max_objs, obj_id_list);
            }
            catch (Throwable err) {
