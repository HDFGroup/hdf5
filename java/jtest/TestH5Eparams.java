...
public class TestH5Eparams {
    ...
    public void testH5Eprint2()
    {
        try {
            ...
            H5Eprint2(current_stackid, null);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Eprint2: " + err);
    ...
    {
        H5Ecreate_msg(hdf_java_classid, H5E_MAJOR(), null);
    }
    ...
    {
        try {
            long err_id = H5Ecreate_msg(hdf_java_classid, H5E_MAJOR(), "Error in Test");
    ...
    {
        try {
            long err_id = H5Ecreate_msg(hdf_java_classid, H5E_MINOR(), "Error in Test Function");
    ...
    public void testH5Eget_msg()
    {
        ...
        String msg           = null;
        try {
            err_id = H5Ecreate_msg(hdf_java_classid, H5E_MAJOR(), "Error in Test");
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Eget_msg: " + err);
