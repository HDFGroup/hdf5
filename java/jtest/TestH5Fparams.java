...
public class TestH5Fparams {
    ...
    public void testH5Fget_info()
    {
        ...
        try {
            ...
            try {
                H5F_info2_t finfo = H5Fget_info(fid);
