...
public class TestH5S {
    ...
    public void createH5file() throws NullPointerException, HDF5Exception
    {
        ...
        assertTrue("H5Screate_simple_extent", H5sid > 0);
    }
    ...
    public void testH5Sget_simple_extent_dims_null()
    {
        ...
        try {
            read_rank = H5Sget_simple_extent_dims(H5sid, null, null);
    ...
    public void testH5Sget_simple_extent_dims()
    {
        ...
        try {
            read_rank = H5Sget_simple_extent_dims(H5sid, dims, maxdims);
            assertTrue("H5Sget_simple_extent_dims", H5rank == read_rank);
    ...
    public void testH5Sset_extent_simple()
    {
        long num_elements = -1;
        try {
            H5Sset_extent_simple(H5sid, H5rank, H5maxdims, H5maxdims);
            num_elements = H5Sget_simple_extent_npoints(H5sid);
    ...
    {
        long sid         = H5I_INVALID_HID();
        long decoded_sid = H5I_INVALID_HID();
        byte[] null_sbuf = null;
        boolean result   = false;
        ...
        try {
            decoded_sid = H5Sdecode(null_sbuf);
    ...
    public void testH5Sencode_decode_scalar_dataspace()
    {
        ...
        try {
            decoded_sid = H5Sdecode(scalar_sbuf);
            assertTrue("testH5Sdecode", decoded_sid > 0);
    ...
    public void testH5Sget_select_npoints()
    {
        ...
        long num_elements = -1;
        try {
            H5Sselect_elements(H5sid, H5S_SELECT_SET(), 3, coord);
    ...
    public void testH5Sget_select_elem_pointlist_invalid() throws Throwable
    {
        ...
        H5Sget_select_elem_pointlist(H5sid, 0, 3, getcoord);
    }
    ...
    public void testH5Sget_select_bounds()
    {
        ...
        long hibounds[]  = {-1, -1};
        try {
            H5Sget_select_bounds(H5sid, lowbounds, hibounds);
    ...
    public void testH5Soffset_simple()
    {
        ...
        long hibounds[]  = {-1, -1};
        try {
            H5Sselect_elements(H5sid, H5S_SELECT_SET(), 4, coord);
            H5Sget_select_bounds(H5sid, lowbounds, hibounds);
    ...
    public void testH5Sget_select_hyper()
    {
        ...
        try {
            ...
            H5Sselect_hyperslab(space1, H5S_SELECT_AND(), start, stride, count, block);
            ...
            H5Sget_select_hyper_blocklist(space1, 0, nblocks, blocks);
    ...
    public void testH5Sget_select_valid()
    {
        ...
        try {
            ...
            assertTrue("H5Scopy", H5sid > 0);
            // 'AND' "all" selection with another hyperslab
            H5Sselect_hyperslab(space1, H5S_SELECT_SET(), start, stride, count, block);

            // Check a valid offset
            offset[0] = -1;
            offset[1] = 0;
            H5Soffset_simple(space1, offset);
    ...
    public void testH5Shyper_regular()
    {
        ...
        try {
            ...
            H5Sselect_hyperslab(H5sid, H5S_SELECT_SET(), start, stride, count, block);

            // Query if 'hyperslab' selection is regular hyperslab (should be TRUE)
            is_regular = H5Sis_regular_hyperslab(H5sid);
            assertTrue("H5Sis_regular_hyperslab", is_regular);

            // Retrieve the hyperslab parameters
            H5Sget_regular_hyperslab(H5sid, q_start, q_stride, q_count, q_block);
