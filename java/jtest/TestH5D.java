...
public class TestH5D {
    ...
    private final void _createPDataset(long fid, long dsid, String name, long dcpl_val)
    {
        ...
        try {
            H5did0 =
                H5.H5Dcreate(fid, name, H5T_STD_I32BE_g(), dsid, H5P_DEFAULT(), H5dcpl_id, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    private final void _createChunkDataset(long fid, long dsid, String name, long dapl)
    {
        ...
        try {
            H5dcpl_id = H5.H5Pcreate(H5P_CLS_DATASET_CREATE_ID_g());
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("H5.H5Pcreate: " + err);
        ...
        try {
            H5did = H5.H5Dcreate(fid, name, H5T_STD_I32BE_g(), dsid, H5P_DEFAULT(), H5dcpl_id, dapl);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Dcreate: " + err);
    ...
    {
        try {
            H5did = H5.H5Dcreate(fid, name, H5T_STD_I32BE_g(), dsid, H5P_DEFAULT(), H5P_DEFAULT(), dapl);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Dcreate: " + err);
    ...
    private final void _createVLStrDataset(String name, long dapl)
    {
        ...
        try {
            H5.H5Tset_size(H5dtid, H5T_VARIABLE());
        ...
        try {
            H5did = H5.H5Dcreate(H5fid, name, H5dtid, H5dsid, H5P_DEFAULT(), H5P_DEFAULT(), dapl);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Dcreate: " + err);
    ...
    public void createH5file() throws NullPointerException, HDF5Exception
    {
        ...
        try {
            H5faplid = H5.H5Pcreate(H5P_CLS_FILE_ACCESS_g());
            H5fid    = H5.H5Fcreate(H5_FILE, H5F_ACC_TRUNC(), H5P_DEFAULT(), H5faplid);
    ...
    public void testH5Dcreate()
    {
        ...
        try {
            dataset_id = H5.H5Dcreate(H5fid, "dset", H5T_STD_I32BE_g(), H5dsid, H5P_DEFAULT(), H5P_DEFAULT(),
                                      H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    public void testH5Dcreate_anon()
    {
        long dataset_id = H5I_INVALID_HID();
        try {
            dataset_id = H5.H5Dcreate_anon(H5fid, H5T_STD_I32BE_g(), H5dsid, H5P_DEFAULT(), H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    public void testH5Dopen()
    {
        ...
        try {
            ...
            dataset_id = H5.H5Dopen(H5fid, "dset", H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    public void testH5Dget_access_plist()
    {
        ...
        try {
            test_dapl_id = H5.H5Pcreate(H5P_CLS_DATASET_ACCESS_g());
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    public void testH5Dfill_null()
    {
        ...
        try {
            H5.H5Dfill(null, H5T_NATIVE_UINT_g(), buf_array, H5T_NATIVE_UINT_g(), H5dsid);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("H5.H5Dfill: " + err);
    ...
    public void testH5Dfill()
    {
        ...
        // Fill selection in memory
        try {
            H5.H5Dfill(fill_value, H5T_NATIVE_UINT_g(), buf_array, H5T_NATIVE_UINT_g(), H5dsid);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("H5.H5Dfill: " + err);
    ...
    public void testH5Diterate()
    {
        ...
        int op_status          = -1;
        try {
            op_status = H5.H5Diterate(buf_array, H5T_NATIVE_UINT_g(), H5dsid, iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Diterate: " + err);
    ...
    public void testH5Dvlen_get_buf_size()
    {
        ...
        try {
            if ((H5did >= 0) && (H5dtid >= 0))
                H5.H5DwriteVL(H5did, H5dtid, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), str_data);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void testH5Dvlen_string_buffer() throws Throwable
    {
        ...
        try {
            ...
            dset_str_id = H5.H5Dcreate(H5fid, dset_str_name, dtype_str_id, dspace_id, H5P_DEFAULT(),
                                       H5P_DEFAULT(), H5P_DEFAULT());
            assertTrue("testH5Dvlen_string_buffer: ", dset_str_id >= 0);

            H5.H5DwriteVL(dset_str_id, dtype_str_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_str_data);
        }
        catch (Exception err) {
            if (dset_str_id > 0)
                try {
        ...
        try {
            H5.H5DreadVL(dset_str_id, dtype_str_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_readbuf);
        }
        catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void testH5Dvlen_write_read()
    {
        ...
        try {
            if ((H5did >= 0) && (H5dtid >= 0))
                H5.H5DwriteVL(H5did, H5dtid, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), str_wdata);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            if ((H5did >= 0) && (H5dtid >= 0))
                H5.H5DreadVL(H5did, H5dtid, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), str_rdata);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void testH5DVLwr()
    {
        ...
        try {
            ...
            try {
                dtype_int_id = H5.H5Tvlen_create(H5T_STD_U32LE_g());
            ...
            try {
                dspace_id = H5.H5Screate_simple(1, dims, null);
                assertTrue(dspace_id > 0);
                dset_int_id = H5.H5Dcreate(H5fid, dset_int_name, dtype_int_id, dspace_id, H5P_DEFAULT(),
                                           H5P_DEFAULT(), H5P_DEFAULT());
                assertTrue("testH5DVLwr: ", dset_int_id >= 0);

                H5.H5DwriteVL(dset_int_id, dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_int_data);
            }
            catch (Exception err) {
                if (dset_int_id > 0)
                    try {
            ...
            try {
                dtype_dbl_id = H5.H5Tvlen_create(H5T_NATIVE_DOUBLE_g());
            ...
            try {
                dspace_id = H5.H5Screate_simple(1, dims, null);
                assertTrue(dspace_id > 0);
                dset_dbl_id = H5.H5Dcreate(H5fid, dset_dbl_name, dtype_dbl_id, dspace_id, H5P_DEFAULT(),
                                           H5P_DEFAULT(), H5P_DEFAULT());
                assertTrue("testH5DVLwr: ", dset_dbl_id >= 0);

                H5.H5DwriteVL(dset_dbl_id, dtype_dbl_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_dbl_data);
            }
            catch (Exception err) {
                if (dset_dbl_id > 0)
                    try {
            ...
            try {
                H5.H5DreadVL(dset_int_id, dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_int_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
            ...
            try {
                H5.H5DreadVL(dset_dbl_id, dtype_dbl_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_dbl_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    public void testH5DVLwrVL()
    {
        ...
        try {
            ...
            try {
                dspace_id = H5.H5Screate_simple(1, dims, null);
                assertTrue(dspace_id > 0);
                dset_int_id = H5.H5Dcreate(H5fid, dset_int_name, base_dtype_int_id, dspace_id, H5P_DEFAULT(),
                                           H5P_DEFAULT(), H5P_DEFAULT());
                assertTrue("testH5DVLwrVL: ", dset_int_id >= 0);

                H5.H5DwriteVL(dset_int_id, base_dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(),
                              base_vl_int_data);
            }
            catch (Exception err) {
                if (dset_int_id > 0)
            ...
            try {
                H5.H5DreadVL(dset_int_id, base_dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(),
                             base_vl_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
    ...
    public void testH5DArraywr()
    {
        ...
        try {
            ...
            try {
                dtype_int_id = H5.H5Tarray_create(H5T_STD_U32LE_g(), 1, dims);
            ...
            try {
                ...
                H5.H5DwriteVL(dset_int_id, dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_int_data);
            }
            catch (Exception err) {
                if (dset_int_id > 0)
                    try {
            ...
            try {
                H5.H5DreadVL(dset_int_id, dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    public void testH5DArray_string_buffer() throws Throwable
    {
        ...
        try {
            ...
            H5.H5DwriteVL(dset_str_id, dtype_str_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_str_data);
        }
        catch (Exception err) {
            if (dset_str_id > 0)
                try {
        ...
        try {
            H5.H5DreadVL(dset_str_id, dtype_str_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_readbuf);
        }
        catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void testH5DArrayenum_rw()
    {
        ...
        try {
            dtype_enum_id = H5.H5Tcreate(H5T_ENUM(), (long)1);
        ...
        try {
            ...
            H5.H5Tcommit(H5fid, enum_type, dtype_enum_id, H5P_DEFAULT(), H5P_DEFAULT(), H5P_DEFAULT());

            H5.H5Tclose(dtype_enum_id);

            // Open the dataytpe for query
            dtype_enum_id = H5.H5Topen(H5fid, enum_type, H5P_DEFAULT());
            ...
            try {
                ...
                try {
                    dtype_arr_enum_id = H5.H5Tarray_create(H5T_STD_U32LE_g(), 1, dims);
                ...
                H5.H5DwriteVL(dset_enum_id, dtype_arr_enum_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(),
                              arr_enum_data);
            }
            catch (Throwable err) {
                if (dset_enum_id > 0)
            ...
            try {
                H5.H5DreadVL(dset_enum_id, dtype_arr_enum_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(),
                             arr_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
