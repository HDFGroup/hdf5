...
public class TestH5D {
    ...
    long H5faplid                       = H5I_INVALID_HID();
    long H5dsid                         = H5I_INVALID_HID();
    long H5dtid                         = H5I_INVALID_HID();
    long H5did                          = H5I_INVALID_HID();
    long H5did0                         = H5I_INVALID_HID();
    long H5dcpl_id                      = H5I_INVALID_HID();
    ...
    private final void _createPDataset(long fid, long dsid, String name, long dcpl_val)
    {
        ...
        assertTrue("testH5D._createPDataset: H5Pcreate: ", H5dcpl_id >= 0);
        ...
        try {
            try (Arena arena = Arena.ofConfined()) {
                ...
                H5did0 = H5Dcreate2(fid, name_segment, H5T_STD_I32BE_g(), dsid, H5P_DEFAULT(), H5dcpl_id,
                                    H5P_DEFAULT());
            }
            catch (Throwable err) {
                err.printStackTrace();
    ...
    private final void _createChunkDataset(long fid, long dsid, String name, long dapl)
    {
        ...
        try {
            H5dcpl_id = H5Pcreate(H5P_CLS_DATASET_CREATE_ID_g());
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("H5Pcreate: " + err);
        }
        assertTrue("testH5D._createChunkDataset: H5Pcreate: ", H5dcpl_id >= 0);

        // Set the chunking.
        long[] chunk_dim = {4, 4};

        try {
            H5Pset_chunk(H5dcpl_id, RANK, chunk_dim);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            try (Arena arena = Arena.ofConfined()) {
                ...
                MemorySegment name_segment = arena.allocateFrom(name);
                H5did =
                    H5Dcreate2(fid, name_segment, H5T_STD_I32BE_g(), dsid, H5P_DEFAULT(), H5dcpl_id, dapl);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("Arena: " + err);
    ...
    private final void _createDataset(long fid, long dsid, String name, long dapl)
    {
        try {
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the string bytes
                MemorySegment name_segment = arena.allocateFrom(name);
                H5did = H5Dcreate2(fid, name_segment, H5T_STD_I32BE_g(), dsid, H5P_DEFAULT(), H5P_DEFAULT(),
                                   dapl);
            }
            catch (Throwable err) {
                err.printStackTrace();
    ...
    private final void _createVLStrDataset(String name, long dapl)
    {
        ...
        try {
            H5Tset_size(H5dtid, H5T_VARIABLE());
            assertTrue("TestH5D._createVLStrDataset.H5Tis_variable_str", H5Tis_variable_str(H5dtid));
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Tset_size: " + err);
        }
        try {
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the string bytes
                MemorySegment name_segment = arena.allocateFrom(name);
                H5did = H5Dcreate2(H5fid, name_segment, H5dtid, H5dsid, H5P_DEFAULT(), H5P_DEFAULT(), dapl);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("Arena: " + err);
    ...
    private final void _openH5file(String filename, String dsetname, long dapl)
    {
        ...
        assertTrue("TestH5D._openH5file: H5Dopen: ", H5did >= 0);
        try {
        ...
        assertTrue("TestH5D._openH5file: H5Dget_space: ", H5dsid > 0);
    }
    ...
    public void createH5file() throws NullPointerException, HDF5Exception
    {
        ...
        try {
            H5faplid = H5Pcreate(H5P_CLS_FILE_ACCESS_g());
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the string bytes
                MemorySegment filename_segment = arena.allocateFrom(H5_FILE);
                H5fid = H5Fcreate(filename_segment, H5F_ACC_TRUNC(), H5P_DEFAULT(), H5faplid);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("Arena: " + err);
            ...
            try (Arena arena = Arena.ofConfined()) {
                ...
                H5dsid                       = H5Screate_simple(RANK, H5dims_segment, null);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("Arena: " + err);
        ...
        assertTrue("TestH5D.createH5file: H5Fcreate: ", H5fid >= 0);
        assertTrue("TestH5D.createH5file: H5Screate_simple: ", H5dsid >= 0);
    ...
    public void testH5Dcreate()
    {
        ...
        try {
            try (Arena arena = Arena.ofConfined()) {
                ...
                dataset_id = H5Dcreate2(H5fid, name_segment, H5T_STD_I32BE_g(), H5dsid, H5P_DEFAULT(),
    ...
    public void testH5Dcreate_anon()
    {
        long dataset_id = H5I_INVALID_HID();
        try {
            dataset_id = H5Dcreate_anon(H5fid, H5T_STD_I32BE_g(), H5dsid, H5P_DEFAULT(), H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    {
        long dataset_id = H5I_INVALID_HID();
        _createDataset(H5fid, H5dsid, "dset", H5P_DEFAULT());

        try {
            H5Dclose(H5did);
            H5did      = H5I_INVALID_HID();
            dataset_id = H5Dopen(H5fid, "dset", H5P_DEFAULT());
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    public void testH5Dget_storage_size_empty()
    {
        ...
        try {
            storage_size = H5Dget_storage_size(H5did);
        }
        catch (Exception err) {
            err.printStackTrace();
    ...
    public void testH5Dget_storage_size()
    {
        ...
        try {
            if (H5did >= 0)
                H5Dwrite(H5did, H5T_NATIVE_INT_g(), H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), dset_data[0]);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    {
        long dapl_id        = H5I_INVALID_HID();
        long test_dapl_id   = H5I_INVALID_HID();
        int[] mdc_nelmts1   = {0};
        int[] mdc_nelmts2   = {0};
        long[] rdcc_nelmts1 = {0};
        long[] rdcc_nelmts2 = {0};
        ...
        try {
            test_dapl_id = H5Pcreate(H5P_CLS_DATASET_ACCESS_g());
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Dget_access_plist: H5Pcreate: " + err);
        }
        assertTrue("testH5Dget_access_plist: test_dapl_id: ", test_dapl_id >= 0);

        try {
            H5Pget_cache(H5faplid, mdc_nelmts1, rdcc_nelmts1, rdcc_nbytes1, rdcc_w01);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Dget_access_plist: H5Pget_cache: " + err);
        }

        _createChunkDataset(H5fid, H5dsid, "dset", test_dapl_id);

        try {
            dapl_id = H5Dget_access_plist(H5did);
            assertTrue("testH5Dget_access_plist: dapl_id: ", dapl_id >= 0);
            H5Pget_chunk_cache(dapl_id, rdcc_nelmts2, rdcc_nbytes2, rdcc_w02);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("testH5Dget_access_plist: H5Dget_access_plist: " + err);
        }
    ...
    public void testH5Dget_space_status()
    {
        ...
        _createPDataset(H5fid, H5dsid, "dset0", H5P_CLS_DATASET_CREATE_ID_g());
        _createDataset(H5fid, H5dsid, "dset", H5P_DEFAULT());

        // Retrieve and print space status and storage size for dset0.
        try {
            space_status0 = H5Dget_space_status(H5did0);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        assertTrue("testH5Dget_space_status0 - H5Dget_space_status: ",
        ...
        try {
            space_status = H5Dget_space_status(H5did);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        assertFalse("testH5Dget_space_status - H5Dget_space_status: ",
                    space_status == H5D_space_status.H5D_SPACE_STATUS_ALLOCATED.getCode());

        // Write the data to the dataset.
        try {
            H5Dwrite(H5did, H5T_NATIVE_INT_g(), H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), write_dset_data);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        assertTrue("testH5Dget_space_status - H5Dget_space_status: ",
                   space_status == H5D_space_status.H5D_SPACE_STATUS_ALLOCATED.getCode());
    }
    ...
    public void testH5Dget_space()
    {
        ...
        try {
            dataspace_id = H5Dget_space(H5did);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("H5Dget_space: " + err);
        }
    ...
    public void testH5Dget_type()
    {
        ...
        try {
            datatype_id = H5Dget_type(H5did);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("H5Dget_type: " + err);
        }
    ...
    public void testH5Dget_offset()
    {
        ...
        try {
            ...
            dset_address = H5Dget_offset(H5did);
        }
    ...
    public void testH5Dfill_null()
    {
        ...
        try {
            H5Dfill(null, H5T_NATIVE_UINT_g(), buf_array, H5T_NATIVE_UINT_g(), H5dsid);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("H5Dfill: " + err);
        ...
        for (int indx = 0; indx < DIM_X; indx++)
            for (int jndx = 0; jndx < DIM_Y; jndx++)
                assertTrue("H5Dfill: [" + indx + "," + jndx + "] ", buf_data[(indx * DIM_Y) + jndx] == 0);
    }
    ...
    public void testH5Dfill()
    {
        ...
        // Fill selection in memory
        try {
            H5Dfill(fill_value, H5T_NATIVE_UINT_g(), buf_array, H5T_NATIVE_UINT_g(), H5dsid);
        }
        catch (Exception err) {
            err.printStackTrace();
            fail("H5Dfill: " + err);
    ...
    public void testH5Diterate()
    {
        ...
        class H5D_iter_callback implements H5D_operator_t.Function {
            public int apply(byte[] elem_buf, long elem_id, int ndim, long[] point, H5D_operator_t op_data)
            {
        ...
        H5D_operator_t iter_cb = new H5D_iter_callback();
        int op_status          = -1;
        try {
            op_status = H5Diterate(buf_array, H5T_NATIVE_UINT_g(), H5dsid, iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Diterate: " + err);
    ...
    public void testH5Diterate_write()
    {
        ...
        for (int indx = 0; indx < DIM_X; indx++)
            for (int jndx = 0; jndx < DIM_Y; jndx++)
                assertTrue("H5Diterate: [" + indx + "," + jndx + "] " + buf_data[(indx * DIM_Y) + jndx],
    ...
    public void testH5Dvlen_get_buf_size()
    {
        ...
        _createVLStrDataset("dset", H5P_DEFAULT());

        try {
            if ((H5did >= 0) && (H5dtid >= 0))
                H5DwriteVL(H5did, H5dtid, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), str_data);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        try {
            vl_size = H5Dvlen_get_buf_size(H5did, H5dtid, H5dsid);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void testH5Dvlen_string_buffer() throws Throwable
    {
        ...
        long dset_str_id     = H5I_INVALID_HID();
        long dtype_str_id    = H5I_INVALID_HID();
        long dspace_id       = H5I_INVALID_HID();
        long[] dims          = {64};
        long lsize           = 1;
        ...
        try {
            ...
            err.printStackTrace();
            fail("testH5Dvlen_string_buffer.H5Tcopy: " + err);
        }
        assertTrue("testH5Dvlen_string_buffer.H5Tcopy: ", H5dtid >= 0);
        try {
            H5Tset_size(H5dtid, H5T_VARIABLE());
            assertTrue("testH5Dvlen_string_buffer.H5Tis_variable_str", H5Tis_variable_str(H5dtid));
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            try (Arena arena = Arena.ofConfined()) {
                ...
                dspace_id                  = H5Screate_simple(1, dims_segment, null);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("Arena: " + err);
            ...
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the string bytes
                MemorySegment name_segment = arena.allocateFrom(dset_str_name);
                dset_str_id = H5Dcreate2(H5fid, name_segment, dtype_str_id, dspace_id, H5P_DEFAULT(),
                                         H5P_DEFAULT(), H5P_DEFAULT());
            }
            catch (Throwable err) {
                err.printStackTrace();
            ...
            H5DwriteVL(dset_str_id, dtype_str_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_str_data);
        }
        catch (Exception err) {
            if (dset_str_id > 0)
                try {
                    H5Dclose(dset_str_id);
                }
                catch (Exception ex) {
                }
            if (dtype_str_id > 0)
        ...
        try {
            H5DreadVL(dset_str_id, dtype_str_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_readbuf);
        }
        catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void testH5Dvlen_write_read()
    {
        ...
        try {
            if ((H5did >= 0) && (H5dtid >= 0))
                H5DwriteVL(H5did, H5dtid, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), str_wdata);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            if ((H5did >= 0) && (H5dtid >= 0))
                H5DreadVL(H5did, H5dtid, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), str_rdata);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void testH5DVLwr()
    {
        ...
        long dset_int_id     = H5I_INVALID_HID();
        long dset_dbl_id     = H5I_INVALID_HID();
        long dtype_int_id    = H5I_INVALID_HID();
        long dtype_dbl_id    = H5I_INVALID_HID();
        long dspace_id       = H5I_INVALID_HID();
        long[] dims          = {4};
        long lsize           = 1;
        ...
        try {
            ...
            try {
                dtype_int_id = H5Tvlen_create(H5T_STD_U32LE_g());
                assertTrue("testH5DVLwr.H5Tvlen_create: ", dtype_int_id >= 0);
            }
            catch (Exception err) {
                if (dtype_int_id > 0)
                    try {
                        H5Tclose(dtype_int_id);
                    }
                    catch (Exception ex) {
                    }
                err.printStackTrace();
            ...
            try {
                ...
                try (Arena arena = Arena.ofConfined()) {
                    // Allocate a MemorySegment to hold the string bytes
                    MemorySegment name_segment = arena.allocateFrom(dset_int_name);
                    dset_int_id = H5Dcreate2(H5fid, name_segment, dtype_int_id, dspace_id, H5P_DEFAULT(),
                                             H5P_DEFAULT(), H5P_DEFAULT());
                }
                catch (Throwable err) {
                    err.printStackTrace();
                ...
                H5DwriteVL(dset_int_id, dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_int_data);
            }
            catch (Exception err) {
                if (dset_int_id > 0)
                    try {
                        H5Dclose(dset_int_id);
                    }
                    catch (Exception ex) {
                    }
                if (dtype_int_id > 0)
            ...
            try {
                dtype_dbl_id = H5Tvlen_create(H5T_NATIVE_DOUBLE_g());
                assertTrue("testH5DVLwr.H5Tvlen_create: ", dtype_dbl_id >= 0);
            }
            catch (Exception err) {
                if (dtype_dbl_id > 0)
                    try {
                        H5Tclose(dtype_dbl_id);
                    }
                    catch (Exception ex) {
                    }
                err.printStackTrace();
            ...
            try {
                ...
                try (Arena arena = Arena.ofConfined()) {
                    // Allocate a MemorySegment to hold the string bytes
                    MemorySegment name_segment = arena.allocateFrom(dset_dbl_name);
                    dset_dbl_id = H5Dcreate2(H5fid, name_segment, dtype_dbl_id, dspace_id, H5P_DEFAULT(),
                                             H5P_DEFAULT(), H5P_DEFAULT());
                }
                catch (Throwable err) {
                    err.printStackTrace();
                ...
                H5DwriteVL(dset_dbl_id, dtype_dbl_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_dbl_data);
            }
            catch (Exception err) {
                if (dset_dbl_id > 0)
                    try {
                        H5Dclose(dset_dbl_id);
                    }
                    catch (Exception ex) {
                    }
                if (dtype_dbl_id > 0)
            ...
            try {
                H5DreadVL(dset_int_id, dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_int_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
            ...
            try {
                H5DreadVL(dset_dbl_id, dtype_dbl_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_dbl_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    public void testH5DVLwrVL()
    {
        ...
        long dset_int_id       = H5I_INVALID_HID();
        long dtype_int_id      = H5I_INVALID_HID();
        long base_dtype_int_id = H5I_INVALID_HID();
        long dspace_id         = H5I_INVALID_HID();
        long[] dims            = {4};
        long lsize             = 1;
        ...
        try {
            ...
            try {
                ...
                H5DwriteVL(dset_int_id, base_dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(),
                           base_vl_int_data);
            }
            catch (Exception err) {
                if (dset_int_id > 0)
            ...
            try {
                H5DreadVL(dset_int_id, base_dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(),
                          base_vl_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
    ...
    public void testH5DArraywr()
    {
        ...
        try {
            ...
            try {
                dtype_int_id = H5Tarray_create(H5T_STD_U32LE_g(), 1, dims);
            ...
            try {
                ...
                H5DwriteVL(dset_int_id, dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_int_data);
            }
            catch (Exception err) {
                if (dset_int_id > 0)
                    try {
            ...
            try {
                H5DreadVL(dset_int_id, dtype_int_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    public void testH5DArray_string_buffer() throws Throwable
    {
        ...
        try {
            ...
            err.printStackTrace();
            fail("testH5DArray_string_buffer.H5Tcopy: " + err);
        }
        assertTrue("testH5DArray_string_buffer.H5Tcopy: ", H5dtid >= 0);
        try {
            H5Tset_size(H5dtid, H5T_VARIABLE());
            assertTrue("testH5DArray_string_buffer.H5Tis_variable_str", H5Tis_variable_str(H5dtid));
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            dtype_str_id = H5Tarray_create(H5dtid, 1, strdims);
        ...
        try {
            ...
            H5DwriteVL(dset_str_id, dtype_str_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_str_data);
        }
        catch (Exception err) {
            if (dset_str_id > 0)
                try {
        ...
        try {
            H5DreadVL(dset_str_id, dtype_str_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_readbuf);
        }
        catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void testH5DArrayenum_rw()
    {
        ...
        long dset_enum_id      = H5I_INVALID_HID();
        long dtype_enum_id     = H5I_INVALID_HID();
        long dtype_arr_enum_id = H5I_INVALID_HID();
        long dspace_id         = H5I_INVALID_HID();
        long[] dims            = {4};
        long lsize             = 1;
        ...
        try {
            ...
            try (Arena arena = Arena.ofConfined()) {
                ...
                MemorySegment name_segment = arena.allocateFrom("RED");
                MemorySegment enum_segment = arena.allocate(ValueLayout.JAVA_BYTE);
                // Set the int value
                enum_segment.set(ValueLayout.JAVA_BYTE, 0, enum_val[0]);
                status = H5Tenum_insert(type_id, name_segment, enum_segment);
            }
            enum_val[0] = 11;
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the enum bytes
                MemorySegment name_segment = arena.allocateFrom("GREEN");
                MemorySegment enum_segment = arena.allocate(ValueLayout.JAVA_BYTE);
                // Set the int value
                enum_segment.set(ValueLayout.JAVA_BYTE, 0, enum_val[0]);
                status = H5Tenum_insert(type_id, name_segment, enum_segment);
            ...
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the enum bytes
                MemorySegment name_segment = arena.allocateFrom("BLUE");
                MemorySegment enum_segment = arena.allocate(ValueLayout.JAVA_BYTE);
                // Set the int value
                enum_segment.set(ValueLayout.JAVA_BYTE, 0, enum_val[0]);
                status = H5Tenum_insert(type_id, name_segment, enum_segment);
            ...
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the enum bytes
                MemorySegment name_segment = arena.allocateFrom("ORANGE");
                MemorySegment enum_segment = arena.allocate(ValueLayout.JAVA_BYTE);
                // Set the int value
                enum_segment.set(ValueLayout.JAVA_BYTE, 0, enum_val[0]);
                status = H5Tenum_insert(type_id, name_segment, enum_segment);
            ...
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the enum bytes
                MemorySegment name_segment = arena.allocateFrom("YELLOW");
                MemorySegment enum_segment = arena.allocate(ValueLayout.JAVA_BYTE);
                // Set the int value
                enum_segment.set(ValueLayout.JAVA_BYTE, 0, enum_val[0]);
                status = H5Tenum_insert(type_id, name_segment, enum_segment);
            ...
            assertTrue("Can't get member number", H5Tget_nmembers(dtype_enum_id) == 5);
            assertTrue("Can't get correct index number", H5Tget_member_index(dtype_enum_id, "ORANGE") == 3);

            // Commit enumeration datatype and close it */
            H5Tcommit(H5fid, enum_type, dtype_enum_id, H5P_DEFAULT(), H5P_DEFAULT(), H5P_DEFAULT());

            H5Tclose(dtype_enum_id);

            // Open the dataytpe for query
            dtype_enum_id = H5Topen(H5fid, enum_type, H5P_DEFAULT());
            ...
            try {
                ...
                try (Arena arena = Arena.ofConfined()) {
                    // Allocate a MemorySegment to hold the string bytes
                    MemorySegment name_segment = arena.allocateFrom(dset_enum_name);
                    dset_enum_id               = H5Dcreate2(H5fid, name_segment, dtype_arr_enum_id, dspace_id,
                ...
                H5DwriteVL(dset_enum_id, dtype_arr_enum_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(),
                           arr_enum_data);
            }
            catch (Throwable err) {
                if (dset_enum_id > 0)
                    try {
                        H5Dclose(dset_enum_id);
                    }
                    catch (Exception ex) {
                    }
                if (dtype_enum_id > 0)
            ...
            try {
                H5DreadVL(dset_enum_id, dtype_arr_enum_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), arr_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
