...
public class TestH5Plist {
    ...
    long plist_class_id = H5I_INVALID_HID();
    ...
    public void createPropClass() throws NullPointerException, HDF5Exception
    {
        ...
        try {
            plist_class_id = H5Pcreate_class_nocb(H5P_CLS_ROOT_ID_g(), CLASS1_NAME);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5P_genprop_basic_class()
    {
        ...
        try {
            // Check class name
            try {
                name = H5Pget_class_name(plist_class_id);
            }
            catch (Throwable err) {
                err.printStackTrace();
            ...
            try {
                status = H5Pequal(cid2, H5P_CLS_ROOT_ID_g());
            }
            catch (Throwable err) {
                err.printStackTrace();
            ...
            try {
                cid1 = H5Pcreate_class_nocb(H5P_CLS_FILE_CREATE_ID_g(), CLASS2_NAME);
            }
            catch (Throwable err) {
                err.printStackTrace();
    ...
    public void testH5P_genprop_basic_class_prop()
    {
        ...
        try {
            status = H5Pexist(plist_class_id, PROP1_NAME);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            ...
            H5Pregister2_nocb(plist_class_id, PROP1_NAME, PROP1_SIZE, prop_value);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            ...
            H5Pregister2_nocb(plist_class_id, PROP2_NAME, PROP2_SIZE, prop_value);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            status = H5Pexist(plist_class_id, PROP2_NAME);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Pexist plist_class_id: " + err);
        ...
        try {
            size = H5Pget_size(plist_class_id, PROP2_NAME);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            ...
            H5Pregister2_nocb(plist_class_id, PROP3_NAME, PROP3_SIZE, prop_value);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            status = H5Pexist(plist_class_id, PROP3_NAME);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Pexist plist_class_id: " + err);
        ...
        try {
            H5Punregister(plist_class_id, PROP1_NAME);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            H5Punregister(plist_class_id, PROP2_NAME);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            H5Punregister(plist_class_id, PROP3_NAME);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5P_genprop_class_iter()
    {
        ...
        class H5P_iter_data extends H5P_iterate_t {
            public ArrayList<idata> iterdata = new ArrayList<idata>();
        }
        H5P_iterate_t iter_data = new H5P_iter_data();
        class H5P_iter_callback implements H5P_iterate_t {
            public int apply(long list_id, String name, H5P_iterate_t.Function op_data)
            {
                idata id = ((H5P_iter_data)op_data).iterdata.get(0);
                return name.compareTo(id.iter_names[id.iter_count++]);
            }
        }
        H5P_iterate_t iter_cb = new H5P_iter_callback();
        ...
        try {
            ...
            H5Pregister2_nocb(plist_class_id, PROP4_NAME, PROP4_SIZE, prop_value);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            H5Piterate(plist_class_id, null, iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Piterate: " + err);
        ...
        try {
            H5Piterate(plist_class_id, idx, iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Piterate: " + err);
    ...
    public void testH5P_genprop_basic_list_prop()
    {
        ...
        try {
            ...
            try {
                ...
                H5Pinsert2_nocb(lid1, PROP3_NAME, PROP3_SIZE, prop_value);
            }
            catch (Throwable err) {
                err.printStackTrace();
            ...
            try {
                ...
                H5Pinsert2_nocb(lid1, PROP4_NAME, PROP4_SIZE, prop_value);
            }
            catch (Throwable err) {
                err.printStackTrace();
            ...
            try {
                status = H5Pexist(lid1, PROP1_NAME);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("H5Pexist plist_class_id: " + err);
            ...
            try {
                status = H5Pexist(lid1, PROP2_NAME);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("H5Pexist plist_class_id: " + err);
            ...
            try {
                status = H5Pexist(lid1, PROP3_NAME);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("H5Pexist plist_class_id: " + err);
            ...
            try {
                status = H5Pexist(lid1, PROP4_NAME);
            }
            catch (Throwable err) {
                err.printStackTrace();
                fail("H5Pexist plist_class_id: " + err);
    ...
    //        class cdata {
    //            public long cls_id = H5I_INVALID_HID();
    ...
    //        long    cid2 = H5I_INVALID_HID();        // Generic Property class ID
    //        long    lid1 = H5I_INVALID_HID();        // Generic Property list ID
    //        long    lid2 = H5I_INVALID_HID();        // Generic Property list ID
    //        long    lid3 = H5I_INVALID_HID();        // Generic Property list ID
    //        long    nprops = -1;    // Number of properties in class
    //
    //        try {
    //            // Create a new generic class, derived from the root of the class hierarchy
    //            try {
    //                cid1 = H5Pcreate_class(H5P_CLS_ROOT_ID_g(), CLASS1_NAME, cls_create_cb,
    ...
    //                byte[] prop_value = HDFNativeData.intToByte(prop1_def);
    //
    //                H5Pregister2(cid1, PROP1_NAME, PROP1_SIZE, prop_value, null, null, null, null, null,
    //                null, null);
    //            }
    //            catch (Throwable err) {
    //                err.printStackTrace();
    ...
    //                byte[] prop_value = HDFNativeData.floatToByte(prop2_def);
    //
    //                H5Pregister2(cid1, PROP2_NAME, PROP2_SIZE, prop_value, null, null, null, null, null,
    //                null, null);
    //            }
    //            catch (Throwable err) {
    //                err.printStackTrace();
    ...
    //                byte[] prop_value = new String(prop3_def).getBytes(StandardCharsets.UTF_8);
    //
    //                H5Pregister2(cid1, PROP3_NAME, PROP3_SIZE, prop_value, null, null, null, null, null,
    //                null, null);
    //            }
    //            catch (Throwable err) {
    //                err.printStackTrace();
