...
public class TestH5Gbasic {
    ...
    public void testH5Gcreate_anon()
    {
        long gid = H5I_INVALID_HID();
        try {
            gid = H5.H5Gcreate_anon(H5fid, H5P_DEFAULT(), H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    {
        H5.H5Gopen(-1, "Invalid ID", H5P_DEFAULT());
    }
    ...
    public void testH5Gopen()
    {
        ...
        try {
            gid = H5.H5Gopen(H5fid, "/testH5Gcreate", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Gopen: " + err);
    ...
    {
        H5.H5Gget_info_by_name(-1, null, H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Gget_info_by_name_invalid() throws Throwable
    {
        H5.H5Gget_info_by_name(-1, "/testH5Gcreate", H5P_DEFAULT());
    }

    @Test(expected = HDF5LibraryException.class)
    public void testH5Gget_info_by_name_not_exists() throws Throwable
    {
        H5.H5Gget_info_by_name(H5fid, "/testH5Gcreate", H5P_DEFAULT());
    }
    ...
    public void testH5Gget_info_by_name()
    {
        ...
        try {
            info = H5.H5Gget_info_by_name(gid, "/testH5Gcreate", H5P_DEFAULT());
        }
        catch (Throwable err) {
            try {
                H5.H5Gclose(gid);
    ...
    public void testH5Gget_info_by_name_fileid()
    {
        ...
        try {
            info = H5.H5Gget_info_by_name(H5fid, "/testH5Gcreate", H5P_DEFAULT());
        }
        catch (Throwable err) {
            try {
                H5.H5Gclose(gid);
