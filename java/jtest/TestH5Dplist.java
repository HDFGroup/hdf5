...
public class TestH5Dplist {
    ...
    long[] H5maxdims                    = {H5S_UNLIMITED(), H5S_UNLIMITED()};
    ...
    private final void _createPDataset(long fid, long dsid, String name, long dcpl_val)
    {
        ...
        // Set the chunk size.
        try {
            H5Pset_chunk(H5dcpl_id, NDIMS, H5chunk_dims);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            ...
            H5Pset_fill_value(H5dcpl_id, H5T_NATIVE_INT_g(), fill_value);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        _createDataset(H5fid, H5dsid, "dset", H5dcpl_id, H5P_DEFAULT());
    }
    ...
    public void createH5file() throws NullPointerException, HDF5Exception
    {
        ...
        try {
            ...
            H5dsid = H5Screate_simple(RANK, H5dims, H5maxdims);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Dset_extent()
    {
        ...
        try {
            H5Dread(H5did, H5T_NATIVE_INT_g(), H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), read_dset_data);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            H5Dread(H5did, H5T_NATIVE_INT_g(), H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), extend_dset_data);
        }
        catch (Exception e) {
            e.printStackTrace();
        }
