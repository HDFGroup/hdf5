...
public class TestH5E {
    ...
    public void H5Eget_stack_class()
    {
        ...
        hdf_java_classid = -1;
        try {
            hdf_java_classid = H5Eregister_class("HDF-Java-Error", "hdf-java", "2.5");
    ...
    public void testH5Eget_msg_major()
    {
        try {
            ...
            int[] error_msg_type = {H5E_MAJOR()};
            String msg           = null;

            try {
                msg = H5Eget_msg(errnum, error_msg_type);
            }
            catch (Throwable err) {
                err.printStackTrace();
    ...
    public void testH5Epush()
    {
        ...
        try {
            try {
                maj_err_id = H5Ecreate_msg(hdf_java_classid, H5E_MAJOR(), "Error in Test");
            ...
            try {
                min_err_id = H5Ecreate_msg(hdf_java_classid, H5E_MINOR(), "Error in Test Function");
            ...
            H5Epush(estack_id, "TestH5E.java", err_func, 354, hdf_java_classid, maj_err_id, min_err_id,
                    err_msg);
    ...
    public void testH5Ewalk()
    {
        ...
        class H5E_walk_data extends H5E_walk2_t {
            public ArrayList<wdata> walkdata = new ArrayList<wdata>();
        }
        H5E_walk2_t walk_data = new H5E_walk_data();
        class H5E_walk_callback implements H5E_walk2_t.Function {
            public int callback(int nidx, H5E_error2_t info, H5E_walk2_t op_data)
            {
        ...
        try {
            H5Ewalk2(current_stackid, H5E_WALK_UPWARD(), walk_cb, walk_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
