...
public class TestH5Sbasic {
    ...
    public void testH5Sget_regular_hyperslab_invalid() throws Throwable
    {
        ...
        H5Sget_regular_hyperslab(-1, q_start, q_stride, q_count, q_block);
    }
    ...
    public void testH5Sselect_intersect_block_invalid() throws Throwable
    {
        ...
        long end[]   = new long[2];
        H5Sselect_intersect_block(-1, start, end);
    }
    ...
    public void testH5Sselect_intersect_block_rank_start() throws Throwable
    {
        ...
        try {
            ...
            assertTrue("H5Screate_simple_extent", sid > 0);
            H5Sselect_intersect_block(sid, start, end);
        }
        finally {
            try {
                H5Sclose(sid);
    ...
    {
        H5Sselect_project_intersection(-1, -1, -1);
    }
    ...
    public void testH5Scombine_hyperslab_invalid() throws Throwable
    {
        ...
        H5Scombine_hyperslab(-1, 0, start, null, count, null);
    }
    ...
    public void testH5Scombine_hyperslab_null_start() throws Throwable
    {
        ...
        try {
            sid = H5Screate(H5S_SIMPLE());
            assertTrue("H5Screate_simple_extent", sid > 0);
            H5Scombine_hyperslab(sid, 0, start, stride, count, block);
        }
        finally {
            try {
                H5Sclose(sid);
