...
public class TestH5R {
    ...
    public void testH5Rget_object()
    {
        ...
        try {
            ref = H5Rcreate_object(H5fid, objName, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            name = H5Rget_obj_name(ref, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Rget_obj_type3()
    {
        ...
        try {
            obj_type = H5Rget_obj_type3(ref, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Rcreate_regionref_object()
    {
        ...
        try {
            H5Sselect_hyperslab(H5dsid, HDF5Constants.H5S_SELECT_SET, start, stride, count, block);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            ref = H5Rcreate_region(H5fid, objName, H5dsid, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    //            ref2 = H5Rcreate(H5gid, "/Group1", HDF5Constants.H5R_OBJECT, -1);
    ...
    //        }
    //        try {
    //            dsid = H5Rget_region(H5fid, HDF5Constants.H5R_DATASET_REGION, ref);
    //            assertNotNull(ref);
    //            assertTrue(dsid >= 0);
    //        }
    //        catch (Throwable err) {
    ...
    {
        String name = null;
        H5Rcreate_object(H5fid, name, H5P_DEFAULT());
    }

    @Test(expected = HDF5FunctionArgumentException.class)
    public void testH5Rcreate_object_Invalidloc() throws Throwable
    {
        String name = "";
        H5Rcreate_object(-1, name, H5P_DEFAULT());
    }
    ...
    {
        String name = null;
        H5Rcreate_region(H5fid, name, -1, H5P_DEFAULT());
    }
    ...
    {
        String name = "";
        H5Rcreate_region(-1, name, -1, H5P_DEFAULT());
    }
    ...
    public void testH5Rcreate_attr_Nullname() throws Throwable
    {
        String name     = null;
        String attrname = "";
        H5Rcreate_attr(H5fid, name, attrname, H5P_DEFAULT());
    }
    ...
    public void testH5Rcreate_attr_Invalidloc() throws Throwable
    {
        String name     = "";
        String attrname = "";
        H5Rcreate_attr(-1, name, attrname, H5P_DEFAULT());
    }
    ...
    public void testH5RVLattr_ref()
    {
        ...
        long attr_obj_id     = H5I_INVALID_HID();
        long attr_reg_id     = H5I_INVALID_HID();
        long atype_obj_id    = H5I_INVALID_HID();
        long atype_reg_id    = H5I_INVALID_HID();
        ...
        try {
            ...
            ref1 = H5Rcreate(H5fid, "/dset", HDF5Constants.H5R_DATASET_REGION, H5dsid);
            assertNotNull(ref1);
            ref2 = H5Rcreate(H5gid, "dset2", HDF5Constants.H5R_DATASET_REGION, H5dsid);
            assertNotNull(ref2);
            ref3 = H5Rcreate(H5gid, "/dset", HDF5Constants.H5R_OBJECT, -1);
            assertNotNull(ref3);

            // Create reference on group
            ref4 = H5Rcreate(H5gid, "/Group1", HDF5Constants.H5R_OBJECT, -1);
            assertNotNull(ref3);
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            ...
            try {
                ...
                attr_obj_id =
                    H5Acreate(H5did, attr_obj_name, atype_obj_id, aspace_id, H5P_DEFAULT(), H5P_DEFAULT());
                assertTrue("testH5RVLattr_ref: ", attr_obj_id >= 0);

                H5Awrite(attr_obj_id, atype_obj_id, vl_obj_data);
            }
            catch (Exception err) {
                if (attr_obj_id > 0)
                    try {
            ...
            try {
                ...
                assertTrue(aspace_id > 0);
                attr_reg_id =
                    H5Acreate(H5did, attr_reg_name, atype_reg_id, aspace_id, H5P_DEFAULT(), H5P_DEFAULT());
                assertTrue("testH5RVLattr_ref: ", attr_reg_id >= 0);

                H5Awrite(attr_reg_id, atype_reg_id, vl_reg_data);
            }
            catch (Exception err) {
                if (attr_reg_id > 0)
                    try {
            ...
            try {
                H5Aread(attr_obj_id, atype_obj_id, vl_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
            ...
            try {
                H5Aread(attr_reg_id, atype_reg_id, vl_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
    ...
    public void testH5RVLdset_ref()
    {
        ...
        long dset_obj_id     = H5I_INVALID_HID();
        long dset_reg_id     = H5I_INVALID_HID();
        long dtype_obj_id    = H5I_INVALID_HID();
        long dtype_reg_id    = H5I_INVALID_HID();
        ...
        try {
            ...
            try {
                ...
                try (Arena arena = Arena.ofConfined()) {
                    // Allocate a MemorySegment to hold the string bytes
                    MemorySegment name_segment = arena.allocateFrom(dset_obj_name);
                    dset_obj_id = H5Dcreate2(H5fid, name_segment, dtype_obj_id, dspace_id, H5P_DEFAULT(),
                ...
                H5Dwrite(dset_obj_id, dtype_obj_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_obj_data);
            }
            catch (Exception err) {
                if (dset_obj_id > 0)
                    try {
            ...
            try {
                ...
                try (Arena arena = Arena.ofConfined()) {
                    // Allocate a MemorySegment to hold the string bytes
                    MemorySegment name_segment = arena.allocateFrom(dset_reg_name);
                    dset_reg_id = H5Dcreate2(H5fid, name_segment, dtype_reg_id, dspace_id, H5P_DEFAULT(),
                                             H5P_DEFAULT(), H5P_DEFAULT());
                }
                catch (Throwable err) {
                    err.printStackTrace();
                ...
                H5Dwrite(dset_reg_id, dtype_reg_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_reg_data);
            }
            catch (Exception err) {
                if (dset_reg_id > 0)
                    try {
            ...
            try {
                H5Dread(dset_obj_id, dtype_obj_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
            ...
            try {
                H5Dread(dset_reg_id, dtype_reg_id, H5S_ALL(), H5S_ALL(), H5P_DEFAULT(), vl_readbuf);
            }
            catch (Exception ex) {
                ex.printStackTrace();
            }
