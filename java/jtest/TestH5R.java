...
public class TestH5R {
    ...
    public void testH5Rget_object()
    {
        ...
        try {
            ref = H5.H5Rcreate_object(H5fid, objName, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            name = H5.H5Rget_obj_name(ref, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Rget_obj_type3()
    {
        ...
        try {
            obj_type = H5.H5Rget_obj_type3(ref, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Rcreate_regionref_object()
    {
        ...
        try {
            ref = H5.H5Rcreate_region(H5fid, objName, H5dsid, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    {
        String name = null;
        H5.H5Rcreate_object(H5fid, name, H5P_DEFAULT());
    }
    ...
    {
        String name = "";
        H5.H5Rcreate_object(-1, name, H5P_DEFAULT());
    }
    ...
    {
        String name = null;
        H5.H5Rcreate_region(H5fid, name, -1, H5P_DEFAULT());
    }
    ...
    {
        String name = "";
        H5.H5Rcreate_region(-1, name, -1, H5P_DEFAULT());
    }
    ...
    public void testH5Rcreate_attr_Nullname() throws Throwable
    {
        String name     = null;
        String attrname = "";
        H5.H5Rcreate_attr(H5fid, name, attrname, H5P_DEFAULT());
    }
    ...
    public void testH5Rcreate_attr_Invalidloc() throws Throwable
    {
        String name     = "";
        String attrname = "";
        H5.H5Rcreate_attr(-1, name, attrname, H5P_DEFAULT());
    }
