...
public class TestH5Pfapls3 {
    ...
    long plapl_id   = H5I_INVALID_HID();
    long dapl_id    = H5I_INVALID_HID();
    long plist_id   = H5I_INVALID_HID();
    long btplist_id = H5I_INVALID_HID();
    ...
    public void testH5Pset_fapl_ros3() throws Exception
    {
        ...
        H5Pset_fapl_ros3(fapl_id, config);

        assertEquals("driver types don't match", HDF5Constants.H5FD_ROS3, H5Pget_driver(fapl_id));

        /* get_fapl_ros3 can throw exception in error cases */
        H5FD_ros3_fapl_t copy = H5Pget_fapl_ros3(fapl_id);
    ...
    public void testH5Pget_fapl_ros3_invalid_fapl_id() throws Exception
    {
        ...
        H5FD_ros3_fapl_t fails = H5Pget_fapl_ros3(-1);
    }
    ...
    public void testH5Pget_fapl_ros3_fapl_id_of_wrong_driver_type() throws Exception
    {
        ...
        H5FD_ros3_fapl_t fails = H5Pget_fapl_ros3(fapl_id);
    }
