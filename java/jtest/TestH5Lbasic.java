...
public class TestH5Lbasic {
    ...
    public void testH5Lexists()
    {
        ...
        try {
            link_exists = H5.H5Lexists(H5fid, "None", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            link_exists = H5.H5Lexists(H5fid, "DS1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lexists: " + err);
        ...
        try {
            link_exists = H5.H5Lexists(H5fid, "G1/DS2", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lexists: " + err);
    ...
    {
        H5.H5Lget_info(H5fid, "None", H5P_DEFAULT());
    }
    ...
    public void testH5Lget_info_dataset()
    {
        ...
        try {
            link_info = H5.H5Lget_info(H5fid, "DS1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Lget_info_hardlink()
    {
        H5L_info_t link_info = null;
        try {
            link_info = H5.H5Lget_info(H5fid, "L1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lget_info: " + err);
    ...
    public void testH5Lget_info_by_idx_n0()
    {
        ...
        try {
            link_info2 = H5.H5Lget_info(H5fid, "DS1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lget_info: " + err);
    ...
    public void testH5Lget_info_by_idx_n3()
    {
        ...
        assertTrue("H5Lget_info_by_idx link type", link_info.type == HDF5Constants.H5L_TYPE_HARD);
        try {
            link_info2 = H5.H5Lget_info(H5fid, "L1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5.H5Lget_info: " + err);
    ...
    public void testH5Lvisit()
    {
        ...
        try {
            H5.H5Lvisit(H5fid, H5_INDEX_NAME(), H5_ITER_INC(), iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
