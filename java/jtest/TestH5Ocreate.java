...
public class TestH5Ocreate {
    ...
    private final long _createGroup(long fid, String name)
    {
        ...
        try {
            H5gcpl = H5P_DEFAULT();
            gid    = H5Gcreate(fid, name, H5P_DEFAULT(), H5gcpl, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Gcreate: " + err);
    ...
    public void createH5file() throws NullPointerException, HDF5Exception
    {
        ...
        try {
            ...
            H5Pset_link_creation_order(H5fcpl, H5P_CRT_ORDER_TRACKED() + H5P_CRT_ORDER_INDEXED());
            try (Arena arena = Arena.ofConfined()) {
                // Allocate a MemorySegment to hold the string bytes
    ...
    {
        H5Ocopy(H5fid, "None", H5fid, "DS1", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    {
        try {
            H5Ocopy(H5fid, "DS1", H5fid, "CPY1", H5P_DEFAULT(), H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
    ...
    public void testH5Ocopy_dst_link_exists() throws Throwable
    {
        ...
        H5Ocopy(H5fid, "CPY1", H5fid, "/G1/DS2", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    public void testH5Oget_info_by_idx_n0_create()
    {
        ...
        try {
            obj_info = H5Oget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 0, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Oget_info_by_idx_n1_create()
    {
        ...
        try {
            obj_info = H5Oget_info_by_idx(H5fid, "/", H5_INDEX_CRT_ORDER(), H5_ITER_INC(), 1, H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Oget_info_by_idx: " + err);
    ...
    public void testH5Oget_info_softlink_dangle() throws Throwable
    {
        ...
        H5Oget_info_by_name(H5fid, "L2", H5P_DEFAULT());
    }
    ...
    public void testH5Olink()
    {
        ...
        try {
            H5Olink(oid, H5fid, "CPY1", H5P_DEFAULT(), H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            dst_obj_info = H5Oget_info_by_name(H5fid, "CPY1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Ovisit_create()
    {
        ...
        class H5O_iter_callback implements H5O_iterate2_t {
            public int callback(long group, String name, H5O_info2_t info, H5O_iterate2_t.Function op_data)
            {
        ...
        try {
            H5Ovisit3(H5fid, H5_INDEX_CRT_ORDER(), H5_ITER_INC(), iter_cb, iter_data);
        }
        catch (Throwable err) {
            err.printStackTrace();
            fail("H5Ovisit: " + err);
    ...
    public void testH5Ocomment()
    {
        ...
        try {
            oid = H5Oopen(H5fid, "DS1", H5P_DEFAULT());
            H5Oset_comment(oid, "Test Comment");
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            obj_comment = H5Oget_comment(oid);
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Ocomment_by_name()
    {
        String obj_comment = null;
        try {
            H5Oset_comment_by_name(H5fid, "DS1", "Test Comment", H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
        }
        catch (Throwable err) {
            err.printStackTrace();
        ...
        try {
            obj_comment = H5Oget_comment_by_name(H5fid, "DS1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
    ...
    public void testH5Ocomment_by_name_clear()
    {
        ...
        assertTrue("H5Oget_comment_by_name: ", obj_comment.compareTo("Test Comment") == 0);
        try {
            H5Oset_comment_by_name(H5fid, "DS1", null, H5P_DEFAULT());
            H5Fflush(H5fid, H5F_SCOPE_LOCAL());
        }
        catch (Throwable err) {
            err.printStackTrace();
