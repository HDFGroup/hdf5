...
public class TestH5Ocreate {
    ...
    {
        H5.H5Ocopy(H5fid, "None", H5fid, "DS1", H5P_DEFAULT(), H5P_DEFAULT());
    }
    ...
    public void testH5Oget_info_softlink_dangle() throws Throwable
    {
        ...
        H5.H5Oget_info_by_name(H5fid, "L2", H5P_DEFAULT());
    }
    ...
    public void testH5Olink()
    {
        ...
        try {
            dst_obj_info = H5.H5Oget_info_by_name(H5fid, "CPY1", H5P_DEFAULT());
        }
        catch (Throwable err) {
            err.printStackTrace();
