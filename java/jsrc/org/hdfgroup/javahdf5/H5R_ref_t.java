...
public class H5R_ref_t {
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(64, hdf5_h.C_CHAR).withName("__data"),
         ...
         * }
         */
        public static long align(MemorySegment union) {
            return union.get(align$LAYOUT, align$OFFSET);
        }
