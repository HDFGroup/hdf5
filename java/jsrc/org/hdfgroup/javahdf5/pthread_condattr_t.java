...
public class pthread_condattr_t {
    ...
    private static final GroupLayout $LAYOUT =
        MemoryLayout
            .unionLayout(MemoryLayout.sequenceLayout(4, hdf5_h.C_CHAR).withName("__size"),
                         hdf5_h.C_INT.withName("__align"))
            .withName("$anon$41:9");
     ...
     * }
     */
    public static final OfInt __align$layout() { return __align$LAYOUT; }
     ...
     * }
     */
    public static int __align(MemorySegment union) { return union.get(__align$LAYOUT, __align$OFFSET); }
