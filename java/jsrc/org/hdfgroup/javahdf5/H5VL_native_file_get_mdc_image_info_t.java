...
public class H5VL_native_file_get_mdc_image_info_t {
    ...
    private static final GroupLayout $LAYOUT =
        MemoryLayout.structLayout(hdf5_h.C_POINTER.withName("addr"), hdf5_h.C_POINTER.withName("len"))
    ...
    private static final AddressLayout len$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("len"));
     ...
     * }
     */
    public static final AddressLayout len$layout() { return len$LAYOUT; }
     ...
     * }
     */
    public static MemorySegment len(MemorySegment struct) { return struct.get(len$LAYOUT, len$OFFSET); }
     ...
     * }
     */
    public static void len(MemorySegment struct, MemorySegment fieldValue)
    {
