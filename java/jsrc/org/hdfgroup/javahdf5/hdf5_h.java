...
public class hdf5_h extends hdf5_h_1 {
    ...
    {
        class Holder {
            static final MemorySegment H5_PACKAGE_STRING = hdf5_h.LIBRARY_ARENA.allocateFrom("HDF5 2.0.0");
        }
    ...
    {
        class Holder {
            static final MemorySegment H5_PACKAGE_VERSION = hdf5_h.LIBRARY_ARENA.allocateFrom("2.0.0");
        }
    ...
    {
        class Holder {
            static final MemorySegment H5_VERSION = hdf5_h.LIBRARY_ARENA.allocateFrom("2.0.0");
        }
    ...
    {
        class Holder {
            static final MemorySegment H5_VERS_STR = hdf5_h.LIBRARY_ARENA.allocateFrom("2.0.0");
        }
    ...
    public static MemorySegment H5_VERS_INFO()
    {
        class Holder {
            static final MemorySegment H5_VERS_INFO =
                hdf5_h.LIBRARY_ARENA.allocateFrom("HDF5 library version: 2.0.0");
        }
