...
public class H5ES_err_info_t {
    ...
    private static final GroupLayout $LAYOUT =
        MemoryLayout
            .structLayout(hdf5_h.C_POINTER.withName("api_name"), hdf5_h.C_POINTER.withName("api_args"),
                          ...
                          MemoryLayout.paddingLayout(4), hdf5_h.C_LONG_LONG.withName("op_ins_count"),
                          hdf5_h.C_LONG_LONG.withName("op_ins_ts"), hdf5_h.C_LONG_LONG.withName("op_exec_ts"),
                          hdf5_h.C_LONG_LONG.withName("op_exec_time"),
    ...
    private static final long err_stack_id$OFFSET = 72;
