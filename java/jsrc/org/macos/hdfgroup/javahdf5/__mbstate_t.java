...
public class __mbstate_t {
    ...
    private static final GroupLayout $LAYOUT =
        MemoryLayout
            .unionLayout(MemoryLayout.sequenceLayout(128, hdf5_h.C_CHAR).withName("__mbstate8"),
                         hdf5_h.C_LONG_LONG.withName("_mbstateL"))
            .withName("$anon$91:9");
    ...
    private static final SequenceLayout __mbstate8$LAYOUT =
        (SequenceLayout)$LAYOUT.select(groupElement("__mbstate8"));
     ...
     * }
     */
    public static final SequenceLayout __mbstate8$layout() { return __mbstate8$LAYOUT; }
     ...
     * }
     */
    public static final long __mbstate8$offset() { return __mbstate8$OFFSET; }
     ...
     * }
     */
    public static long[] __mbstate8$dimensions() { return __mbstate8$DIMS; }
     ...
     * }
     */
    public static final OfLong _mbstateL$layout() { return _mbstateL$LAYOUT; }
     ...
     * }
     */
    public static final long _mbstateL$offset() { return _mbstateL$OFFSET; }
