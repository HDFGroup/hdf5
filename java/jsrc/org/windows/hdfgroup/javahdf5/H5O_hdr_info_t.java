...
public class H5O_hdr_info_t {
    ...
    public static class space {
        ...
        private static final GroupLayout $LAYOUT =
            MemoryLayout
                .structLayout(hdf5_h.C_LONG_LONG.withName("total"), hdf5_h.C_LONG_LONG.withName("meta"),
                              hdf5_h.C_LONG_LONG.withName("mesg"), hdf5_h.C_LONG_LONG.withName("free"))
                .withName("$anon$127:5");
    ...
    public static class mesg {
        ...
        private static final GroupLayout $LAYOUT =
            MemoryLayout
                .structLayout(hdf5_h.C_LONG_LONG.withName("present"), hdf5_h.C_LONG_LONG.withName("shared"))
                .withName("$anon$133:5");
