...
public class H5L_info1_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        H5L_info1_t.u.layout().withName("u")
    ).withName("$anon$1458:9");
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            hdf5_h.C_LONG_LONG.withName("address"),
            hdf5_h.C_LONG_LONG.withName("val_size")
        ).withName("$anon$1463:5");
         ...
         * }
         */
        public static long address(MemorySegment union) {
            return union.get(address$LAYOUT, address$OFFSET);
        }
         ...
         * }
         */
        public static void address(MemorySegment union, long fieldValue) {
            union.set(address$LAYOUT, address$OFFSET, fieldValue);
        }
