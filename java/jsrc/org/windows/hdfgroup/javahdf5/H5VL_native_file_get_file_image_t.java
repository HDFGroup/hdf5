...
public class H5VL_native_file_get_file_image_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        hdf5_h.C_LONG_LONG.withName("buf_size"),
    ...
    private static final AddressLayout image_len$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("image_len"));
     ...
     * }
     */
    public static final AddressLayout image_len$layout() {
        return image_len$LAYOUT;
    }
     ...
     * }
     */
    public static final long image_len$offset() {
        return image_len$OFFSET;
    }
