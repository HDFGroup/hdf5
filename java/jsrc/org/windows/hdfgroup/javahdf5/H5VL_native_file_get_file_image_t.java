...
public class H5VL_native_file_get_file_image_t {
    ...
    private static final GroupLayout $LAYOUT =
        MemoryLayout
            .structLayout(hdf5_h.C_LONG_LONG.withName("buf_size"), hdf5_h.C_POINTER.withName("buf"),
                          hdf5_h.C_POINTER.withName("image_len"))
    ...
    private static final AddressLayout image_len$LAYOUT =
        (AddressLayout)$LAYOUT.select(groupElement("image_len"));
     ...
     * }
     */
    public static final AddressLayout image_len$layout() { return image_len$LAYOUT; }

    private static final long image_len$OFFSET = 16;
     ...
     * }
     */
    public static final long image_len$offset() { return image_len$OFFSET; }
     ...
     * }
     */
    public static MemorySegment image_len(MemorySegment struct)
    {
        return struct.get(image_len$LAYOUT, image_len$OFFSET);
    }
     ...
     * }
     */
    public static void image_len(MemorySegment struct, MemorySegment fieldValue)
    {
        struct.set(image_len$LAYOUT, image_len$OFFSET, fieldValue);
    }
