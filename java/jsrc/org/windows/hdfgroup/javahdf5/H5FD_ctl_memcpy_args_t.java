...
public class H5FD_ctl_memcpy_args_t {
    ...
    private static final GroupLayout $LAYOUT =
        MemoryLayout
            .structLayout(hdf5_h.C_POINTER.withName("dstbuf"), hdf5_h.C_LONG_LONG.withName("dst_off"),
                          hdf5_h.C_POINTER.withName("srcbuf"), hdf5_h.C_LONG_LONG.withName("src_off"),
                          hdf5_h.C_LONG_LONG.withName("len"))
