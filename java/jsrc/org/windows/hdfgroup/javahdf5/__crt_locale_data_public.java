...
public class __crt_locale_data_public {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout
                                                   .structLayout(hdf5_h.C_POINTER.withName("_locale_pctype"),
    ...
    private static final AddressLayout _locale_pctype$LAYOUT =
        (AddressLayout)$LAYOUT.select(groupElement("_locale_pctype"));
     ...
     * }
     */
    public static final AddressLayout _locale_pctype$layout() { return _locale_pctype$LAYOUT; }
     ...
     * }
     */
    public static final long _locale_pctype$offset() { return _locale_pctype$OFFSET; }
    ...
    private static final OfInt _locale_mb_cur_max$LAYOUT =
        (OfInt)$LAYOUT.select(groupElement("_locale_mb_cur_max"));
     ...
     * }
     */
    public static final OfInt _locale_mb_cur_max$layout() { return _locale_mb_cur_max$LAYOUT; }
     ...
     * }
     */
    public static final long _locale_mb_cur_max$offset() { return _locale_mb_cur_max$OFFSET; }
    ...
    private static final OfInt _locale_lc_codepage$LAYOUT =
        (OfInt)$LAYOUT.select(groupElement("_locale_lc_codepage"));
     ...
     * }
     */
    public static final OfInt _locale_lc_codepage$layout() { return _locale_lc_codepage$LAYOUT; }
     ...
     * }
     */
    public static final long _locale_lc_codepage$offset() { return _locale_lc_codepage$OFFSET; }
