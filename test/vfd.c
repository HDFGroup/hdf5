...
const char *FILENAME[] = {
    ...
    "multi_aio_test",		/*13*/
    "multi_aio_test2",		/*14*/
    "sec2_aio_error_test",	/*15*/
    "core_aio_error_test",	/*16*/
    "stdio_aio_error_test",	/*17*/
    "family_aio_error_test",	/*18*/
    "multi_aio_error_test",	/*19*/
    "new_multi_file_v16",	/*20*/
    NULL
};
...
test_multi_compat(void)
{
    ...
    h5_fixname(FILENAME[20], fapl, newname, sizeof newname);
