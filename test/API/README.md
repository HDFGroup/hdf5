...
public API and serve as regression tests for HDF5 [VOL Connectors](hdfgroup.github.io/hdf5/develop/_h5_v_l__u_g.html).
...
connector in this manner, refer to section 2.3 of the [HDF5 VOL Connector Author Guide](hdfgroup.github.io/hdf5/develop/_v_o_l__connector.html).
