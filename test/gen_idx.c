 ...
 *              which will generate a file called "btree_idx_1_6.h5".
...
const char *FILENAME[1] = {
    "btree_idx_1_6.h5"	/* file with datasets that use B-tree indexing method */
}; 
...
static void gen_idx_file(void)
{
    ...
    did2  = H5Dcreate(fid, DSET_FILTER, H5T_NATIVE_INT, sid, dcpl);
    assert(did2 >= 0);
