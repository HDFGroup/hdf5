...
#define accum_write(a, s, b)                                                                                 \
    H5F_block_write(f, H5FD_MEM_DEFAULT, (haddr_t)(a), (size_t)(s), H5P_DATASET_XFER_DEFAULT, (b))
#define accum_read(a, s, b)                                                                                  \
    H5F_block_read(f, H5FD_MEM_DEFAULT, (haddr_t)(a), (size_t)(s), H5P_DATASET_XFER_DEFAULT, (b))
...
test_free(const H5F_io_info_t *fio_info)
{
    ...
    if (accum_free(fio_info, 0, 256 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;

    /* Free an empty accumulator */
    if (accum_free(fio_info, 0, 256 * 1024 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_free(fio_info, 64 * sizeof(int32_t), 65 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_free(fio_info, 0, sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_free(fio_info, 127 * sizeof(int32_t), sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_free(fio_info, 2 * sizeof(int32_t), sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_free(fio_info, 62 * sizeof(int32_t), 4 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_write(68 * sizeof(int32_t), 4 * sizeof(int32_t), wbuf) < 0)
        FAIL_STACK_ERROR;
    HDmemcpy(expect + 68, wbuf, 4 * sizeof(int32_t));
    if (accum_free(fio_info, 62 * sizeof(int32_t), 16 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_free(fio_info, 66 * sizeof(int32_t), 4 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_write(72 * sizeof(int32_t), 4 * sizeof(int32_t), wbuf) < 0)
        FAIL_STACK_ERROR;
    HDmemcpy(expect + 72, wbuf, 4 * sizeof(int32_t));
    if (accum_free(fio_info, 70 * sizeof(int32_t), 4 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_write(72 * sizeof(int32_t), 4 * sizeof(int32_t), wbuf) < 0)
        FAIL_STACK_ERROR;
    HDmemcpy(expect + 72, wbuf, 4 * sizeof(int32_t));
    if (accum_free(fio_info, 70 * sizeof(int32_t), 8 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
    ...
    if (accum_free(fio_info, 72 * sizeof(int32_t), 4 * sizeof(int32_t)) < 0)
        FAIL_STACK_ERROR;
