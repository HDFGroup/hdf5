...
test_floattypes(hid_t file)
{
    ...
    /* long double */
    {
        long double orig_data[2][5] = {{(long double)1.6081706885101836e+60L, -255.32099170994480,
                                   (long double)1.2677579992621376e-61L, 64568.289448797700,
                                   (long double)-1.0619721778839084e-75L},
                                  {(long double)2.1499497833454840e+56L, 6.6562295504670740e-3, -1.5747263393432150,
                                   1.0711093225222612, -9.8971679387636870e-1}};
