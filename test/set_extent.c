...
#define CONFIG_ALL         (CONFIG_COMPRESS + CONFIG_FILL + CONFIG_EARLY_ALLOC)
#define FILL_VALUE         -1
...
static int test_rank1(hid_t fapl, hid_t dcpl, hbool_t do_fill_value, hbool_t set_istore_k);
...
static int test_random_rank4(hid_t fapl, hid_t dcpl, hbool_t do_fillvalue, hbool_t do_sparse);
...
static int
test_rank1(hid_t fapl, hid_t dcpl, hbool_t do_fill_value, hbool_t set_istore_k)
{
...
static int
test_rank2(hid_t fapl, hid_t dcpl, hbool_t do_fill_value, hbool_t set_istore_k)
{
...
static int
test_rank3(hid_t fapl, hid_t dcpl, hbool_t do_fill_value, hbool_t set_istore_k)
{
 ...
 */
static int
test_random_rank4(hid_t fapl, hid_t dcpl, hbool_t do_fillvalue, hbool_t do_sparse)
{
    hid_t             file    = -1;
    hid_t             dset    = -1;
    hid_t             fspace  = -1;
