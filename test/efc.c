...
test_single(void)
{
    ...
    /* Open parent file */
    if (NULL ==
        (f0 = H5F_open(filename[0], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (f1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f1) < 0)
        FAIL_STACK_ERROR
    if (NULL == (ftmp1 = H5F_open(filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f0, f1) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f1 != ftmp1)
        TEST_ERROR
    ...
    if (H5F_efc_close(f0, f1) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f1 = H5F_open(filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f1->shared->nrefs != 2)
        TEST_ERROR

    if (NULL == (f2 = H5F_efc_open(f0, filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f2) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f2 = H5F_open(filename[2], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f1->shared->nrefs != 2)
        TEST_ERROR
    ...
    if (NULL == (f3 = H5F_efc_open(f0, filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f3) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f3 = H5F_open(filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f1->shared->nrefs != 2)
        TEST_ERROR
    if (f2->shared->nrefs != 2)
    ...
    if (NULL == (f4 = H5F_efc_open(f0, filename[4], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f4) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f4 = H5F_open(filename[4], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f1->shared->nrefs != 1)
        TEST_ERROR
    if (f2->shared->nrefs != 2)
    ...
    if (NULL == (ftmp3 = H5F_efc_open(f0, filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (ftmp2 = H5F_efc_open(f0, filename[2], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (ftmp1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (ftmp4 = H5F_efc_open(f0, filename[4], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f0, f2) < 0)
        FAIL_STACK_ERROR
    if (NULL == (ftmp2 = H5F_open(filename[2], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (ftmp1->shared->nrefs != 2)
        TEST_ERROR
    if (NULL == (f2 = H5F_efc_open(f0, filename[2], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f2) < 0)
        FAIL_STACK_ERROR
    if (ftmp1->shared->nrefs != 1)
    ...
    if (NULL == (f3 = H5F_efc_open(f0, filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp3 = H5F_open(filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f0, f4) < 0)
        FAIL_STACK_ERROR
    if (NULL == (ftmp4 = H5F_open(filename[4], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (f1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f2 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp1 = H5F_open(filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
...
test_graph_nocycle(void)
{
    ...
    if (NULL == (f1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f2 = H5F_efc_open(f1, filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL ==
        (f0 = H5F_open(filename[0], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp1 = H5F_open(filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id,
                                  dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f2 = H5F_efc_open(ftmp1, filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (f3 = H5F_efc_open(f0, filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f4 = H5F_efc_open(f3, filename[4], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL ==
        ...
        FAIL_STACK_ERROR
    if (NULL ==
        (f1 = H5F_open(filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f2 = H5F_efc_open(f0, filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp2 = H5F_efc_open(f1, filename[2], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f3 = H5F_efc_open(f2, filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f2, f3) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f3 = H5F_efc_open(f1, filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (f3 = H5F_efc_open(f1, filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f4 = H5F_efc_open(f1, filename[4], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f0, f1) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f3 = H5F_efc_open(f2, filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f4 = H5F_efc_open(f2, filename[4], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f2, f4) < 0)
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f2) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f4 = H5F_efc_open(f3, filename[4], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f3, f4) < 0)
        FAIL_STACK_ERROR
    if (H5F_efc_close(f2, f3) < 0)
...
test_graph_cycle(void)
{
    ...
    if (NULL ==
        (f0 = H5F_open(filename[0], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp0 = H5F_efc_open(f0, filename[0], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (f1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp1 = H5F_efc_open(f1, filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (f1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp0 = H5F_efc_open(f1, filename[0], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (f2 = H5F_efc_open(f1, filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp1 = H5F_efc_open(f2, filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL == (f2 = H5F_efc_open(f0, filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp0 = H5F_efc_open(f2, filename[0], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f1, f2) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f3 = H5F_efc_open(f1, filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp1 = H5F_efc_open(f3, filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL ==
        (f0 = H5F_open(filename[0], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp0 = H5F_open(filename[0], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f1 = H5F_efc_open(f0, filename[1], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp1 = H5F_efc_open(f1, filename[0], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f1, ftmp1) < 0)
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f1) < 0)
    ...
    if (ftmp1->shared->nrefs != 2)
        TEST_ERROR
    if (NULL == (f0 = H5F_open(filename[0], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f0->shared->nrefs != 2)
        TEST_ERROR
    ...
    if (H5F_try_close(f1) < 0)
        FAIL_STACK_ERROR
    if (NULL ==
        (f2 = H5F_open(filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f2->shared->nrefs != 1)
        TEST_ERROR
    if (H5F_try_close(f2) < 0)
    ...
    if (H5F_try_close(f2) < 0)
        FAIL_STACK_ERROR
    if (NULL ==
        (f3 = H5F_open(filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f3->shared->nrefs != 1)
        TEST_ERROR
    if (H5F_try_close(f3) < 0)
    ...
    if (NULL == (f3 = H5F_efc_open(f2, filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp2 = H5F_efc_open(f3, filename[2], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f2, f3) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f3 = H5F_efc_open(f0, filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp0 = H5F_efc_open(f3, filename[0], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f3, ftmp0) < 0)
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f3) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f4 = H5F_efc_open(f1, filename[4], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp1 = H5F_efc_open(f4, filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f4, ftmp1) < 0)
        FAIL_STACK_ERROR
    if (H5F_efc_close(f1, f4) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f5 = H5F_efc_open(f2, filename[5], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (ftmp2 = H5F_efc_open(f5, filename[2], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_try_close(f3) < 0)
        FAIL_STACK_ERROR
    if (NULL ==
        (f4 = H5F_open(filename[4], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (f4->shared->nrefs != 1)
        TEST_ERROR
    if (H5F_try_close(f4) < 0)
        FAIL_STACK_ERROR
    if (NULL ==
        (f5 = H5F_open(filename[5], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f2, f5) < 0)
        FAIL_STACK_ERROR
    if (NULL == (f5 = H5F_open(filename[5], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f1) < 0)
        FAIL_STACK_ERROR
    if (H5F_efc_close(f0, f2) < 0)
    ...
    if (H5F_efc_close(f1, ftmp2) < 0)
        FAIL_STACK_ERROR
    if (NULL == (ftmp3 = H5F_efc_open(f1, filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f2, ftmp1) < 0)
        FAIL_STACK_ERROR
    if (NULL == (ftmp2 = H5F_efc_open(f2, filename[2], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (H5F_efc_close(f2, ftmp2) < 0)
        FAIL_STACK_ERROR
    if (NULL == (ftmp3 = H5F_efc_open(f2, filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (H5F_efc_close(f3, ftmp2) < 0)
        FAIL_STACK_ERROR
    if (NULL == (ftmp3 = H5F_efc_open(f3, filename[3], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    ...
    if (NULL ==
        (f2 = H5F_open(filename[2], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f1 = H5F_efc_open(f2, filename[1], H5F_ACC_RDWR, fcpl_id, fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
    if (NULL == (f3 = H5F_efc_open(f1, filename[3], H5F_ACC_RDWR | H5F_ACC_CREAT | H5F_ACC_TRUNC, fcpl_id,
                                   fapl_id, dxpl_id)))
        FAIL_STACK_ERROR
