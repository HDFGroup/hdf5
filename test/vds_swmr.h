...
/* Planes */
H5_DLLVAR hsize_t PLANES[N_SOURCES][RANK];

/* File names for source datasets */
H5_DLLVAR char FILE_NAMES[N_SOURCES][NAME_LEN];

/* VDS file name */
H5_DLLVAR char VDS_FILE_NAME[NAME_LEN];

/* Dataset names */
H5_DLLVAR char SOURCE_DSET_PATH[NAME_LEN];
H5_DLLVAR char VDS_DSET_NAME[NAME_LEN];
#endif /* VDS_SWMR_H */
