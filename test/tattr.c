    ...
    for (new_format = FALSE; new_format <= TRUE; new_format++) {
        ...
        if (new_format == TRUE) {
            ...
            for (use_shared = FALSE; use_shared <= TRUE; use_shared++) {
                ...
                test_attr_dense_unlink(my_fcpl,
                                       my_fapl); /* Test unlinking object with attributes in dense storage */
                ...
                test_attr_corder_create_dense(
                    my_fcpl,
                    my_fapl); /* Test dense attribute storage on an object w/attribute creation order info */
                ...
                test_attr_corder_transition(my_fcpl, my_fapl); /* Test attribute storage transitions on an
                                                                  object w/attribute creation order info */
                test_attr_corder_delete(
                    my_fcpl,
                    my_fapl); /* Test deleting object using dense storage w/attribute creation order info */
                ...
                if (use_shared == TRUE) {
                    test_attr_shared_write(
                        my_fcpl, my_fapl); /* Test writing to shared attributes in compact & dense storage */
                    test_attr_shared_rename(
                        my_fcpl, my_fapl); /* Test renaming shared attributes in compact & dense storage */
                    test_attr_shared_delete(
                        my_fcpl, my_fapl); /* Test deleting shared attributes in compact & dense storage */
                    test_attr_shared_unlink(my_fcpl, my_fapl); /* Test unlinking object with shared attributes
                                                                  in compact & dense storage */
                }                                              /* end if */
