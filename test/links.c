...
obj_visit(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Ovisit2(fid, H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata, H5O_INFO_BASIC) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit0_new : ovisit0_old;
    if (H5Ovisit2(gid, H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata, H5O_INFO_BASIC) < 0)
        FAIL_STACK_ERROR
    if (H5Gclose(gid) < 0)
        FAIL_STACK_ERROR
...
obj_visit_by_name(hid_t fapl, hbool_t new_format)
{
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit0_new : ovisit0_old;
    if (H5Ovisit_by_name2(fid, "/", H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata, H5O_INFO_BASIC,
                          H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit0_new : ovisit0_old;
    if (H5Ovisit_by_name2(gid, ".", H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata, H5O_INFO_BASIC,
                          H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Gclose(gid) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit1_new : ovisit1_old;
    if (H5Ovisit_by_name2(fid, "/Group1", H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata, H5O_INFO_BASIC,
                          H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit2_new : ovisit2_old;
    if (H5Ovisit_by_name2(fid, "/Group1/Group2", H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata,
...
obj_visit_stop(hid_t fapl, hbool_t new_format)
{
    ...
    nvisited = 0;
    if ((ret = H5Ovisit_by_name2(fid, "/", H5_INDEX_NAME, H5_ITER_INC, visit_obj_stop_cb, &nvisited,
                                 H5O_INFO_BASIC, H5P_DEFAULT)) < 0)
        FAIL_STACK_ERROR
    if (ret != H5_ITER_STOP)
        TEST_ERROR
                  ...
                  H5_iter_order_t order, unsigned max_links, haddr_t *objno)
{
    ...
    for (v = 0; v < 2; v++) {
        ...
        for (u = 0; u < max_links; u++) {
            ...
            if (H5Oget_info2(obj_id, &oi, H5O_INFO_BASIC) < 0)
                TEST_ERROR
    ...
    if (H5Oget_info2(mount_file_id, &oi, H5O_INFO_BASIC) < 0)
        TEST_ERROR
                  ...
                  unsigned max_links, haddr_t *objno)
{
    ...
    for (v = 0; v < 2; v++) {
        ...
        for (u = 0; u < max_links; u++) {
            ...
            if (H5Oget_info_by_name2(group_id, objname, &oinfo, H5O_INFO_BASIC | H5O_INFO_NUM_ATTRS,
                                     H5P_DEFAULT) < 0)
                TEST_ERROR
            ...
            if (H5Oget_info_by_idx2(group_id, ".", idx_type, order, (hsize_t)u, &oinfo,
    ...
    for (idx_type = H5_INDEX_NAME; idx_type <= H5_INDEX_CRT_ORDER; idx_type++) {
        ...
        for (order = H5_ITER_INC; order <= H5_ITER_NATIVE; order++) {
            ...
            for (use_index = FALSE; use_index <= TRUE; use_index++) {
                ...
                H5E_BEGIN_TRY
                {
                    ret = H5Oget_info_by_idx2(group_id, ".", H5_INDEX_NAME, order, (hsize_t)0, &oinfo,
                ...
                for (u = 0; u < max_compact; u++) {
                    ...
                    /* Retrieve group's address on disk */
                    if (H5Oget_info2(group_id2, &oinfo, H5O_INFO_BASIC) < 0)
                        TEST_ERROR
                    objno[u] = oinfo.addr;
                ...
                H5E_BEGIN_TRY
                {
                    ret = H5Oget_info_by_idx2(group_id, ".", H5_INDEX_NAME, order, (hsize_t)u, &oinfo,
                                              H5O_INFO_BASIC, H5P_DEFAULT);
                }
                H5E_END_TRY;
                if (ret >= 0)
...
object_info_old(hid_t fapl)
{
    ...
    for (order = H5_ITER_INC; order <= H5_ITER_NATIVE; order++) {
        ...
        H5E_BEGIN_TRY
        {
            ret = H5Oget_info_by_idx2(group_id, ".", H5_INDEX_NAME, order, (hsize_t)0, &oinfo, H5O_INFO_BASIC,
                                      H5P_DEFAULT);
        }
        H5E_END_TRY;
        if (ret >= 0)
        ...
        H5E_BEGIN_TRY
        {
            ret = H5Oget_info_by_idx2(group_id, ".", H5_INDEX_NAME, order, (hsize_t)u, &oinfo, H5O_INFO_BASIC,
                                      H5P_DEFAULT);
        }
        H5E_END_TRY;
        if (ret >= 0)
        ...
        H5E_BEGIN_TRY
        {
            ret = H5Oget_info_by_idx2(group_id, ".", H5_INDEX_CRT_ORDER, order, (hsize_t)(u - 1), &oinfo,
                                      H5O_INFO_BASIC, H5P_DEFAULT);
        }
        H5E_END_TRY;
        if (ret >= 0)
...
timestamps(hid_t fapl)
{
    ...
    if (H5Oget_info2(group_id, &oinfo, H5O_INFO_TIME | H5O_INFO_HDR) < 0)
        TEST_ERROR
    if (H5Oget_info2(group_id2, &oinfo2, H5O_INFO_TIME | H5O_INFO_HDR) < 0)
        TEST_ERROR
