...
cklinks(hid_t fapl, hbool_t new_format)
{
    ...
    /* Hard link */
    if (H5Oget_info_by_name(file, "d1", &oinfo1, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file, "grp1/hard", &oinfo2, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    ...
    /* Symbolic link */
    if (H5Oget_info_by_name(file, "grp1/soft", &oinfo2, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5O_TYPE_DATASET != oinfo2.type) {
        H5_FAILED();
        HDprintf("    %d: Unexpected object type should have been a dataset\n", __LINE__);
    ...
    if (H5Lget_info(file, "grp1/dangle", &linfo2, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    ...
    if (H5Lget_info(file, "grp1/recursive", &linfo2, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5L_TYPE_SOFT != linfo2.type) {
        H5_FAILED();
        HDprintf("    %d: Unexpected object type should have been a symbolic link\n", __LINE__);
...
test_lcpl(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Lget_info(file_id, "group", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    /* Check that its character encoding is the default */
    if (H5Lget_info(file_id, "type", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.cset != H5F_DEFAULT_CSET)
        TEST_ERROR
    ...
    /* Check that its character encoding is the default */
    if (H5Lget_info(file_id, "dataset", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.cset != H5F_DEFAULT_CSET)
        TEST_ERROR
    ...
    if (H5Lget_info(file_id, "group2", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    /* Check that its character encoding is UTF-8 */
    if (H5Lget_info(file_id, "type2", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.cset != H5T_CSET_UTF8)
        TEST_ERROR
    ...
    /* Check that its character encoding is UTF-8 */
    if (H5Lget_info(file_id, "dataset2", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.cset != H5T_CSET_UTF8)
        TEST_ERROR
    ...
    if (H5Lget_info(file_id, "/dataset2_link", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (H5Lcreate_soft("dataset2", file_id, "slink_to_dset2", lcpl_id, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Lget_info(file_id, "slink_to_dset2", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.cset != H5T_CSET_UTF8)
        TEST_ERROR
    ...
    if (H5Lmove(file_id, "slink_to_dset2", file_id, "moved_slink", lcpl_id, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Lget_info(file_id, "moved_slink", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.cset != H5T_CSET_ASCII)
        TEST_ERROR
    ...
    if (H5Lcopy(file_id, "moved_slink", file_id, "copied_slink", lcpl_id, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Lget_info(file_id, "copied_slink", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.cset != H5T_CSET_UTF8)
        TEST_ERROR
    ...
    if (H5Lcreate_external("filename", "path", file_id, "extlink", lcpl_id, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Lget_info(file_id, "extlink", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.cset != H5T_CSET_UTF8)
        TEST_ERROR
...
test_move_preserves(hid_t fapl_id, hbool_t new_format)
{
    ...
    if (H5Lget_info(file_id, "group", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(file_id, "group", &oinfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    old_cset = linfo.cset;
    ...
    if (H5Lcreate_hard(file_id, "group", file_id, "group2", H5P_DEFAULT, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(file_id, "group2", &oinfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (old_modification_time != oinfo.mtime)
        TEST_ERROR
    if (H5Lget_info(file_id, "group2", &linfo, H5P_DEFAULT) < 0)
    ...
    if (H5Lcopy(file_id, "group", file_id, "group_copied", lcpl_id, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(file_id, "group_copied", &oinfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (old_modification_time != oinfo.mtime)
        TEST_ERROR
    if (H5Lget_info(file_id, "group_copied", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder_valid != TRUE)
        TEST_ERROR
    if (linfo.corder != 2)
    ...
    if (H5Lmove(file_id, "group_copied", file_id, "group_copied2", H5P_DEFAULT, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(file_id, "group_copied2", &oinfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (old_modification_time != oinfo.mtime)
        TEST_ERROR
    if (H5Lget_info(file_id, "group_copied2", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder_valid != TRUE)
        TEST_ERROR
    if (linfo.corder != 3)
    ...
    if (H5Lmove(file_id, "group", file_id, "group_moved", lcpl_id, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(file_id, "group_moved", &oinfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (old_modification_time != oinfo.mtime)
        TEST_ERROR
    if (H5Lget_info(file_id, "group_moved", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder_valid != TRUE)
        TEST_ERROR
    if (linfo.corder != 4)
    ...
    if (H5Lmove(file_id, "group_moved", file_id, "group_moved_again", H5P_DEFAULT, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(file_id, "group_moved_again", &oinfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (old_modification_time != oinfo.mtime)
        TEST_ERROR
    if (H5Lget_info(file_id, "group_moved_again", &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder_valid != TRUE)
        TEST_ERROR
    if (linfo.corder != 5)
...
external_link_root(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Lget_info(fid, "ext_link", &linfo, H5P_DEFAULT) < 0)
        goto error;
...
external_link_query(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Lget_info(fid, "src", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (H5Oget_info_by_name(fid, "src", &oi, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
external_link_closing(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Lget_info(fid1, "elink/elink/elink/type1", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Lget_info(fid1, "elink/elink/elink", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(fid1, "elink/elink/elink/type1", &oi, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(fid1, "elink/elink/elink", &oi, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (H5Gclose(gid) < 0)
        TEST_ERROR
    if (H5Oget_info_by_name(fid1, "elink/elink2/group2/group3/group4", &oi, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (H5Gclose(gid) < 0)
        TEST_ERROR
    if (H5Lget_info(fid1, "elink/file2group1/file2group2/slink/group3", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (H5Gclose(gid) < 0)
        TEST_ERROR
    if (H5Lget_info(fid1, "elink/file2group3", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (H5Lget_info(fid1, "elink/elink", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
...
external_symlink(const char *env_h5_drvr, hid_t fapl, hbool_t new_format)
{
    ...
    char  filename1[NAME_BUF_SIZE], filename2a[NAME_BUF_SIZE], filename2b[NAME_BUF_SIZE],
        filename3a[NAME_BUF_SIZE], filename3b[NAME_BUF_SIZE], filename4a[NAME_BUF_SIZE],
        filename4b[NAME_BUF_SIZE], filename5a[NAME_BUF_SIZE], filename5b[NAME_BUF_SIZE],
        tmpname[NAME_BUF_SIZE], cwdpath[NAME_BUF_SIZE];
...
ud_hard_links(hid_t fapl)
{
    ...
    if (H5Lget_info(fid, "group", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (H5Lget_info(fid, "ud_link", &li, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
ud_callbacks(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Lget_info(fid, UD_CB_LINK_NAME, &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (li.u.val_size != 16)
        TEST_ERROR
...
lapl_nlinks(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Lget_val(fid, "soft17", NULL, (size_t)0, plist) < 0)
        TEST_ERROR
    if (H5Lget_info(fid, "soft17", NULL, plist) < 0)
        TEST_ERROR
...
linkinfo(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Lget_info(fid, "datatype", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (li.type != H5L_TYPE_HARD)
        TEST_ERROR
    if (H5Lget_info(fid, "dataset", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (li.type != H5L_TYPE_HARD)
        TEST_ERROR

    if (H5Lget_info(fid, "ext_link", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (li.type != H5L_TYPE_EXTERNAL)
        TEST_ERROR
    if (H5Lget_info(fid, "softlink", &li, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (H5Lget_info(fid, "group", NULL, H5P_DEFAULT) < 0)
        TEST_ERROR
...
link_visit(hid_t fapl, hbool_t new_format)
{
    ...
    udata.idx  = 0;
    udata.info = lvisit0;
    if (H5Lvisit(fid, H5_INDEX_NAME, H5_ITER_INC, visit_link_cb, &udata) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = lvisit0;
    if (H5Lvisit(gid, H5_INDEX_NAME, H5_ITER_INC, visit_link_cb, &udata) < 0)
        FAIL_STACK_ERROR
    if (H5Gclose(gid) < 0)
        FAIL_STACK_ERROR
...
link_visit_by_name(hid_t fapl, hbool_t new_format)
{
    ...
    udata.idx  = 0;
    udata.info = lvisit0;
    if (H5Lvisit_by_name(gid, ".", H5_INDEX_NAME, H5_ITER_INC, visit_link_cb, &udata, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Gclose(gid) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = lvisit1;
    if (H5Lvisit_by_name(fid, "/Group1", H5_INDEX_NAME, H5_ITER_INC, visit_link_cb, &udata, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = lvisit2;
    if (H5Lvisit_by_name(fid, "/Group1/Group2", H5_INDEX_NAME, H5_ITER_INC, visit_link_cb, &udata,
                         H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
obj_visit(hid_t fapl, hbool_t new_format)
{
    ...
    if (H5Ovisit(fid, H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit0_new : ovisit0_old;
    if (H5Ovisit(gid, H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata) < 0)
        FAIL_STACK_ERROR
    if (H5Gclose(gid) < 0)
        FAIL_STACK_ERROR
...
obj_visit_by_name(hid_t fapl, hbool_t new_format)
{
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit0_new : ovisit0_old;
    if (H5Ovisit_by_name(fid, "/", H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit0_new : ovisit0_old;
    if (H5Ovisit_by_name(gid, ".", H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Gclose(gid) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit1_new : ovisit1_old;
    if (H5Ovisit_by_name(fid, "/Group1", H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    ...
    udata.idx  = 0;
    udata.info = new_format ? ovisit2_new : ovisit2_old;
    if (H5Ovisit_by_name(fid, "/Group1/Group2", H5_INDEX_NAME, H5_ITER_INC, visit_obj_cb, &udata,
                         H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
visit_obj_stop_cb(hid_t H5_ATTR_UNUSED group_id, const char H5_ATTR_UNUSED *name,
                  const H5O_info_t H5_ATTR_UNUSED *oinfo, void *_op_data)
{
...
obj_visit_stop(hid_t fapl, hbool_t new_format)
{
    ...
    nvisited = 0;
    if ((ret = H5Ovisit_by_name(fid, "/", H5_INDEX_NAME, H5_ITER_INC, visit_obj_stop_cb, &nvisited,
                                H5P_DEFAULT)) < 0)
        FAIL_STACK_ERROR
    if (ret != H5_ITER_STOP)
        TEST_ERROR
...
corder_create_compact(hid_t fapl)
{
    ...
    for (u = 0; u < max_compact; u++) {
        ...
        HDsnprintf(objname, sizeof(objname), "filler %u", u);
        if (H5Lget_info(group_id, objname, &linfo, H5P_DEFAULT) < 0)
            TEST_ERROR
...
link_info_by_idx_check(hid_t group_id, const char *linkname, hsize_t n, hbool_t hard_link, hbool_t use_index)
{
    ...
    if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_INC, (hsize_t)0, &linfo, H5P_DEFAULT) <
        0)
        TEST_ERROR
    if (linfo.corder != 0)
        TEST_ERROR
    ...
    HDmemset(&linfo, 0, sizeof(linfo));
    if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_INC, n, &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    ...
    if (use_index) {
        ...
        HDmemset(&linfo, 0, sizeof(linfo));
        if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_NATIVE, (hsize_t)0, &linfo,
                               H5P_DEFAULT) < 0)
            TEST_ERROR
        if (linfo.corder != 0)
            TEST_ERROR
        ...
        HDmemset(&linfo, 0, sizeof(linfo));
        if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_NATIVE, n, &linfo, H5P_DEFAULT) < 0)
            TEST_ERROR
        if (linfo.corder != (int64_t)n)
            TEST_ERROR
    ...
    HDmemset(&linfo, 0, sizeof(linfo));
    if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_DEC, n, &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder != 0)
        TEST_ERROR
    ...
    HDmemset(&linfo, 0, sizeof(linfo));
    if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_DEC, (hsize_t)0, &linfo, H5P_DEFAULT) <
        0)
        TEST_ERROR
    if (linfo.corder != (int64_t)n)
        TEST_ERROR
    ...
    HDmemset(&linfo, 0, sizeof(linfo));
    if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_INC, (hsize_t)0, &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder != 0)
        TEST_ERROR
    ...
    HDmemset(&linfo, 0, sizeof(linfo));
    if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_INC, n, &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder != (int64_t)n)
        TEST_ERROR
    ...
    HDmemset(&linfo, 0, sizeof(linfo));
    if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_DEC, n, &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder != 0)
        TEST_ERROR
    ...
    HDmemset(&linfo, 0, sizeof(linfo));
    if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_DEC, (hsize_t)0, &linfo, H5P_DEFAULT) < 0)
        TEST_ERROR
    if (linfo.corder != (int64_t)n)
        TEST_ERROR
...
link_info_by_idx(hid_t fapl)
{
    ...
    for (hard_link = FALSE; hard_link <= TRUE; hard_link++) {
        ...
        for (use_index = FALSE; use_index <= TRUE; use_index++) {
            ...
            H5E_BEGIN_TRY
            {
                ret = H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_INC, (hsize_t)0, &linfo,
                                         H5P_DEFAULT);
            }
            H5E_END_TRY;
            if (ret >= 0)
            ...
            H5E_BEGIN_TRY
            {
                ret = H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_INC, (hsize_t)u, &linfo,
                                         H5P_DEFAULT);
            }
            H5E_END_TRY;
            if (ret >= 0)
            ...
            H5E_BEGIN_TRY
            {
                ret = H5Lget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, H5_ITER_DEC, (hsize_t)u, &linfo,
                                         H5P_DEFAULT);
            }
            H5E_END_TRY;
            if (ret >= 0)
...
link_info_by_idx_old(hid_t fapl)
{
    ...
    for (hard_link = FALSE; hard_link <= TRUE; hard_link++) {
        ...
        for (u = 0; u < CORDER_NLINKS; u++) {
            ...
            if (hard_link) {
                if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_INC, (hsize_t)u, &linfo,
                                       H5P_DEFAULT) < 0)
                    TEST_ERROR
            ...
            if (hard_link) {
                if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_NATIVE, (hsize_t)u, &linfo,
                                       H5P_DEFAULT) < 0)
                    TEST_ERROR
                if (H5F_addr_ne(linfo.u.address, objno[u]))
                    TEST_ERROR
            ...
            if (hard_link) {
                if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_DEC, (hsize_t)u, &linfo,
                                       H5P_DEFAULT) < 0)
                    TEST_ERROR
        ...
        for (order = H5_ITER_INC; order <= H5_ITER_DEC; H5_INC_ENUM(H5_iter_order_t, order)) {
            ...
            for (use_index = FALSE; use_index <= TRUE; use_index++) {
                ...
                for (u = 0; u < (max_compact - 1); u++) {
                    ...
                    HDmemset(&linfo, 0, sizeof(linfo));
                    if (H5Lget_info_by_idx(group_id, ".", idx_type, order, (hsize_t)0, &linfo, H5P_DEFAULT) <
                        0)
                        TEST_ERROR
                    if (order == H5_ITER_INC) {
                        if (linfo.corder != (u + 1))
                ...
                for (u = 0; u < max_compact; u++) {
                    ...
                    HDmemset(&linfo, 0, sizeof(linfo));
                    if (H5Lget_info_by_idx(group_id, ".", idx_type, order, (hsize_t)u, &linfo, H5P_DEFAULT) <
                        0)
                        TEST_ERROR
                    if (order == H5_ITER_INC) {
...
delete_by_idx_old(hid_t fapl)
{
    ...
    for (order = H5_ITER_INC; order <= H5_ITER_DEC; H5_INC_ENUM(H5_iter_order_t, order)) {
        ...
        for (u = 0; u < (CORDER_NLINKS - 1); u++) {
            ...
            /* Verify the link information for first link in appropriate order */
            HDmemset(&linfo, 0, sizeof(linfo));
            if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, order, (hsize_t)0, &linfo, H5P_DEFAULT) < 0)
                TEST_ERROR
            if (order == H5_ITER_INC) {
        ...
        for (u = 0; u < (CORDER_NLINKS / 2); u++) {
            ...
            /* Verify the link information for current link in appropriate order */
            HDmemset(&linfo, 0, sizeof(linfo));
            if (H5Lget_info_by_idx(group_id, ".", H5_INDEX_NAME, order, (hsize_t)u, &linfo, H5P_DEFAULT) < 0)
                TEST_ERROR
            if (order == H5_ITER_INC) {
 ...
 */
static int
link_iterate_cb(hid_t group_id, const char *link_name, const H5L_info_t *info, void *_op_data)
{
                   ...
                   link_iter_info_t *iter_info)
{
    ...
    if (H5Literate(group_id, idx_type, order, &skip, link_iterate_cb, iter_info) < 0)
        TEST_ERROR
    ...
    iter_info->curr     = order != H5_ITER_DEC ? 0 : (max_links - 1);
    HDmemset(iter_info->visited, 0, sizeof(hbool_t) * iter_info->max_visit);
    if ((ret = H5Literate(group_id, idx_type, order, &skip, link_iterate_cb, iter_info)) < 0)
        TEST_ERROR
    ...
    for (idx_type = H5_INDEX_NAME; idx_type <= H5_INDEX_CRT_ORDER; H5_INC_ENUM(H5_index_t, idx_type)) {
        ...
        for (order = H5_ITER_INC; order <= H5_ITER_NATIVE; H5_INC_ENUM(H5_iter_order_t, order)) {
            ...
            for (use_index = FALSE; use_index <= TRUE; use_index++) {
                ...
                /* (should be OK) */
                if (H5Literate(group_id, idx_type, order, NULL, link_iterate_cb, NULL) < 0)
                    TEST_ERROR
...
link_iterate_old_check(hid_t group_id, H5_iter_order_t order, unsigned max_links, link_iter_info_t *iter_info)
{
    ...
    iter_info->curr     = order != H5_ITER_DEC ? 0 : (max_links - 1);
    HDmemset(iter_info->visited, 0, sizeof(hbool_t) * iter_info->max_visit);
    if (H5Literate(group_id, H5_INDEX_NAME, order, &skip, link_iterate_old_cb, iter_info) < 0)
        TEST_ERROR
    ...
    iter_info->curr     = order != H5_ITER_DEC ? 0 : (max_links - 1);
    HDmemset(iter_info->visited, 0, sizeof(hbool_t) * iter_info->max_visit);
    if ((ret = H5Literate(group_id, H5_INDEX_NAME, order, &skip, link_iterate_old_cb, iter_info)) < 0)
        TEST_ERROR
    if (ret != CORDER_ITER_STOP)
        TEST_ERROR
    if (iter_info->ncalled != 3)
...
link_iterate_old(hid_t fapl)
{
    ...
    for (order = H5_ITER_INC; order <= H5_ITER_NATIVE; H5_INC_ENUM(H5_iter_order_t, order)) {
        ...
        /* Check for iteration on empty group */
        /* (should be OK) */
        if (H5Literate(group_id, H5_INDEX_NAME, order, NULL, link_iterate_old_cb, NULL) < 0)
            TEST_ERROR
                  ...
                  H5_iter_order_t order, unsigned max_links, haddr_t *objno)
{
    ...
    if (H5Oget_info(mount_file_id, &oi) < 0)
        TEST_ERROR
    ...
    if (H5F_addr_ne(oi.addr, mnt_root_addr))
        TEST_ERROR
    if (H5F_addr_eq(oi.addr, objno[mnt_idx]))
        TEST_ERROR
...
open_by_idx(hid_t fapl)
{
    ...
    if (NULL == (objno = (haddr_t *)HDmalloc(sizeof(haddr_t) * (max_compact * 2))))
        TEST_ERROR
...
open_by_idx_old(hid_t fapl)
{
    ...
    for (order = H5_ITER_INC; order <= H5_ITER_NATIVE; H5_INC_ENUM(H5_iter_order_t, order)) {
        ...
        /* Verify opening objects by index */
        if (open_by_idx_check(group_id, soft_group_id, mount_file_id, H5_INDEX_NAME, order, u, objno) < 0)
            TEST_ERROR
...
object_info_check(hid_t main_group_id, hid_t soft_group_id, H5_index_t idx_type, H5_iter_order_t order,
                  unsigned max_links, haddr_t *objno)
{
    char       objname[NAME_BUF_SIZE]; /* Object name */
    hid_t      group_id = -1;          /* ID of group to test */
    ...
    for (v = 0; v < 2; v++) {
        ...
        for (u = 0; u < max_links; u++) {
            ...
            if (H5Oget_info_by_name(group_id, objname, &oinfo, H5P_DEFAULT) < 0)
                TEST_ERROR

            /* Check that the object is the correct one */
            if (H5F_addr_ne(oinfo.addr, objno[u]))
                TEST_ERROR
            if (H5F_addr_ne(oinfo.num_attrs, u))
                TEST_ERROR

            /* Query the object's information, by index */
            if (H5Oget_info_by_idx(group_id, ".", idx_type, order, (hsize_t)u, &oinfo, H5P_DEFAULT) < 0)
                TEST_ERROR
            ...
            if (order == H5_ITER_INC) {
                ...
                if (H5F_addr_ne(oinfo.addr, objno[dec_u]))
                    TEST_ERROR
                if (H5F_addr_ne(oinfo.num_attrs, dec_u))
                    TEST_ERROR
            } /* end if */
            else {
                /* XXX: What to do about native order? */
    ...
    for (idx_type = H5_INDEX_NAME; idx_type <= H5_INDEX_CRT_ORDER; H5_INC_ENUM(H5_index_t, idx_type)) {
        ...
        for (order = H5_ITER_INC; order <= H5_ITER_NATIVE; H5_INC_ENUM(H5_iter_order_t, order)) {
            ...
            for (use_index = FALSE; use_index <= TRUE; use_index++) {
                ...
                H5E_BEGIN_TRY
                {
                    ret = H5Oget_info_by_idx(group_id, ".", H5_INDEX_NAME, order, (hsize_t)0, &oinfo,
                                             H5P_DEFAULT);
                }
                H5E_END_TRY;
                if (ret >= 0)
                ...
                for (u = 0; u < max_compact; u++) {
                    ...
                    /* Retrieve group's address on disk */
                    if (H5Oget_info(group_id2, &oinfo) < 0)
                        TEST_ERROR
                    objno[u] = oinfo.addr;
                ...
                H5E_BEGIN_TRY
                {
                    ret = H5Oget_info_by_idx(group_id, ".", H5_INDEX_NAME, order, (hsize_t)u, &oinfo,
                                             H5P_DEFAULT);
                }
                H5E_END_TRY;
                if (ret >= 0)
...
object_info_old(hid_t fapl)
{
    ...
    for (order = H5_ITER_INC; order <= H5_ITER_NATIVE; H5_INC_ENUM(H5_iter_order_t, order)) {
        ...
        H5E_BEGIN_TRY
        {
            ret = H5Oget_info_by_idx(group_id, ".", H5_INDEX_CRT_ORDER, order, (hsize_t)(u - 1), &oinfo,
                                     H5P_DEFAULT);
        }
        H5E_END_TRY;
        if (ret >= 0)
        ...
        /* Verify querying objects by name */
        if (object_info_check(group_id, soft_group_id, H5_INDEX_NAME, order, u, objno) < 0)
            TEST_ERROR
...
timestamps(hid_t fapl)
{
    ...
    if (H5Oget_info(group_id, &oinfo) < 0)
        TEST_ERROR
    if (H5Oget_info(group_id2, &oinfo2) < 0)
        TEST_ERROR
    ...
    if (oinfo.btime == oinfo2.btime)
        TEST_ERROR
    if ((oinfo.hdr.flags & H5O_HDR_STORE_TIMES) != 0)
        TEST_ERROR
    if ((oinfo2.hdr.flags & H5O_HDR_STORE_TIMES) == 0)
        TEST_ERROR
    if (oinfo.hdr.space.total >= oinfo2.hdr.space.total)
        TEST_ERROR
    if (oinfo.hdr.space.meta >= oinfo2.hdr.space.meta)
        TEST_ERROR
