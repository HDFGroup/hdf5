...
test_misc18(void)
{
    ...
    ret =
        H5Oget_info_by_name2(fid, MISC18_DSET1_NAME, &oinfo, H5O_INFO_HDR | H5O_INFO_NUM_ATTRS, H5P_DEFAULT);
    CHECK(ret, FAIL, "H5Oget_info_by_name");
    ...
    /* Get object information */
    ret =
        H5Oget_info_by_name2(fid, MISC18_DSET2_NAME, &oinfo, H5O_INFO_HDR | H5O_INFO_NUM_ATTRS, H5P_DEFAULT);
    CHECK(ret, FAIL, "H5Oget_info_by_name");
    VERIFY(oinfo.hdr.nmesgs, 6, "H5Oget_info_by_name");
    VERIFY(oinfo.hdr.nchunks, 1, "H5Oget_info_by_name");
    VERIFY(oinfo.hdr.space.total, 272, "H5Oget_info_by_name");
