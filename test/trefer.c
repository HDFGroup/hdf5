...
{
    remove(FILE_REF_PARAM);
    remove(FILE_REF_OBJ);
    remove(FILE_REF_VL_OBJ);
    remove(FILE_REF_CMPND_OBJ);
    remove(FILE_REF_REG);
    remove(FILE_REF_REG_1D);
    remove(FILE_REF_OBJ_DEL);
    remove(FILE_REF_GRP);
    remove(FILE_REF_ATTR);
    remove(FILE_REF_EXT1);
    remove(FILE_REF_EXT2);
    remove(FILE_REF_COMPAT);
}
