...
main(void)
{
    ...
    if (h5_cleanup(EXT_FNAME, fapl_id_old)) {
        remove("extern_1r.raw");
        remove("extern_2r.raw");
        remove("extern_3r.raw");
        remove("extern_4r.raw");

        remove("extern_1w.raw");
        remove("extern_2w.raw");
        remove("extern_3w.raw");
        remove("extern_4w.raw");
