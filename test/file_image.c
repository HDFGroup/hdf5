...
main(void)
{
    ...
    if (H5Pset_fapl_sec2(fapl) < 0)
        ...
        errors += test_get_file_image("H5Fget_file_image() with sec2 driver", 0, fapl);
    ...
    if (H5Pset_fapl_stdio(fapl) < 0)
        ...
        errors += test_get_file_image("H5Fget_file_image() with stdio driver", 1, fapl);
    ...
    if (H5Pset_fapl_core(fapl, (size_t)(64 * 1024), TRUE) < 0)
        ...
        errors += test_get_file_image("H5Fget_file_image() with core driver", 2, fapl);
