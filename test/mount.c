...
test_preopen(hid_t fapl)
{
    ...
    if (H5Oget_info2(grp, &oinfo, H5O_INFO_BASIC) < 0)
        FAIL_STACK_ERROR
...
test_postopen(hid_t fapl)
{
    ...
    if (H5Oget_info_by_name2(file2, "/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
test_unlink(hid_t fapl)
{
     ...
     */
    if (H5Oget_info_by_name2(file1, "/mnt_unlink/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(mnt, "/mnt_unlink/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(root, "/mnt_unlink/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(root, "file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    H5E_BEGIN_TRY { status = H5Oget_info_by_name2(mnt, "file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT); }
    H5E_END_TRY;
    if (status >= 0) {
        H5_FAILED();
...
test_mvmpt(hid_t fapl)
{
    ...
    if (H5Oget_info_by_name2(file1, "/mnt_move_b/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
test_uniformity(hid_t fapl)
{
    ...
    if (H5Oget_info_by_name2(file1, "/", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(file1, "/mnt1", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(file1, "mnt1", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(file1, "/mnt1/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(file1, "mnt1/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR

    /* Access the same things from the file2 handle */
    if (H5Oget_info_by_name2(file2, "/", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(file2, "/mnt1", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(file2, "mnt1", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(file2, "/mnt1/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name2(file2, "mnt1/file2", &oinfo, H5O_INFO_BASIC, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
test_fcdegree_strong(hid_t fapl)
{
    ...
    H5E_BEGIN_TRY { ret = H5Oget_info2(gidA, &oinfo, H5O_INFO_BASIC); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR
    H5E_BEGIN_TRY { ret = H5Oget_info2(gidAM, &oinfo, H5O_INFO_BASIC); }
    H5E_END_TRY;
    if (ret >= 0)
        TEST_ERROR
