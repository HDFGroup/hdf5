...
test_hide(hid_t fapl)
{
    ...
    if (H5Oget_info_by_name(file1, "/mnt1/file1", &oi1, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
     ...
     */
    if (H5Oget_info_by_name(file1, "/file1", &oi2, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
test_assoc(hid_t fapl)
{
     ...
     * of file2.
     */
    if (H5Oget_info_by_name(file1, "/mnt1", &oi2, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
test_postopen(hid_t fapl)
{
    ...
    if (H5Oget_info_by_name(file2, "/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
test_unlink(hid_t fapl)
{
     ...
     */
    if (H5Oget_info_by_name(file1, "/mnt_unlink/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(mnt, "/mnt_unlink/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(root, "/mnt_unlink/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
test_mvmpt(hid_t fapl)
{
    ...
    if (H5Oget_info_by_name(file1, "/mnt_move_b/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
...
test_uniformity(hid_t fapl)
{
    ...
    if (H5Oget_info_by_name(file1, "/", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file1, "/mnt1", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file1, "mnt1", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file1, "/mnt1/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file1, "mnt1/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR

    /* Access the same things from the file2 handle */
    if (H5Oget_info_by_name(file2, "/", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file2, "/mnt1", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file2, "mnt1", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file2, "/mnt1/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
    if (H5Oget_info_by_name(file2, "mnt1/file2", &oinfo, H5P_DEFAULT) < 0)
        FAIL_STACK_ERROR
