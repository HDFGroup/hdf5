...
!> @{
  ...
  INTEGER :: SELECT_IOC_ONE_PER_NODE_F    !< SELECT_IOC_ONE_PER_NODE
  INTEGER :: SELECT_IOC_EVERY_NTH_RANK_F  !< SELECT_IOC_EVERY_NTH_RANK
  INTEGER :: SELECT_IOC_WITH_CONFIG_F     !< SELECT_IOC_WITH_CONFIG
  INTEGER :: SELECT_IOC_TOTAL_F           !< SELECT_IOC_TOTAL
  INTEGER :: IOC_SELECTION_OPTIONS_F      !< IOC_SELECTION_OPTIONS
