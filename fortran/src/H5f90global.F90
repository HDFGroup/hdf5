...
MODULE H5GLOBAL
  ...
  !
  INTEGER(HID_T) :: H5T_NATIVE_REAL_C_FLOAT = -1
  INTEGER(HID_T) :: H5T_NATIVE_REAL_C_DOUBLE = -1
  INTEGER(HID_T) :: H5T_NATIVE_REAL_C_LONG_DOUBLE = -1
  INTEGER(HID_T) :: H5T_NATIVE_INTEGER = -1
  INTEGER(HID_T) :: H5T_NATIVE_REAL = -1
  INTEGER(HID_T) :: H5T_NATIVE_DOUBLE = -1
  INTEGER(HID_T) :: H5T_NATIVE_CHARACTER  = -1
  INTEGER(HID_T) :: H5T_STD_REF_OBJ = -1
  INTEGER(HID_T) :: H5T_STD_REF_DSETREG = -1
  INTEGER(HID_T) :: H5T_IEEE_F32BE = -1
  INTEGER(HID_T) :: H5T_IEEE_F32LE = -1
  INTEGER(HID_T) :: H5T_IEEE_F64BE = -1
  INTEGER(HID_T) :: H5T_IEEE_F64LE = -1
  INTEGER(HID_T) :: H5T_STD_I8BE = -1
  INTEGER(HID_T) :: H5T_STD_I8LE = -1
  INTEGER(HID_T) :: H5T_STD_I16BE = -1
  INTEGER(HID_T) :: H5T_STD_I16LE = -1
  INTEGER(HID_T) :: H5T_STD_I32BE = -1
  INTEGER(HID_T) :: H5T_STD_I32LE = -1
  INTEGER(HID_T) :: H5T_STD_I64BE = -1
  INTEGER(HID_T) :: H5T_STD_I64LE = -1
  INTEGER(HID_T) :: H5T_STD_U8BE = -1
  INTEGER(HID_T) :: H5T_STD_U8LE = -1
  INTEGER(HID_T) :: H5T_STD_U16BE = -1
  INTEGER(HID_T) :: H5T_STD_U16LE = -1
  INTEGER(HID_T) :: H5T_STD_U32BE = -1
  INTEGER(HID_T) :: H5T_STD_U32LE = -1
  INTEGER(HID_T) :: H5T_STD_U64BE = -1
  INTEGER(HID_T) :: H5T_STD_U64LE = -1
  INTEGER(HID_T) :: H5T_STRING = -1
  INTEGER(HID_T) :: H5T_STD_B8BE = -1
  INTEGER(HID_T) :: H5T_STD_B8LE = -1
  INTEGER(HID_T) :: H5T_STD_B16BE = -1
  INTEGER(HID_T) :: H5T_STD_B16LE = -1
  INTEGER(HID_T) :: H5T_STD_B32BE = -1
  INTEGER(HID_T) :: H5T_STD_B32LE = -1
  INTEGER(HID_T) :: H5T_STD_B64BE = -1
  INTEGER(HID_T) :: H5T_STD_B64LE = -1
  INTEGER(HID_T) :: H5T_NATIVE_B8 = -1
  INTEGER(HID_T) :: H5T_NATIVE_B16 = -1
  INTEGER(HID_T) :: H5T_NATIVE_B32 = -1
  INTEGER(HID_T) :: H5T_NATIVE_B64 = -1
  INTEGER(HID_T) :: H5T_FORTRAN_S1 = -1
  INTEGER(HID_T) :: H5T_C_S1 = -1
  ...
  !
  INTEGER :: H5F_ACC_RDWR_F = -1
  INTEGER :: H5F_ACC_RDONLY_F = -1
  INTEGER :: H5F_ACC_TRUNC_F = -1
  INTEGER :: H5F_ACC_EXCL_F = -1
  INTEGER :: H5F_ACC_DEBUG_F = -1
  INTEGER :: H5F_SCOPE_LOCAL_F = -1
  INTEGER :: H5F_SCOPE_GLOBAL_F = -1
  INTEGER :: H5F_CLOSE_DEFAULT_F = -1
  INTEGER :: H5F_CLOSE_WEAK_F = -1
  INTEGER :: H5F_CLOSE_SEMI_F = -1
  INTEGER :: H5F_CLOSE_STRONG_F = -1
  INTEGER :: H5F_OBJ_FILE_F = -1
  INTEGER :: H5F_OBJ_DATASET_F = -1
  INTEGER :: H5F_OBJ_GROUP_F = -1
  INTEGER :: H5F_OBJ_DATATYPE_F = -1
  INTEGER :: H5F_OBJ_ALL_F = -1
  INTEGER :: H5F_LIBVER_EARLIEST_F = -1
  INTEGER :: H5F_LIBVER_LATEST_F = -1
  INTEGER :: H5F_UNLIMITED_F = -1
  !
