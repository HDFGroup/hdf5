...
h5init_flags_c(int_f *h5d_flags, size_t_f *h5d_size_flags, int_f *h5e_flags, hid_t_f *h5e_hid_flags,
               int_f *h5es_flags, hid_t_f *h5es_hid_flags, int_f *h5f_flags, int_f *h5fd_flags,
...
/******/
{
    ...
    /* H5ES_WAIT_FOREVER  Defined in FORTRAN */
    /* H5ES_WAIT_NONE (0) Set in FORTRAN */

    h5es_flags[0] = (int_f)H5ES_STATUS_IN_PROGRESS;
    h5es_flags[1] = (int_f)H5ES_STATUS_SUCCEED;
    h5es_flags[2] = (int_f)H5ES_STATUS_FAIL;
