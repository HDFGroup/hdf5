...
!! \param hdferr   \fortran_error
!!
!! See C API: @ref H5Pget_dset_use_spatial_tree()
!!
  SUBROUTINE h5pget_dset_use_spatial_tree_f(dapl_id, use_tree, hdferr)
    IMPLICIT NONE
    INTEGER(HID_T) , INTENT(IN)              :: dapl_id
    ...
    INTERFACE
        INTEGER(C_INT) FUNCTION H5Pget_dset_use_spatial_tree_c(dapl_id, use_tree) BIND(C, NAME='H5Pget_dset_use_spatial_tree')
    ...
    hdferr = INT(H5Pget_dset_use_spatial_tree_c(dapl_id, c_use_tree))

    ! Transfer value of C C_BOOL type to Fortran LOGICAL
    use_tree = c_use_tree

    END SUBROUTINE h5pget_dset_use_spatial_tree_f
...
!! \param hdferr   \fortran_error
!!
!! See C API: @ref H5Pset_dset_use_spatial_tree()
!!
  SUBROUTINE h5pset_dset_use_spatial_tree_f(dapl_id, use_tree, hdferr)
    IMPLICIT NONE
    INTEGER(HID_T) , INTENT(IN)              :: dapl_id
    ...
    INTERFACE
        INTEGER FUNCTION h5pset_dset_use_spatial_tree_c(dapl_id, use_tree) BIND(C, NAME='H5Pset_dset_use_spatial_tree')
          IMPORT :: HID_T, C_BOOL
          IMPLICIT NONE
          INTEGER(HID_T), INTENT(IN), VALUE :: dapl_id
          LOGICAL(C_BOOL), INTENT(IN), VALUE :: use_tree
        END FUNCTION h5pset_dset_use_spatial_tree_c
    END INTERFACE

    ! Transfer value of Fortran LOGICAL to C C_BOOL type
    c_use_tree = use_tree

    hdferr = INT(h5pset_dset_use_spatial_tree_c(dapl_id, c_use_tree))

  END SUBROUTINE h5pset_dset_use_spatial_tree_f
