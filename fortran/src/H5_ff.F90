...
MODULE H5LIB
  ...
  !
  INTEGER, PARAMETER :: H5ES_FLAGS_LEN = 3
...
!*****
    ...
    H5ES_WAIT_FOREVER_F = HUGE(H5ES_WAIT_FOREVER_F)
    H5ES_WAIT_NONE_F = 0_C_INT64_T

    H5ES_STATUS_IN_PROGRESS_F = H5ES_flags(1)
    H5ES_STATUS_SUCCEED_F     = H5ES_flags(2)
    H5ES_STATUS_FAIL_F        = H5ES_flags(3)
