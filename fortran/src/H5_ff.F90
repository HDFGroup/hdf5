...
MODULE H5LIB
  ...
  !
  INTEGER, PARAMETER :: H5F_FLAGS_LEN = 23
...
!!
!! \return h5_type Returns the type
!!
...
!!
!! \return offset Offset of a member within the derived type
!!
...
!! \return datetime  A date/time array using Fortran conventions:
!!                 \li datetime(1) = year
!!                 \li datetime(2) = month
!!                 \li datetime(3) = day
