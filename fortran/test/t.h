...
H5_DLL int_f nh5_fixname_c(_fcd base_name, size_t_f *base_namelen, hid_t_f *fapl, _fcd full_name,
                           size_t_f *full_namelen);

H5_DLL int_f nh5_cleanup_c(_fcd base_name, size_t_f *base_namelen, hid_t_f *fapl);

H5_DLL H5_ATTR_NORETURN void nh5_exit_c(int_f *status);

H5_DLL void nh5_env_nocleanup_c(int_f *status);
