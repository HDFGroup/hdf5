...
Java Examples Maven Integration:
   - **org.hdfgroup:hdf5-java-examples** - Complete Java examples with platform-specific dependencies
   - Cross-platform support (Linux, Windows, macOS x86_64, macOS aarch64)
