    ...
    if (NOT ZLIB_USE_EXTERNAL) # This checks if zlib should be found on the system or built from an external source
      ...
      if (H5_ZLIB_FOUND)
        if (HDF5_USE_ZLIB_NG)
          ...
          # zlib-ng config (e.g. from vcpkg) exports zlib-ng::zlib and sets
          # zlib-ng_INCLUDE_DIR rather than ZLIB_INCLUDE_DIR / ZLIB::ZLIB
          if (NOT ZLIB_INCLUDE_DIR AND DEFINED zlib-ng_INCLUDE_DIR)
            set (ZLIB_INCLUDE_DIR ${zlib-ng_INCLUDE_DIR})
          endif ()
          if (TARGET zlib-ng::zlib AND NOT TARGET ZLIB::ZLIB)
            add_library (ZLIB::ZLIB ALIAS zlib-ng::zlib)
          endif ()
        else ()
