...
test_printf(unsigned config, hid_t fapl)
{
    ...
    if(H5Dwrite(vdset, H5T_NATIVE_INT, memspace, filespace, dxpl_id, buf[0]) < 0)
        TEST_ERROR
    ...
    /* Read srcdset[1] */
    if(H5Dread(srcdset[1], H5T_NATIVE_INT, memspace, H5S_ALL, dxpl_id, rbuf[0]) < 0)
        TEST_ERROR
    ...
    /* Read srcdset[2] */
    if(H5Dread(srcdset[2], H5T_NATIVE_INT, memspace, H5S_ALL, dxpl_id, rbuf[0]) < 0)
        TEST_ERROR
    ...
    /* Write to srcdset[3] */
    if(H5Dwrite(srcdset[3], H5T_NATIVE_INT, memspace, H5S_ALL, dxpl_id, buf[0]) < 0)
        TEST_ERROR
    ...
    /* Write to srcdset[4] */
    if(H5Dwrite(srcdset[4], H5T_NATIVE_INT, memspace, H5S_ALL, dxpl_id, buf[0]) < 0)
        TEST_ERROR
    ...
    /* Write to srcdset[5] */
    if(H5Dwrite(srcdset[5], H5T_NATIVE_INT, memspace, H5S_ALL, dxpl_id, buf[0]) < 0)
        TEST_ERROR
    ...
    if(H5Sselect_hyperslab(srcspace, H5S_SELECT_SET, start, NULL, count, NULL) < 0)
        TEST_ERROR
    if(H5Dwrite(srcdset[0], H5T_NATIVE_INT, memspace, srcspace, dxpl_id, buf[0]) < 0)
        TEST_ERROR
    ...
    if(H5Sselect_all(srcspace) < 0)
        TEST_ERROR
    if(H5Dwrite(srcdset[1], H5T_NATIVE_INT, memspace, srcspace, dxpl_id, buf[0]) < 0)
        TEST_ERROR
    ...
    if(H5Sselect_hyperslab(srcspace, H5S_SELECT_SET, start, NULL, count, NULL) < 0)
        TEST_ERROR
    if(H5Dwrite(srcdset[2], H5T_NATIVE_INT, memspace, srcspace, dxpl_id, buf[0]) < 0)
        TEST_ERROR
    ...
    if(H5Sselect_hyperslab(memspace, H5S_SELECT_SET, start, NULL, block, NULL) < 0)
        TEST_ERROR
    if(H5Dwrite(srcdset[3], H5T_NATIVE_INT, memspace, srcspace, dxpl_id, buf[0]) < 0)
        TEST_ERROR
