...
test_actual_io_mode(int selection_mode)
{
    ...
    switch (selection_mode) {
        ...
        case TEST_ACTUAL_IO_CONTIGUOUS:
            ...
            actual_chunk_opt_mode_expected = H5D_MPIO_LINK_CHUNK; /*!FIXME Could reinstate single chunk case and mark it as H5D_MPIO_NO_CHUNK_OPTIMIZATION, or reevaluate how we report these in the wake of mdset -NAF */
