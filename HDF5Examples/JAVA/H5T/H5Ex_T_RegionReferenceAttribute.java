...
public class H5Ex_T_RegionReferenceAttribute {
    ...
    private static void writeRegRef(Arena arena)
    {
        ...
        try {
            ...
            dataset_id =
                H5Dcreate2(file_id, DATASETNAME, H5T_STD_I32LE_g(), dataspace_id,
    ...
    private static void readRegRef(Arena arena)
    {
        ...
        try {
            ...
            try {
                attribute_id = H5Aopen(file_id, ATTRIBUTENAME, H5P_DEFAULT());

                try {
                    // Get dataspace and allocate memory for read buffer.
                    dataspace_id = H5Aget_space(attribute_id);
                    H5Sget_simple_extent_dims(attribute_id, dims, null);
