 ...
 * the file COPYING, which can be found at the root of the Granular BitRound source code   *
...
main(void)
{
    ...
    size_t       nelmts = 5;
    /* number of elements in cd_values */ /* NB: Must equal H5Zgranularbr.c: CCR_FLT_PRM_NBR */
    unsigned int       flags;
