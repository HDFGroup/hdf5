    ...
    if (HDF5_FOUND)
      if (NOT HDF5_static_C_FOUND AND NOT HDF5_shared_C_FOUND)
        ...
        if (USE_SHARED_LIBS AND HDF5_shared_C_FOUND)
          ...
          get_target_property (liblocation ${HDF5_C_SHARED_LIBRARY} IMPORTED_LOCATION_${UPPER_BUILD_TYPE})
          get_filename_component (HDF5_LIBRARY_PATH ${liblocation} DIRECTORY)
        else ()
