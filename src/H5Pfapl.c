 ...
 */
herr_t
H5Pget_cache(hid_t plist_id, int *mdc_nelmts, size_t *rdcc_nslots/*out*/,
    size_t *rdcc_nbytes/*out*/, double *rdcc_w0/*out*/)
{
    H5P_genplist_t *plist;      /* Property list pointer */
    herr_t ret_value = SUCCEED;   /* return value */

    FUNC_ENTER_API(FAIL)
    H5TRACE5("e", "i*Isxxx", plist_id, mdc_nelmts, rdcc_nslots, rdcc_nbytes,
             rdcc_w0);
 ...
 */
herr_t
H5Pget_mdc_log_options(hid_t plist_id, hbool_t *is_enabled/*out*/,
    char *location/*out*/, size_t *location_size/*out*/, hbool_t *start_on_access/*out*/)
{
    H5P_genplist_t *plist;              /* Property list pointer */
    ...
    FUNC_ENTER_API(FAIL)
    H5TRACE5("e", "ixxxx", plist_id, is_enabled, location, location_size,
             start_on_access);
 ...
 */
herr_t
H5Pget_file_locking(hid_t fapl_id, hbool_t *use_file_locking/*out*/,
 ...
 */
herr_t
H5Pget_page_buffer_size(hid_t plist_id, size_t *buf_size/*out*/,
    unsigned *min_meta_perc/*out*/, unsigned *min_raw_perc/*out*/)
{
    H5P_genplist_t *plist;      /* Property list pointer */
    herr_t ret_value = SUCCEED;   /* return value */
