 ...
 */
#define H5_VERS_INFO_HELPER(major, minor, release)      "HDF5 library version: " #major "." #minor "." #release
#define H5_VERS_INFO_CONCAT(major, minor, release, sub) H5_VERS_INFO_HELPER(major, minor, release) sub
