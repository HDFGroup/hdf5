...
#define H5_VERS_RELEASE	223	/* For tweaks, bug-fixes, or development     */
#define H5_VERS_SUBRELEASE "swmr1"	/* For pre-releases like snap0       */
				/* Empty string for real releases.           */
#define H5_VERS_INFO    "HDF5 library version: 1.9.223-swmr1"      /* Full version string */
