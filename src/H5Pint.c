...
hid_t H5P_CLS_READ_CONTEXT_ACQUIRE_ID_g         = FAIL;
H5P_genclass_t *H5P_CLS_READ_CONTEXT_ACQUIRE_g  = NULL;
hid_t H5P_CLS_TRANSACTION_START_ID_g            = FAIL;
H5P_genclass_t *H5P_CLS_TRANSACTION_START_g      = NULL;
hid_t H5P_CLS_TRANSACTION_FINISH_ID_g           = FAIL;
...
hid_t H5P_LST_READ_CONTEXT_ACQUIRE_ID_g = FAIL;
        ...
        if((nclass + nlist) > 0) {
            ...
            if(nlist > 0) {
                ...
                if(H5I_nmembers(H5I_GENPROP_LST) == 0) {
                    H5P_LST_FILE_CREATE_ID_g =
                        ...
                        H5P_LST_READ_CONTEXT_ACQUIRE_ID_g =
            ...
            if(nlist == 0 && nclass > 0) {
                ...
                if(H5I_nmembers(H5I_GENPROP_CLS) == 0) {
                        ...
                        H5P_CLS_READ_CONTEXT_ACQUIRE_ID_g = 
...
H5P__new_plist_of_type(H5P_plist_type_t type)
{
    ...
    switch(type) {
        ...
        case H5P_TYPE_READ_CONTEXT_ACQUIRE:
            class_id = H5P_CLS_READ_CONTEXT_ACQUIRE_ID_g;
            break;

        case H5P_TYPE_TRANSACTION_START:
            class_id = H5P_CLS_TRANSACTION_START_ID_g;
            break;

        case H5P_TYPE_TRANSACTION_FINISH:
            class_id = H5P_CLS_TRANSACTION_FINISH_ID_g;
            break;
