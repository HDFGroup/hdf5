 ...
 * \dtype_id Identifier of datatype to be committed and, upon function’s
 ...
 *          datatype identifier \p dtype_id must be linked into the HDF5 file
 ...
 *          known as a named) type or a transient type. If this function returns
 ...
 *
 * \dtype_id
 * param[in] dtype_class Datatype class
 *
 * \return \htri_t
 *
 * \details H5Tdetect_class() determines whether the datatype specified in
 *          \p dtype_id contains any datatypes of the datatype class specified
 *          in \p dtype_class.
 *
 ...
 *          \p dtype_id to be immediately flushed to disk without removing the
 *          data from the cache.
 *
 ...
 * \dtype_id
 *
 * \return Returns datatype class if successful; otherwise H5T_NO_CLASS (-1).
 *
 * \details H5Tget_class() returns the class of the datatype \p dtype_id.
 *          Valid class identifiers, as defined in H5Tpublic.h, are:
 *          \datatype_class
 *
 ...
 *          identifier for the datatype specified by \p dtype_id.
 *
 ...
 *
 *          For example, if \p dtype_id is a compound datatype, the returned
 ...
 *          nested compound datatypes will be unwound. If \p dtype_id is an
 ...
 *
 *          <table>
 *          <tr><td>#H5T_DIR_ASCEND</td>
 *              <td>Searches the above list in ascending size of the datatype,
 *                  i.e., from top to bottom. (Default)</td></tr>
 *          <tr><td>#H5T_DIR_DESCEND</td>
 *              <td>Searches the above list in descending size of the datatype,
 *                  i.e., from bottom to top.</td></tr>
 *          </table>
 *
 ...
 *
 *          \note H5LTdtype_to_text() creates a text description of a
 *          datatype.  \note H5LTtext_to_dtype() creates an HDF5 datatype
 ...
 *          \p dtype_id is derived.  In the case of an enumeration type, the
 ...
 *
 * \dtype_id for which the size is being set
 ...
 *
 * \dtype_id{src_id} of source datatype
 * \dtype_id{dst_id} of destination datatype
 *
 * \return \htri_t
 *
...
H5_DLL herr_t H5Tconvert(hid_t src_id, hid_t dst_id, size_t nelmts,
			  void *buf, void *background, hid_t dxpl_id);
/**
 * --------------------------------------------------------------------------
 * \ingroup CONV
 *
 ...
 *          using H5Tdecode() to return a new object handle (hid_t) for
 *          this datatype.
 *
 ...
 *          <table>
 *          <tr><td>#H5T_PAD_ZERO</td>
 *              <td>0</td>
 *              <td>Set background to zeros</td></tr>
 *          <tr><td>#H5T_PAD_ONE</td>
 *              <td>1</td>
 *              <td>Set background to ones</td></tr>
 *          <tr><td>#H5T_PAD_BACKGROUND</td>
 *              <td>2</td>
 *              <td>Leave background alone</td></tr>
 *          </table>
 *
 * \since 1.2.0
 *
 ...
 * \norm_type
 *          <table>
 *          <tr><td>#H5T_NORM_IMPLIED</td>
 *              <td>0</td>
 *              <td>MSB of mantissa is not stored, always 1</td></tr>
 *          <tr><td>#H5T_NORM_MSBSET</td>
 *              <td>1</td>
 *              <td>MSB of mantissa is always 1</td></tr>
 *          <tr><td>#H5T_NORM_NONE</td>
 *              <td>2</td>
 *              <td>Mantissa is not normalized</td></tr>
 *          </table>
 ...
 *
 * \dtype_id
 * \param[in] precision Number of bits of precision for datatype
 *
 * \return \herr_t
 *
 ...
 *          is specified in the array \p dims. The value of \p rank is
 *          currently limited to #H5S_MAX_RANK and must be greater than 0
 *          (zero). All dimension sizes specified in \p dims must be greater
 *          than 0 (zero).
 *
 * \since 1.8.0
 *
 ...
 *
 * \dtype_id
 * \param[in] member_no Zero-based index of the field or element
 *
 ...
 *
 */
H5_DLL H5T_class_t H5Tget_member_class(hid_t type_id, unsigned member_no);
 ...
 *
 */
H5_DLL char *H5Tget_member_name(hid_t type_id, unsigned member_no);
 ...
 *
 */
H5_DLL size_t H5Tget_member_offset(hid_t type_id, unsigned member_no);
 ...
 *
 */
H5_DLL hid_t H5Tget_member_type(hid_t type_id, unsigned member_no);
 ...
 *
 */
H5_DLL int H5Tget_nmembers(hid_t dtype_id);
 ...
 *
 */
H5_DLL herr_t H5Tinsert(hid_t dtype_id, const char *name, size_t offset, hid_t field_id);
 ...
 *
 * \dtype_id{base_id}, the element type of the datatype to create
 *
 * \return \hid_t{datatype}
 *
 ...
 *
 * \dtype_id{type} of an opaque datatype
 ...
 *            integer datatype
 *
 * \return Returns the datatype identifier for the new enumeration datatype if
 *         successful; otherwise returns a negative value.
 *
 ...
 *
 *          \p dtype_id is the datatype identifier for the enumeration datatype,
 ...
 *          specified \p value of the enumeration datatype \p dtype_id.
 *
 ...
 *
 */
H5_DLL herr_t H5Tenum_nameof(hid_t dtype_id, const void *value, char *name/*out*/,
			     size_t size);
/**
 * --------------------------------------------------------------------------
 * \ingroup ENUM
...
/* Operations defined on atomic datatypes */
 ...
 *
 * \dtype_id
 * \param[in] member_no Number of the enumeration datatype member
 ...
 *
 */
H5_DLL herr_t H5Tget_member_value(hid_t type_id, unsigned member_no, void *value/*out*/);
 ...
 * \fg_loc_id
 * \param[in] name Name given to committed datatype
 * \param[in] dtype_id Identifier of datatype to be committed
 *
 * \return \herr_t
 *
 ...
 *          eventually be closed by calling H5T_CLOSE  to release resources.
 *
