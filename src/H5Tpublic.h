 ...
 *
 * \note The size and precision of, as well as any offset for, the floating-point
 *       datatype should be set appropriately before calling H5Tset_fields().
 *       Otherwise, H5Tset_fields() may fail when checking that the values make
 *       sense for the datatype. This is of particular concern if another
 *       floating-point datatype was copied as a starting point.
 *
 * \since 1.0.0
 *
 */
