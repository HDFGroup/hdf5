 ...
 * \ingroup H5T
 *
 * \brief Asynchronous version of H5Tcopy().
 *
 * \todo Create an example for H5Tcopy_async().
 *
 */
...
#ifndef H5T_MODULE
#define H5Tcopy_async(...)   H5Tcopy_async(__FILE__, __func__, __LINE__, __VA_ARGS__)
...
#define H5Tcopy_async_wrap H5_NO_EXPAND(H5Tcopy_async)
#define H5Tcopy_async_wrap H5_NO_EXPAND(H5Tcopy_async)
