...
H5_DLL herr_t H5VL__encode_loc_params(H5VL_loc_params_t loc_params, uint8_t **pp, size_t *size);
H5_DLL herr_t H5VL__decode_loc_params(const uint8_t **pp, H5VL_loc_params_t *loc_params);
