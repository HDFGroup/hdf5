 ...
 *                  However, objects written with this setting may be accessible
 *                  to a smaller range of library versions than would be the
 *                  case if low is set
 ...
 *
 * \since 1.8.0 Function added to this release.
 *
 */
 ...
 *          property list, and H5Fget_mdc_logging_status() will return the current
