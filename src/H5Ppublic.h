...
typedef enum H5D_mpio_no_collective_cause_t {
    ...
    /**< Collective I/O would be supported by selection or vector I/O but the type conversion buffer is too small */
    H5D_MPIO_SELECTION_IO_FILTER = 0x400,
    /**< Collective I/O may be supported by selection or vector I/O but selection/vector I/O is not compatible with data filters */
    H5D_MPIO_SELECTION_IO_CHUNK_CACHE = 0x800,
    /**< Collective I/O may be supported by selection or vector I/O but selection/vector I/O is not compatible with the chunk cache */
