...
#define H5P_RC_ACQUIRE  		(H5OPEN H5P_CLS_READ_CONTEXT_ACQUIRE_ID_g)
#define H5P_TR_START    		(H5OPEN H5P_CLS_TRANSACTION_START_ID_g)
#define H5P_TR_FINISH   		(H5OPEN H5P_CLS_TRANSACTION_FINISH_ID_g)
#define H5P_VIEW_CREATE   		(H5OPEN H5P_CLS_VIEW_CREATE_ID_g)
...
#define H5P_RC_ACQUIRE_DEFAULT		(H5OPEN H5P_LST_READ_CONTEXT_ACQUIRE_ID_g)
#define H5P_TR_START_DEFAULT		(H5OPEN H5P_LST_TRANSACTION_START_ID_g)
#define H5P_TR_FINISH_DEFAULT		(H5OPEN H5P_LST_TRANSACTION_FINISH_ID_g)
#define H5P_VIEW_CREATE_DEFAULT  	(H5OPEN H5P_LST_VIEW_CREATE_ID_g)
#ifdef H5_HAVE_INDEXING
...
H5_DLLVAR hid_t H5P_CLS_READ_CONTEXT_ACQUIRE_ID_g;
H5_DLLVAR hid_t H5P_CLS_TRANSACTION_START_ID_g;
H5_DLLVAR hid_t H5P_CLS_TRANSACTION_FINISH_ID_g;
H5_DLLVAR hid_t H5P_CLS_VIEW_CREATE_ID_g;
#ifdef H5_HAVE_INDEXING
...
H5_DLLVAR hid_t H5P_LST_READ_CONTEXT_ACQUIRE_ID_g;
H5_DLLVAR hid_t H5P_LST_TRANSACTION_START_ID_g;
H5_DLLVAR hid_t H5P_LST_TRANSACTION_FINISH_ID_g;
H5_DLLVAR hid_t H5P_LST_VIEW_CREATE_ID_g;
#ifdef H5_HAVE_INDEXING
