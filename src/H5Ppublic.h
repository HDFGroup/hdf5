...
H5_DLL herr_t H5Pset_avoid_truncate(hid_t fcpl_id, H5F_avoid_truncate_t avoid_truncate);
H5_DLL herr_t H5Pget_avoid_truncate(hid_t fcpl_id, H5F_avoid_truncate_t * avoid_truncate);
