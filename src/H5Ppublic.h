 ...
 * \ingroup FAPL
 *
 * \brief Control whether implicit asynchronous operations are allowed.
 *
 * \fapl_id{plist_id}
 * \param[in]  allow_implicit_async  Flag to control whether implicit asynchronous operations are allowed
 *
 * \return \herr_t
 *
 * \details H5Pset_vol_implicit_async() controls whether implicit asynchronous
 ...
 *
 * \note    See the documentation for asynchronous operations for more details
 *          about implicit asynchronous operations.
 *
 * \since 1.13.0
 *
 * \see H5Pget_vol_implicit_async()
 *
 */
H5_DLL herr_t H5Pset_vol_implicit_async(hid_t plist_id, hbool_t allow_implicit_async);

/**
 * \ingroup FAPL
 *
 * \brief Query whether implicit asynchronous operations are allowed.
 *
 * \fapl_id{plist_id}
 * \param[out]  implicit_async_allowed  Flag to indicate whether implicit asynchronous operations are allowed
 *
 * \return \herr_t
 *
 * \details H5Pget_vol_implicit_async() queries whether implicit asynchronous
 *          operations are allowed.
 *
 *          Allowing / disallowing implicit asynchronous operations does not
 *          affect operation of explicit asynchronous operations.
 ...
 * \since 1.13.0
 *
 * \see H5Pset_vol_implicit_async()
 *
 */
H5_DLL herr_t H5Pget_vol_implicit_async(hid_t plist_id, hbool_t *implicit_async_allowed);
