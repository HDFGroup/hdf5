...
#include "H5Vmodule.h"          /* This source code file is part of the H5V module */
...
/*--------------------------------------------------------------------------
NAME
   H5V__init_package -- Initialize interface-specific information
USAGE
    herr_t H5V__init_package()
