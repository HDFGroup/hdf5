    ...
    H5P_prp_copy_func_t prp_copy, H5P_prp_close_func_t prp_close)
{
    ...
    FUNC_ENTER_API(FAIL)
    H5TRACE10("e", "i*sz*xPCPSPGPDPOPL", cls_id, name, size, def_value, prp_create,
    ...
    H5P_prp_close_func_t prp_close)
{
    ...
    FUNC_ENTER_API(FAIL)
    H5TRACE9("e", "i*sz*xPSPGPDPOPL", plist_id, name, size, value, prp_set, prp_get,
 ...
 */
herr_t
H5Pget_file_space(hid_t plist_id, H5F_file_space_type_t *strategy/*out*/,
