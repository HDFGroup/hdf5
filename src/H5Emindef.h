...
static const H5E_msg_t H5E_UNINITIALIZED_msg_s = {false, "Information is uinitialized", H5E_MINOR,
                                                  &H5E_err_cls_s};
...
static const H5E_msg_t H5E_CANTREDISTRIBUTE_msg_s = {false, "Unable to redistribute records", H5E_MINOR,
                                                     &H5E_err_cls_s};
...
static const H5E_msg_t H5E_CANTCLEAN_msg_s   = {false, "Unable to mark metadata as clean", H5E_MINOR,
                                              &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTCORK_msg_s    = {false, "Unable to cork an object", H5E_MINOR, &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTDEPEND_msg_s  = {false, "Unable to create a flush dependency", H5E_MINOR,
                                               &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTDIRTY_msg_s   = {false, "Unable to mark metadata as dirty", H5E_MINOR,
                                              &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTEXPUNGE_msg_s = {false, "Unable to expunge a metadata cache entry", H5E_MINOR,
                                                &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTFLUSH_msg_s   = {false, "Unable to flush data from cache", H5E_MINOR,
                                              &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTINS_msg_s     = {false, "Unable to insert metadata into cache", H5E_MINOR,
                                            &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTLOAD_msg_s    = {false, "Unable to load metadata into cache", H5E_MINOR,
                                             &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTMARKCLEAN_msg_s = {false, "Unable to mark a pinned entry as clean", H5E_MINOR,
                                                  &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTMARKDIRTY_msg_s = {false, "Unable to mark a pinned entry as dirty", H5E_MINOR,
                                                  &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTMARKSERIALIZED_msg_s   = {false, "Unable to mark an entry as serialized",
                                                       H5E_MINOR, &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTMARKUNSERIALIZED_msg_s = {false, "Unable to mark an entry as unserialized",
                                                         H5E_MINOR, &H5E_err_cls_s};
...
static const H5E_msg_t H5E_CANTPROTECT_msg_s   = {false, "Unable to protect metadata", H5E_MINOR,
                                                &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTRESIZE_msg_s    = {false, "Unable to resize a metadata cache entry", H5E_MINOR,
                                               &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTSERIALIZE_msg_s = {false, "Unable to serialize data from cache", H5E_MINOR,
                                                  &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTTAG_msg_s       = {false, "Unable to tag metadata in the cache", H5E_MINOR,
                                            &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTUNCORK_msg_s    = {false, "Unable to uncork an object", H5E_MINOR,
                                               &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTUNDEPEND_msg_s  = {false, "Unable to destroy a flush dependency", H5E_MINOR,
                                                 &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTUNPIN_msg_s     = {false, "Unable to un-pin cache entry", H5E_MINOR,
                                              &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTUNPROTECT_msg_s = {false, "Unable to unprotect metadata", H5E_MINOR,
                                                  &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTUNSERIALIZE_msg_s = {false, "Unable to mark metadata as unserialized",
                                                    H5E_MINOR, &H5E_err_cls_s};
static const H5E_msg_t H5E_LOGGING_msg_s   = {false, "Failure in the cache logging framework", H5E_MINOR,
                                            &H5E_err_cls_s};
static const H5E_msg_t H5E_NOTCACHED_msg_s = {false, "Metadata not currently cached", H5E_MINOR,
                                              &H5E_err_cls_s};
...
static const H5E_msg_t H5E_CANTNEXT_msg_s    = {false, "Can't move to next iterator location", H5E_MINOR,
                                             &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTSELECT_msg_s  = {false, "Can't select hyperslab", H5E_MINOR, &H5E_err_cls_s};
static const H5E_msg_t H5E_INCONSISTENTSTATE_msg_s = {false, "Internal states are inconsistent", H5E_MINOR,
                                                      &H5E_err_cls_s};
...
static const H5E_msg_t H5E_ALREADYINIT_msg_s = {false, "Object already initialized", H5E_MINOR,
                                                &H5E_err_cls_s};
...
static const H5E_msg_t H5E_BADGROUP_msg_s = {false, "Unable to find ID group information", H5E_MINOR,
                                             &H5E_err_cls_s};
static const H5E_msg_t H5E_BADID_msg_s = {false, "Unable to find ID information (already closed?)", H5E_MINOR,
                                          &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTDEC_msg_s      = {false, "Unable to decrement reference count", H5E_MINOR,
                                            &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTINC_msg_s      = {false, "Unable to increment reference count", H5E_MINOR,
                                            &H5E_err_cls_s};
static const H5E_msg_t H5E_CANTREGISTER_msg_s = {false, "Unable to register new ID", H5E_MINOR,
                                                 &H5E_err_cls_s};
...
static const H5E_msg_t H5E_NOTREGISTERED_msg_s = {false, "Link class not registered", H5E_MINOR,
                                                  &H5E_err_cls_s};
...
static const H5E_msg_t H5E_NO_INDEPENDENT_msg_s = {false, "Can't perform independent IO", H5E_MINOR,
                                                   &H5E_err_cls_s};
...
static const H5E_msg_t H5E_LINKCOUNT_msg_s  = {false, "Bad object header link count", H5E_MINOR,
                                              &H5E_err_cls_s};
...
static const H5E_msg_t H5E_NOENCODER_msg_s  = {false, "Filter present but encoding disabled", H5E_MINOR,
                                              &H5E_err_cls_s};
static const H5E_msg_t H5E_NOFILTER_msg_s   = {false, "Requested filter is not available", H5E_MINOR,
                                             &H5E_err_cls_s};
...
static const H5E_msg_t H5E_DUPCLASS_msg_s      = {false, "Duplicate class name in parent class", H5E_MINOR,
                                             &H5E_err_cls_s};
static const H5E_msg_t H5E_SETDISALLOWED_msg_s = {false, "Disallowed operation", H5E_MINOR, &H5E_err_cls_s};

/* PLUGIN: Plugin errors */
static const H5E_msg_t H5E_OPENERROR_msg_s = {false, "Can't open directory or file", H5E_MINOR,
                                              &H5E_err_cls_s};
...
static const H5E_msg_t H5E_NOSPACE_msg_s     = {false, "No space available for allocation", H5E_MINOR,
                                            &H5E_err_cls_s};
