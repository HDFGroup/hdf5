...
/* FUNC_ENTER/LEAVE macros used when entering and leaving library API calls */
#include "H5func_enter_threadsafe.h"
#include "H5func_enter.h"

/* We declare H5CXpush/pop() here, since they are used in the FUNC_ENTER macros
 * and including H5CXprivate.h creates circular dependencies.
 */
H5_DLL herr_t H5CX_push(void);
H5_DLL herr_t H5CX_pop(bool update_dxpl_props);

/* Macros for accessing library init/term global variables */
