                     ...
                     H5VL_object_t **_vol_obj_ptr)
{
    ...
    /* Read the data */
    if (H5VL_dataset_read(count, obj, connector, mem_type_id, mem_space_id, file_space_id, dxpl_id,
                                 buf, token_ptr) < 0)
                      ...
                      H5VL_object_t **_vol_obj_ptr)
{
    ...
    /* Write the data */
    if (H5VL_dataset_write(count, obj, connector, mem_type_id, mem_space_id, file_space_id, dxpl_id,
                                  buf, token_ptr) < 0)
