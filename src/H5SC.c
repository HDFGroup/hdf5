 ...
 *              July, 2012
 *
 * Purpose:	The commsplitter library from Sandia, integrated into the HDF5
 *              library for splitting MPI_COMM_WORLD from under the application
 *              and taking some processes for I/O without involvement from the 
 *              application.
 */
