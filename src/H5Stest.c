...
/*--------------------------------------------------------------------------
 ...
 USAGE
    herr_t H5S_get_rebuild_status(hid_t space_id, H5S_diminfo_valid_t *status1,
...
/*--------------------------------------------------------------------------
 ...
 PURPOSE
    ...
    selection information for an equivalent single hyperslab selection)
 USAGE
    herr_t H5S_get_diminfo_status_test(hid_t space_id, H5S_diminfo_valid_t *status)
        hid_t space_id;          IN:  dataspace id
...
/*--------------------------------------------------------------------------
 ...
 USAGE
    herr_t H5S_check_spans_tail_ptr(span_lst)
        const H5S_hyper_span_info_t *span_lst;  IN: the spans to check for tail pointers        
 RETURNS
    SUCCEED/FAIL
 DESCRIPTION
...
/*--------------------------------------------------------------------------
 ...
 USAGE
    herr_t H5S_check_points_tail_ptr(const H5S_pnt_list_t *pnt_lst)
        const H5S_pnt_list_t *pnt_lst;  IN: the points list to check for tail pointers        
 RETURNS
    SUCCEED/FAIL
 DESCRIPTION
...
/*--------------------------------------------------------------------------
 ...
 USAGE
    herr_t H5S_check_internal_consistency(const H5S_t *space)
