...
#define H5EA_HDR_VERSION_0      0 /* Initial version of the Extensible Array Header */
...
/* The Extensible Array class for dataset structured chunks w/o filters*/
H5_DLLVAR const H5EA_class_t H5EA_CLS_STRUCT_CHUNK[1];

/* The Extensible Array class for dataset structured chunks w/ filters*/
H5_DLLVAR const H5EA_class_t H5EA_CLS_FILT_STRUCT_CHUNK[1];
