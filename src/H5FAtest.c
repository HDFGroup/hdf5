...
static herr_t H5FA__test_debug(FILE *stream, int indent, int fwidth, hsize_t idx, const void *elmt, void *dbg_ctx);
 ...
 */
static herr_t
H5FA__test_debug(FILE *stream, int indent, int fwidth, hsize_t idx, const void *elmt, void H5_ATTR_UNUSED *dbg_ctx)
{
