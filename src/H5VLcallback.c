...
H5VL_cmp_connector_info(const H5VL_connector_t *connector, int *cmp_value, const void *info1, const void *info2)
{
    ...
    if (connector->cls->info_cls.cmp) {
        if ((connector->cls->info_cls.cmp)(cmp_value, info1, info2) < 0)
...
H5VL_wrap_object(const H5VL_class_t *cls, void *wrap_ctx, void *obj, H5I_type_t obj_type)
{
    ...
    if (wrap_ctx) {
        ...
        if (NULL == (ret_value = (cls->wrap_cls.wrap_object)(obj, obj_type, wrap_ctx)))
...
H5VL_unwrap_object(const H5VL_class_t *cls, void *obj)
{
    ...
    if (cls->wrap_cls.wrap_object) {
        ...
        if (NULL == (ret_value = (cls->wrap_cls.unwrap_object)(obj)))
 ...
 */
void *
H5VL_file_open(H5VL_connector_t *connector, const char *name, unsigned flags, hid_t fapl_id,
               hid_t dxpl_id, void **req)
{
    void         *ret_value = NULL; /* Return value */
