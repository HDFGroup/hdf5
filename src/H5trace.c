                ...
                case 'a':       /* haddr_t */
                    {
                        ...
                        if(H5F_addr_defined(addr))
                            H5MS_asprintf_cat(ms, H5_PRINTF_HADDR_FMT, addr);
                        else
                            H5MS_acat(ms, "UNDEF");
                    } /* end block */
                    break;
                        ...
                        case 'n':       /* H5D_mpio_no_collective_cause_t */
                            {
                                ...
                                if(nocol_cause_mode & H5D_MPIO_SET_INDEPENDENT) {
                                    H5MS_asprintf_cat(ms, "%sH5D_MPIO_SET_INDEPENDENT", flag_already_displayed ? " | " : "");
                                    flag_already_displayed = TRUE;
                                } /* end if */
                                if(nocol_cause_mode & H5D_MPIO_DATATYPE_CONVERSION) {
                                    H5MS_asprintf_cat(ms, "%sH5D_MPIO_DATATYPE_CONVERSION", flag_already_displayed ? " | " : "");
                                    flag_already_displayed = TRUE;
                                } /* end if */
                                if(nocol_cause_mode & H5D_MPIO_DATA_TRANSFORMS) {
                                    H5MS_asprintf_cat(ms, "%sH5D_MPIO_DATA_TRANSFORMS", flag_already_displayed ? " | " : "");
                                    flag_already_displayed = TRUE;
                                } /* end if */
                                if(nocol_cause_mode & H5D_MPIO_MPI_OPT_TYPES_ENV_VAR_DISABLED) {
                                    H5MS_asprintf_cat(ms, "%sH5D_MPIO_MPI_OPT_TYPES_ENV_VAR_DISABLED", flag_already_displayed ? " | " : "");
                                    flag_already_displayed = TRUE;
                                } /* end if */
                                if(nocol_cause_mode & H5D_MPIO_NOT_SIMPLE_OR_SCALAR_DATASPACES) {
                                    H5MS_asprintf_cat(ms, "%sH5D_MPIO_NOT_SIMPLE_OR_SCALAR_DATASPACES", flag_already_displayed ? " | " : "");
                                    flag_already_displayed = TRUE;
                                } /* end if */
                                if(nocol_cause_mode & H5D_MPIO_NOT_CONTIGUOUS_OR_CHUNKED_DATASET) {
                                    H5MS_asprintf_cat(ms, "%sH5D_MPIO_NOT_CONTIGUOUS_OR_CHUNKED_DATASET", flag_already_displayed ? " | " : "");
                                    flag_already_displayed = TRUE;
                                } /* end if */
                        ...
                        case 'I':   /* H5F_info2_t */
                            {
                                ...
                                H5MS_asprintf_cat(ms, "{{%u, %" PRIuHSIZE ", %" PRIuHSIZE "}, ", fi2.super.version, fi2.super.super_size, fi2.super.super_ext_size);
                                H5MS_asprintf_cat(ms, "{%u, %" PRIuHSIZE ", %" PRIuHSIZE "}, ", fi2.free.version, fi2.free.meta_size, fi2.free.tot_space);
                                H5MS_asprintf_cat(ms, "{%u, %" PRIuHSIZE ", {%" PRIuHSIZE ", %" PRIuHSIZE "}}}", fi2.sohm.version, fi2.sohm.hdr_size, fi2.sohm.msgs_info.index_size, fi2.sohm.msgs_info.heap_size);
                            } /* end block */
                            break;
                        ...
                        case 'a':       /* H5_alloc_stats_t */
                            {
                                ...
                                H5MS_asprintf_cat(ms, "{%llu, %zu, %zu, %zu, %zu, %zu, %zu}", stats.total_alloc_bytes, stats.curr_alloc_bytes, stats.peak_alloc_bytes, stats.max_block_size, stats.total_alloc_blocks_count, stats.curr_alloc_blocks_count, stats.peak_alloc_blocks_count);
                            } /* end block */
                            break;
                        ...
                        if(H5P_DEFAULT == obj)
                            ...
                            switch(H5I_TYPE(obj)) { /* Use internal H5I macro instead of function call */
                                ...
                                case H5I_SPACE_SEL_ITER:
                                    H5MS_asprintf_cat(ms, "0x%0llx (dataspace selection iterator)", (unsigned long long)obj);
                                    break;
                ...
                case 'L':
                    switch(type[1]) {
                        ...
                        case 't':   /* H5L_elink_traverse_t */
                            {
                                H5L_elink_traverse_t elt = (H5L_elink_traverse_t)HDva_arg(ap, H5L_elink_traverse_t);
                ...
                case 'O':
                    switch(type[1]) {
                        ...
                        case 's':   /* H5O_mcdt_search_cb_t */
                            {
                                H5O_mcdt_search_cb_t osrch = (H5O_mcdt_search_cb_t)HDva_arg(ap, H5O_mcdt_search_cb_t);
                ...
                case 'P':
                    switch(type[1]) {
                        case 'c':   /* H5P_cls_create_func_t */
                            {
                                H5P_cls_create_func_t pcls_crt = (H5P_cls_create_func_t)HDva_arg(ap, H5P_cls_create_func_t);
                        ...
                        case 'C':   /* H5P_prp_create_func_t */
                            {
                                H5P_prp_create_func_t prp_crt = (H5P_prp_create_func_t)HDva_arg(ap, H5P_prp_create_func_t);
                        ...
                        case 'D':   /* H5P_prp_delete_func_t */
                            {
                                H5P_prp_delete_func_t prp_del = (H5P_prp_delete_func_t)HDva_arg(ap, H5P_prp_delete_func_t);
                        ...
                        case 'l':   /* H5P_cls_close_func_t */
                            {
                                H5P_cls_close_func_t pcls_cls = (H5P_cls_close_func_t)HDva_arg(ap, H5P_cls_close_func_t);
                        ...
                        case 'L':   /* H5P_prp_close_func_t */
                            {
                                H5P_prp_close_func_t prp_cls = (H5P_prp_close_func_t)HDva_arg(ap, H5P_prp_close_func_t);
                        ...
                        case 'M':   /* H5P_prp_compare_func_t */
                            {
                                H5P_prp_compare_func_t prp_cmp = (H5P_prp_compare_func_t)HDva_arg(ap, H5P_prp_compare_func_t);
                        ...
                        case 'o':   /* H5P_cls_copy_func_t */
                            {
                                H5P_cls_copy_func_t pcls_cpy = (H5P_cls_copy_func_t)HDva_arg(ap, H5P_cls_copy_func_t);
                        ...
                        case 'O':   /* H5P_prp_copy_func_t */
                            {
                                H5P_prp_copy_func_t prp_cpy = (H5P_prp_copy_func_t)HDva_arg(ap, H5P_prp_copy_func_t);
                        ...
                        case 'o':       /* hobj_ref_t */
                            {
                                ...
                                H5MS_asprintf_cat(ms, "Reference Object=" H5_PRINTF_HADDR_FMT, ref);
                            } /* end block */
                            break;
                ...
                case 'T':
                    switch(type[1]) {
                        ...
                        case 'E':   /* H5T_conv_except_func_t */
                            {
                                H5T_conv_except_func_t conv_ex = (H5T_conv_except_func_t)HDva_arg(ap, H5T_conv_except_func_t);
                ...
                case 'V':
                    switch(type[1]) {
                        ...
                        case 'N':   /* H5VL_request_notify_t */
                            {
                                H5VL_request_notify_t vlrnot = (H5VL_request_notify_t)HDva_arg(ap, H5VL_request_notify_t);
