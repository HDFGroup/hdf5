...
/* This version stores each filter's canonical key=value configuration string
 *      (as set with H5Pappend_filter) after the client data values, so it can
 *      be recovered losslessly without loading the filter plugin
 */
