...
const H5P_libclass_t H5P_CLS_TRSCC[1] = {{
    ...
    &H5P_CLS_TRANSACTION_START_g,       /* Pointer to class             */
    &H5P_CLS_TRANSACTION_START_ID_g,	/* Pointer to class ID          */
    &H5P_LST_TRANSACTION_START_ID_g,	/* Pointer to default property list ID */
