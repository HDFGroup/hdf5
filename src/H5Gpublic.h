 ...
 *
 *          The possible values for type of storage are:
 *          \li H5G_STORAGE_TYPE_COMPACT: Compact storage 
 *          \li H5G_STORAGE_TYPE_DENSE: Indexed storage 
 *          \li H5G_STORAGE_TYPE_SYMBOL_TABLE: Symbol tables, the
 ...
 *
 * \fgdta_loc_id (Todo: only group or file)
 ...
 *      \li negative value, if failure occurred
 *
 * \details H5Gget_info_by_idx() returns the name of the object specified by
 ...
 *          call to H5Gget_info_by_idx() can then be used to retrieve the
 *          actual name.
 *
 * \since 1.8.0
 *
