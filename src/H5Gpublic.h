...
H5_DLL herr_t H5Gget_info_async(hid_t loc_id, H5G_info_t *group_info/*out*/, 
    hid_t es_id);

H5_DLL herr_t H5Gget_info_by_name(hid_t loc_id, const char *name, H5G_info_t *ginfo, hid_t lapl_id);
H5_DLL herr_t H5Gget_info_by_name_async(hid_t loc_id, const char *name, H5G_info_t *group_info/*out*/,
...
H5_DLL herr_t H5Gget_info_by_idx_async(hid_t loc_id, const char *group_name, 
