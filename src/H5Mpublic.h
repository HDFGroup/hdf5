...
#define H5VL_MAP_GET_VAL  3 /**< Callback operation ID for getting an associated value from a map \since 1.12.0 */
...
typedef enum H5VL_map_get_t {
    ...
    H5VL_MAP_GET_COUNT /**< Callback operation ID for getting the number of key-value pairs stored in a map \since 1.12.0 */
} H5VL_map_get_t;
...
typedef enum H5VL_map_specific_t {
    H5VL_MAP_ITER,  /**< Callback operation ID for iterating over all key-value pairs stored in the map \since 1.12.0 */
