 ...
 */
static herr_t
H5VL_pass_through_link_create(H5VL_link_create_type_t create_type, const H5VL_link_create_args_t *create_args,
                              ...
                              hid_t dxpl_id, void **req)
{
    ...
    if (H5VL_LINK_CREATE_HARD == create_type) {
        ...
        if (cur_obj) {
            /* Copy the current link creation arguments */
            new_create_args = *create_args;
            ...
            new_create_args.hard.vol_obj_data = ((H5VL_pass_through_t *)cur_obj)->under_object;
