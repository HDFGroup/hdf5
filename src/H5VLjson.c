                      ...
                      hid_t fapl_id, hid_t dxpl_id, void H5_ATTR_UNUSED **req)
{
    ...
    json_t* attribute_collection = json_array();
    json_object_set_new(root_group, "attributes", attribute_collection);
 ...
 *              November, 2017
 *
 *              XXX: Implement the case of (not) creating intermediate
                      ...
                      hid_t lcpl_id, hid_t lapl_id, hid_t H5_ATTR_UNUSED dxpl_id, void H5_ATTR_UNUSED **req)
{
    ...
    switch (create_type) {
        case H5VL_LINK_CREATE_HARD:
        {
            ...
            /* XXX: May need to populate an H5VL_json_object_t * when the link created
             * is a hard link; avoid repeat trips to server
             */
