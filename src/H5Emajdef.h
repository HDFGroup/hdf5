...
static const H5E_msg_t H5E_INTERNAL_msg_s  = {false, "Internal error (too specific to document in detail)",
                                             H5E_MAJOR, &H5E_err_cls_s};
...
static const H5E_msg_t H5E_PLUGIN_msg_s     = {false, "Plugin for dynamically loaded library", H5E_MAJOR,
                                           &H5E_err_cls_s};
