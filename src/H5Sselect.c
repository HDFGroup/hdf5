 ...
 * \return \herr_t
 *
 * \details shifts a dataspace selection by a specified logical offset 
 *          within the dataspace extent.  This can be useful for VOL 
 *          developers to implement chunked datasets.
 *
 * \since 1.12.0
 */ 
