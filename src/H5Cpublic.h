...
enum H5C_cache_incr_mode {
    H5C_incr__off,/**<Automatic cache size increase is disabled, and the
    *         remaining increment fields are ignored.*/
    H5C_incr__threshold/**<Automatic cache size increase is enabled using the
    *         hit rate threshold algorithm.*/
};
