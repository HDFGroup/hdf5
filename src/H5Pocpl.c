 ...
 */
herr_t
H5Pget_attr_phase_change(hid_t plist_id, unsigned *max_compact/*out*/,
...
H5Pget_filter2(hid_t plist_id, unsigned idx, unsigned int *flags/*out*/,
        ...
        size_t namelen, char name[]/*out*/, unsigned *filter_config/*out*/)
{
    H5P_genplist_t  *plist;             /* Property list */
    H5O_pline_t     pline;              /* Filter pipeline */
    ...
    size_t namelen, char name[]/*out*/, unsigned *filter_config/*out*/)
{
    ...
    FUNC_ENTER_API(FAIL)
    H5TRACE8("e", "iZfx*zxzxx", plist_id, id, flags, cd_nelmts, cd_values, namelen,
             name, filter_config);
