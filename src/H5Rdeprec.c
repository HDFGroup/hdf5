 ...
 *                - if 'size' == 0: treats the call as length query, does not                   *                  write anything to the buffer (not even a null terminator), and
 *                  returns the actual length of the path (excluding null terminator).
 *
