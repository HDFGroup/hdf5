 ...
 *          page buffer size has not been set on fapl_id, it is set to 64 MB. To
 *          set a different page buffer size, simply call  H5Pset_page_buffer()
 *          with fapl_id and your desired page buffer size. To disable the page
 *          buffer, call H5Pset_page_buffer() with a size of 0. Disabling the
 *          page buffer with the ROS3 driver may cause severe performance
 *          degradation.
 */
