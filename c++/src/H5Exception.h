...
class H5_DLL FileIException : public Exception {
  public:
...
class H5_DLL GroupIException : public Exception {
  public:
...
class H5_DLL DataSpaceIException : public Exception {
  public:
...
class H5_DLL DataTypeIException : public Exception {
  public:
...
class H5_DLL ObjHeaderIException : public Exception {
  public:
...
class H5_DLL PropListIException : public Exception {
  public:
...
class H5_DLL DataSetIException : public Exception {
  public:
...
class H5_DLL AttributeIException : public Exception {
  public:
...
class H5_DLL ReferenceException : public Exception {
  public:
...
class H5_DLL LibraryIException : public Exception {
  public:
...
class H5_DLL LocationException : public Exception {
  public:
...
class H5_DLL IdComponentException : public Exception {
  public:
