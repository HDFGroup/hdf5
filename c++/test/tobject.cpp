...
test_get_objname()
{
    ...
    try {
        ...
        if (name_len > 4) {
            ...
            verify_val(static_cast<const char *>(grp1_name), "/Top", "Group::getObjName", __LINE__, __FILE__);
            delete[] grp1_name;
        }
...
test_get_objname_ontypes()
{
    ...
    try {
        ...
        verify_val(name_len, static_cast<ssize_t>(HDstrlen("/typetests/IntType NATIVE_INT")), "DataType::getObjName",
                   __LINE__, __FILE__);
