 ...
 *
 */
H5_DLL herr_t H5LDget_dset_dims(hid_t did, hsize_t *cur_dims);
 ...
 *
 */
H5_DLL size_t H5LDget_dset_type_size(hid_t did, const char *fields);
 ...
 *
 */
H5_DLL herr_t H5LDget_dset_elmts(hid_t did, const hsize_t *prev_dims, const hsize_t *cur_dims,
