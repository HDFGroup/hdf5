 ...
 *
 */
H5_DLL herr_t H5DSwith_new_ref(hid_t obj_id, hbool_t *with_new_ref);
 ...
 */
H5_DLL herr_t H5DSattach_scale(hid_t did, hid_t dsid, unsigned int idx);
 ...
 *
 */
H5_DLL herr_t H5DSdetach_scale(hid_t did, hid_t dsid, unsigned int idx);
 ...
 */
H5_DLL herr_t H5DSset_scale(hid_t dsid, const char *dimname);
 ...
 *
 */
H5_DLL int H5DSget_num_scales(hid_t did, unsigned int idx);
 ...
 *
 */
H5_DLL herr_t H5DSset_label(hid_t did, unsigned int idx, const char *label);
 ...
 *
 */
H5_DLL ssize_t H5DSget_label(hid_t did, unsigned int idx, char *label, size_t size);
 ...
 */
H5_DLL ssize_t H5DSget_scale_name(hid_t did, char *name, size_t size);
 ...
 *
 */
H5_DLL htri_t H5DSis_scale(hid_t did);
 ...
 */
H5_DLL herr_t H5DSiterate_scales(hid_t did, unsigned int dim, int *idx, H5DS_iterate_t visitor,
                                 void *visitor_data);
 ...
 *
 */
H5_DLL htri_t H5DSis_attached(hid_t did, hid_t dsid, unsigned int idx);
