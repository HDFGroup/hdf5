 ...
 */
#if !(defined(H5LR_MODULE) | defined(H5ERROR_MODULE))
...
/* #include "H5ERRORprivate.h" */

/* Other private headers needed by this file */
/* #include "H5ACprivate.h"	/\* Metadata cache			*\/ */
/* #include "H5FLprivate.h"	/\* Free Lists                           *\/ */
#include "../../src/H5pubconf.h"
...
/* If this package header is being included in one of the H5ERROR modules, define
...
#endif /* H5ERROR_MODULE */

/* /\* Fill value for extensible array test class *\/ */
/* #ifdef H5ERROR_TESTING */
/* #define H5ERROR_TEST_FILL          ((uint64_t)ULLONG_MAX) */
/* #endif /\* H5ERROR_TESTING *\/ */

/* /\* Size of checksum information (on disk) *\/ */
/* #define H5ERROR_SIZEOF_CHKSUM      4 */
