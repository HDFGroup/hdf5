 ...
 *
 */
H5_DLL herr_t H5TBmake_table(const char *table_title, hid_t loc_id, const char *dset_name, hsize_t nfields,
 ...
 *
 */
H5_DLL herr_t H5TBappend_records(hid_t loc_id, const char *dset_name, hsize_t nrecords, size_t type_size,
 ...
 *
 */
H5_DLL herr_t H5TBwrite_records(hid_t loc_id, const char *dset_name, hsize_t start, hsize_t nrecords,
 ...
 *
 */
H5_DLL herr_t H5TBwrite_fields_name(hid_t loc_id, const char *dset_name, const char *field_names,
 ...
 *
 */
H5_DLL herr_t H5TBwrite_fields_index(hid_t loc_id, const char *dset_name, hsize_t nfields,
 ...
 *
 */
H5_DLL herr_t H5TBread_table(hid_t loc_id, const char *dset_name, size_t dst_size, const size_t *dst_offset,
 ...
 *
 */
H5_DLL herr_t H5TBread_fields_name(hid_t loc_id, const char *dset_name, const char *field_names,
                                   hsize_t start, hsize_t nrecords, size_t type_size,
 ...
 *
 */
H5_DLL herr_t H5TBread_fields_index(hid_t loc_id, const char *dset_name, hsize_t nfields,
 ...
 *
 */
H5_DLL herr_t H5TBread_records(hid_t loc_id, const char *dset_name, hsize_t start, hsize_t nrecords,
 ...
 *
 */
H5_DLL herr_t H5TBget_table_info(hid_t loc_id, const char *dset_name, hsize_t *nfields, hsize_t *nrecords);
 ...
 *
 */
H5_DLL herr_t H5TBget_field_info(hid_t loc_id, const char *dset_name, char *field_names[],
 ...
 *
 */
H5_DLL herr_t H5TBdelete_record(hid_t loc_id, const char *dset_name, hsize_t start, hsize_t nrecords);
 ...
 *
 */
H5_DLL herr_t H5TBinsert_record(hid_t loc_id, const char *dset_name, hsize_t start, hsize_t nrecords,
 ...
 *
 */
H5_DLL herr_t H5TBadd_records_from(hid_t loc_id, const char *dset_name1, hsize_t start1, hsize_t nrecords,
 ...
 *
 */
H5_DLL herr_t H5TBcombine_tables(hid_t loc_id1, const char *dset_name1, hid_t loc_id2, const char *dset_name2,
 ...
 *
 */
H5_DLL herr_t H5TBinsert_field(hid_t loc_id, const char *dset_name, const char *field_name, hid_t field_type,
 ...
 *
 */
H5_DLL herr_t H5TBdelete_field(hid_t loc_id, const char *dset_name, const char *field_name);
 ...
 *
 */
H5_DLL herr_t H5TBAget_title(hid_t loc_id, char *table_title);
 ...
 *
 */
H5_DLL htri_t H5TBAget_fill(hid_t loc_id, const char *dset_name, hid_t dset_id, unsigned char *dst_buf);
