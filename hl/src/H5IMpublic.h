 ...
 *
 */
H5_DLL herr_t H5IMmake_image_8bit(hid_t loc_id, const char *dset_name, hsize_t width, hsize_t height,
 ...
 *
 */
H5_DLL herr_t H5IMmake_image_24bit(hid_t loc_id, const char *dset_name, hsize_t width, hsize_t height,
 ...
 *
 */
H5_DLL herr_t H5IMget_image_info(hid_t loc_id, const char *dset_name, hsize_t *width, hsize_t *height,
 ...
 *
 */
H5_DLL herr_t H5IMread_image(hid_t loc_id, const char *dset_name, unsigned char *buffer);
 ...
 *
 */
H5_DLL herr_t H5IMmake_palette(hid_t loc_id, const char *pal_name, const hsize_t *pal_dims,
 ...
 *
 */
H5_DLL herr_t H5IMlink_palette(hid_t loc_id, const char *image_name, const char *pal_name);
 ...
 *
 */
H5_DLL herr_t H5IMunlink_palette(hid_t loc_id, const char *image_name, const char *pal_name);
 ...
 *
 */
H5_DLL herr_t H5IMget_npalettes(hid_t loc_id, const char *image_name, hssize_t *npals);
 ...
 *
 */
H5_DLL herr_t H5IMget_palette_info(hid_t loc_id, const char *image_name, int pal_number, hsize_t *pal_dims);
 ...
 *
 */
H5_DLL herr_t H5IMget_palette(hid_t loc_id, const char *image_name, int pal_number, unsigned char *pal_data);
 ...
 *
 */
H5_DLL herr_t H5IMis_image(hid_t loc_id, const char *dset_name);
 ...
 *
 */
H5_DLL herr_t H5IMis_palette(hid_t loc_id, const char *dset_name);
